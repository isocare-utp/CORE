...
namespace Saving.Applications.admin.ws_am_accountyear_ctrl
{
    ...
    {
        public DataSet1.CMACCOUNTYEARDataTable DATA { get; private set; }
        ...
        {
            string sql = "SELECT *FROM CMACCOUNTYEAR WHERE COOP_ID = '" + state.SsCoopControl + "' ORDER BY ACCOUNT_YEAR";
