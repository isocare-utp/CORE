<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_dbrestore.aspx.cs" Inherits="Saving.Applications.admin.w_sheet_dbrestore" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    รายการแฟ้มข้อมูลฐานข้อมูล <asp:Button ID="SetupBtn" runat="server"  Visible="true"  
     ...
     <br />
    <asp:Literal ID="Literal0" runat="server" Visible="false"></asp:Literal>
    <br />
    </div> 
    ...
    <table border=0><tr><td>รายการแฟ้มข้อมูลสำรองระบบ : </td><td><asp:DropDownList ID="DdDatabase" runat="server" AutoPostBack="True" ></asp:DropDownList>
     <asp:TextBox ID="DBProfileRetoreConnStr" runat="server" Width="300px" Visible=false ></asp:TextBox></td></tr></table>    
     <br />
