<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="ws_am_constant_roundmoney.aspx.cs" Inherits="Saving.Applications.admin.ws_am_constant_roundmoney_ctrl.ws_am_constant_roundmoney" %>
        ...
        function OnDsListItemChanged(s, r, c, v) {
            if (c == "use_flag") {
                ...
                if (li_use_flag == 0) {
                    ...
                    dsList.GetElement(r, "applgroup_code").style.background = "#DDDDDD";
                    ...
                    dsList.GetElement(r, "applgroup_code").readOnly = true;
                    ...
                    dsList.GetElement(r, "applgroup_code").style.background = "#FFFFFF";
                    ...
                    dsList.GetElement(r, "applgroup_code").readOnly = false;
        ...
        function SheetLoadComplete() {
            ...
            for (var i = 0; i < li_row; i++) {
                ...
                if (li_use_flag == 0) {
                    ...
                    dsList.GetElement(i, "applgroup_code").style.background = "#DDDDDD";
                    ...
                    dsList.GetElement(i, "applgroup_code").readOnly = true;
                    ...
                    dsList.GetElement(i, "applgroup_code").style.background = "#FFFFFF";
                    ...
                    dsList.GetElement(i, "applgroup_code").readOnly = false;
