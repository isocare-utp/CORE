<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.admin.ws_am_constant_roundmoney_ctrl.DsList" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td  width="12%">
                        <asp:TextBox ID="applgroup_code" runat="server"></asp:TextBox>
                    </td>
                    <td width="12%">
