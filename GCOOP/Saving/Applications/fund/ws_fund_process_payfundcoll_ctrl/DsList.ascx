<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.fund.ws_fund_process_payfundcoll_ctrl.DsList" %>
        ...
        <ItemTemplate>
            <tr>
              ...
              <%--  <td>
                ...
                <td>
                    <asp:TextBox ID="fundbalance" runat="server" Style="text-align: right;" ToolTip="#,##0.00" OnKeyPess="return chkNumber(this)"></asp:TextBox>
                </td> 
            </tr>
        </ItemTemplate>
    </asp:Repeater>
