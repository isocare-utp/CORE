<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_kp_slcls_day_master.aspx.cs" Inherits="Saving.Applications.keeping.w_sheet_kp_slcls_day_master" %>
            ...
            <tr>
                <td colspan="3">
                    <dw:WebDataWindowControl ID="Dw_option" runat="server" AutoRestoreContext="False"
                        ...
                        ClientScriptable="True" DataWindowObject="d_slclssrv_prc_day_option" LibraryList="~/DataWindow/keeping/kp_slcls_day.pbl"
