<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_kp_det_detail.aspx.cs" Inherits="Saving.Applications.keeping.w_sheet_kp_det_detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    <dw:WebDataWindowControl ID="Dw_main" runat="server" DataWindowObject="d_kp_det_main"
        LibraryList="~/DataWindow/keeping/kp_det_detail.pbl" ClientScriptable="True"
