<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_kp_req_keepexpense.aspx.cs"
    Inherits="Saving.Applications.keeping.w_sheet_kp_req_keepexpense" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_kp_req_expense_main"
        LibraryList="~/DataWindow/keeping/kp_recieve_store.pbl" ClientScriptable="True"
     ...
     <table style="width: 100%;">
        <tr>
            <td align="left">
                <span style="cursor: pointer" onclick="OnClickAddRow();">เพิ่มแถว
                    </span>
            </td>
            <td align="right">
            </td>
