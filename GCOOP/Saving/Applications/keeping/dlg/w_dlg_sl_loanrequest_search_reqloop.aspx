<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_loanrequest_search_reqloop.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_sl_loanrequest_search_reqloop" %>
        ...
        <tr>
            <td>
                ...
                <dw:WebDataWindowControl ID="dw_detail" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
                    ClientEventClicked="selectRow" DataWindowObject="d_sl_loanrequest_search_list_reqloop"
