<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_loanrequest_loanrightchoose.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_sl_loanrequest_loanrightchoose" %>
...
<body>
    ...
    <table style="width: 100%;">
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_collright" runat="server" AutoRestoreContext="False"
                    ...
                    ClientEventClicked="OnDwCollRightClick" DataWindowObject="d_sl_loanrequest_loanrightchoose"
        ...
        <tr>
            <td>
                <asp:Button ID="btn_confirm" runat="server" Text="ยืนยัน" OnClick="btn_confirm_Click" />
            </td>
        </tr>
    </table>
