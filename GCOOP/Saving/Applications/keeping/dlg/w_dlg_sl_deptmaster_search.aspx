<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_deptmaster_search.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_deptmaster_search" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function selectRow(sender, rowNumber, objectName) {
            ...
            window.opener.GetContFromDlg(member_no);
            window.close();
        }
...
<body>
    ...
    <dw:WebDataWindowControl ID="dw_data" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
        ...
        LibraryList="~/DataWindow/shrlon/sl_deptmaster_search.pbl" 
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_sl_deptmaster_search_list"
        LibraryList="~/DataWindow/shrlon/sl_deptmaster_search.pbl" RowsPerPage="14"
