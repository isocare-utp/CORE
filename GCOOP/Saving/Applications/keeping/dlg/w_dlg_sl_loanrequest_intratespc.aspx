<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_loanrequest_intratespc.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_sl_loanrequest_intratespc" %>
        ...
        <tr>
            <td>
                ...
                <dw:WebDataWindowControl ID="dw_intspc" runat="server" AutoRestoreContext="False"
                    ...
                    ClientEventButtonClicked="OnDwIntSpcButtonClicked" DataWindowObject="d_sl_loanrequest_intratespc"
                    LibraryList="~/DataWindow/shrlon/sl_loan_requestment.pbl" ClientFormatting="True"
                    ClientEventItemChanged="ItemChangeDwIntSpc">
