<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_loanrequest_search_all.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_sl_loanrequest_search_all" %>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    DataWindowObject="d_sl_loanrequest_search_criteria" LibraryList="~/DataWindow/shrlon/sl_loan_requestment.pbl"
