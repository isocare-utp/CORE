<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_search_mb.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_search_mb" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function selectRow(sender, rowNumber, objectName) {
            ...
            window.opener.GetMemSeachMb(memberno);
            window.close();
        }
    </script>
...
<body>
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_sl_membsrch_list_memno2" LibraryList="~/DataWindow/keeping/sl_member_search.pbl"
