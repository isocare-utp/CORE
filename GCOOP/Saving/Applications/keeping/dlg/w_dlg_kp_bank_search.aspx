<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_kp_bank_search.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_kp_bank_search" %>
...
<body>
    ...
    <table style="width: 530px;">
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" DataWindowObject="d_kp_bankserch_criteria"
                    LibraryList="~/DataWindow/keeping/kp_dlg_bank_search.pbl" ClientScriptable="True"
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_dlg_kp_bank_list" LibraryList="~/DataWindow/keeping/kp_dlg_bank_search.pbl"
