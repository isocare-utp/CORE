<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_RunCfbalProcess_progessbar.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_RunCfbalProcess_progessbar" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ผลการประมวลผลยืนยันยอด</title>
        ...
        try{
            ...
            if(statusProcess!=1){
                if( isNaN(pc) ){
                    ...
                    Gcoop.GetEl("AjaxStatus").innerHTML = arr[7] + " "  + pc + "%";
                }
            }
            if(arr[0] == 1){
                statusProcess = 1;
    ...
    function CallAjax()
    {
        try{
            ...
            var urls = opener.Gcoop.GetUrl() + "Applications/shrlon/AjaxSlCfbalProcess.aspx" + queryStr1; 
