<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_member_new_search.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_sl_member_new_search" %>
...
<body>
    ...
    <table style="width: 530px;">
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_sl_member_new_search_criteria"
                    LibraryList="~/DataWindow/Shrlon/sl_member_new_search.pbl">
                </dw:WebDataWindowControl>
            </td>
            <td>
                <asp:Button ID="pb_search" runat="server" Text="ค้นหา" Height="80px" Width="55px"
                    OnClick="pb_search_Click" />
            </td>
        </tr>
    </table>
    รายละเอียด
