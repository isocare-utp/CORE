<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_popup_withdraw.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_sl_popup_withdraw" %>
    ...
    <script type="text/javascript">
        ...
        function OnDwMainItemChanged(s, r, c, v) {
            ...
            if (c == "operate_tdate") {
                ...
                s.SetItem(r, c, v);
                s.AcceptText();
                Gcoop.GetEl("Hfmoneytype_code").value = s.GetItem(r, "moneytype_code");
                fittermoneytype();
        ...
        <tr>
            <td>
                ...
                <dw:WebDataWindowControl ID="DwOperateLoan" runat="server" DataWindowObject="d_sl_payinslip_loan"
                    ...
                    ClientEventClicked="OnDwLoanItemClicked" ClientFormatting="True" 
                    ClientEventItemChanged="OnDwLoanItemChanged" style="top: 0px; left: 0px">
                </dw:WebDataWindowControl>
                <br />
