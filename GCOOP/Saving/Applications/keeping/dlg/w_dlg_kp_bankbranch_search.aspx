<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_kp_bankbranch_search.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_kp_bankbranch_search" %>
    ...
    <script type="text/javascript">
        function selectRow(sender, rowNumber, objectName) {
            if (objectName != "datawindow") {
                ...
                try {
                    window.opener.GetBankBranchFromDlg(branch_id);
                    window.close();
                } catch (err) {
                    parent.GetBankBranchFromDlg(branch_id);
                    parent.RemoveIFrame();
                }
            }
        }
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" DataWindowObject="d_kp_bankbranchserch_criteria"
                    LibraryList="~/DataWindow/keeping/kp_dlg_bankbranch_search.pbl" ClientScriptable="True"
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_dlg_kp_bankbranch_list" LibraryList="~/DataWindow/keeping/kp_dlg_bankbranch_search.pbl"
