<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_RunPostProcess_Progress.aspx.cs"
    Inherits="Saving.Applications.keeping.dlg.w_dlg_RunPostProcess_Progress" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ผลการประมวลผลตัดยอด</title>
    ...
    {
        try{
            var urls = opener.Gcoop.GetUrl() + "Applications/keeping/AjaxKpPostProcess.aspx"; 
