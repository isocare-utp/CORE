<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cmucfbankfeerate.ascx.cs"
    Inherits="Saving.Applications.keeping.u_cmucfbankfeerate" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_cmucfbankfeerate"
