<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_lnucfcollmasttype.ascx.cs"
    Inherits="Saving.Applications.keeping.u_lnucfcollmasttype" %>
<%@ Register Assembly="WebDataWindow" Namespace="Sybase.DataWindow.Web" TagPrefix="dw" %>

<script type="text/javascript">
    function OnButtonClick(sender, row, name) {
        if (name == "b_delete") {
            var detail = "รหัสประเภทหลักทรัพย์ : " + objdw_main.GetItem(row, "collmasttype_code");
...
<table style="width: 100%;">
    <tr>
        <td align="center">
            ...
            <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_lnucfcollmasttype"
