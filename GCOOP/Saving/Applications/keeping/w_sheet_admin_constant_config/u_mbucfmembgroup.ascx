<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_mbucfmembgroup.ascx.cs"
    Inherits="Saving.Applications.keeping.u_mbucfmembgroup" %>
...
<dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_mbucfmembgroup"
