<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_shucfshritemtype.ascx.cs" Inherits="Saving.Applications.keeping.u_shucfshritemtype" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if(name == "b_delete"){
                var detail = "รหัส " + objdw_main.GetItem(row, "shritemtype_code");
                detail += " : " + objdw_main.GetItem(row, "shritemtype_desc");
...
<dw:WebDataWindowControl ID="dw_main" runat="server"
    DataWindowObject="d_shucfshritemtype" 
