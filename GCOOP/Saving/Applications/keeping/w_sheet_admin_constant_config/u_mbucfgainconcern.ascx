<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_mbucfgainconcern.ascx.cs" Inherits="Saving.Applications.keeping.u_mbucfgainconcern" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if(name == "b_delete"){
                var detail = "รหัส " + objdw_main.GetItem(row, "concern_code");
                detail += " : " + objdw_main.GetItem(row, "gain_concern");
...
<dw:WebDataWindowControl ID="dw_main" runat="server"
    DataWindowObject="d_mbucfgainconcern" 
