<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_mbucfdepartment.ascx.cs" Inherits="Saving.Applications.keeping.u_mbucfdepartment" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if(name == "b_delete"){
                var detail = "รหัส " + objdw_main.GetItem(row, "department_code");
                detail += " : " + objdw_main.GetItem(row, "department_desc");
...
<dw:WebDataWindowControl ID="dw_main" runat="server"
    DataWindowObject="d_mbucfdepartment" 
