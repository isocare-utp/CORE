<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_mbucfresigncause.ascx.cs"
    Inherits="Saving.Applications.keeping.u_mbucfresigncause" %>
...
<script type="text/javascript">
    function OnButtonClick(sender, row, name) {
        if (name == "b_delete") {
            var detail = "รหัส " + objdw_main.GetItem(row, "resigncause_code");
            detail += " : " + objdw_main.GetItem(row, "resigncause_desc");
...
<dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_mbucfresigncause"
