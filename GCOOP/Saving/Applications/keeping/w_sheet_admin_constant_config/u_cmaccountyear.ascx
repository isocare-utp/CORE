<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cmaccountyear.ascx.cs"
    Inherits="Saving.Applications.keeping.u_cmaccountyear" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_cmaccountyear"
    ...
    ClientScriptable="True" RowsPerPage="20" ClientFormatting="True" AutoSaveDataCacheAfterRetrieve="True" AutoRestoreDataCache="True" AutoRestoreContext="False">
