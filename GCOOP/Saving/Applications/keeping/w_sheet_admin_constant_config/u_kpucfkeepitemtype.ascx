<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_kpucfkeepitemtype.ascx.cs"
    Inherits="Saving.Applications.keeping.u_kpucfkeepitemtype" %>
...
<script type="text/javascript">
    function OnButtonClick(sender, row, name) {
        if (name == "b_delete") {
            var detail = "รหัส " + objDwMain.GetItem(row, "keepitemtype_code");
            detail += " : " + objDwMain.GetItem(row, "keepitemtype_desc");
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_kpucfkeepitemtype"
