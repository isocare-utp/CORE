<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_kpucftofromaccid.ascx.cs"
    Inherits="Saving.Applications.keeping.u_kpucftofromaccid" %>
...
<script type="text/javascript">
    function OnButtonClick(sender, row, name) {
        if (name == "b_delete") {
            var detail = "รหัส " + objDwMain.GetItem(row, "account_id");
            detail += " : " + objDwMain.GetItem(row, "account_desc");
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_kpucftofromaccid"
