<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_mb_update_salary.aspx.cs" Inherits="Saving.Applications.keeping.w_sheet_mb_update_salary_ctrl.w_sheet_mb_update_salary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#ctl00_ContentPlace_ReportIR').click(function () {
                LoadDatatxt();
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table width='200px'>
        ...
        <tr>
            <td>
                <asp:Button ID="ReportIR" runat="server" Text="Report ข้อมูลเงินเดือน" />
            </td>
        </tr>
        <tr>
            <td>
