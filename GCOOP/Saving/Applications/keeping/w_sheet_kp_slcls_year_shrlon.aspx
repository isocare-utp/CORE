<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_kp_slcls_year_shrlon.aspx.cs" Inherits="Saving.Applications.keeping.w_sheet_kp_slcls_year_shrlon" %>
    ...
    <script type="text/JavaScript">
        ...
        function SheetLoadComplete() {
            if (Gcoop.GetEl("Hd_process").value == "true") {
                Gcoop.OpenProgressBar("ประมวลผลปิดสิ้นปีหุ้นหนี้", true, true, ProcClsYearComplete);
            }
        }
            ...
            <tr>
                <td colspan="3">
                    <dw:WebDataWindowControl ID="Dw_option" runat="server" 
                        ...
                        ClientScriptable="True" DataWindowObject="d_slclssrv_prc_year_shrlon_option" 
                        LibraryList="~/DataWindow/keeping/kp_slcls_year_shrlon.pbl" 
