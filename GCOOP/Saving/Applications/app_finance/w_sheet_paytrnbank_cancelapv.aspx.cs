...
{
    public partial class w_sheet_paytrnbank_cancelapv : PageWebSheet,WebSheet
    {
        ...
        private void JsPostDetail()
        {
            ...
            {
                String xmlMain = "";
                xmlMain = finService.of_getlistcancel_moneyorder(state.SsWsPass, date);
                DwDetail.Reset();
        ...
        private void JsCheckAll()
        {
            ...
            {
                DwDetail.SetItemDecimal(i, "paytrnbank_status", Set);
            }
        }
        ...
        public void SaveWebSheet()
        {
            ...
            try
            {
                ...
                finService.of_cancel_moneyorder(state.SsWsPass, xmlDetail, state.SsUsername, state.SsWorkDate);
