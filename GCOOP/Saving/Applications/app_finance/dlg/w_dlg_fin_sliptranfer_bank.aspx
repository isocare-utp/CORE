<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_fin_sliptranfer_bank.aspx.cs" Inherits="Saving.Applications.app_finance.dlg.w_dlg_fin_sliptranfer_bank" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function selectRow(sender, rowNumber, objectName) {
            ...
            var slip_tran = objDwList.GetItem(rowNumber, "sliptrandoc_no");
            window.opener.GetValueSlipFromDlg(slip_tran);
            window.close();
        }
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="d_fn_sliptranbanksearch_list"
