<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_member_search.aspx.cs"
    Inherits="Saving.Applications.app_finance.dlg.w_dlg_sl_member_search" %>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" 
                    DataWindowObject="d_sl_membsrch_criteria"
                    LibraryList="~/DataWindow/mbshr/kp_recieve_return.pbl" 
