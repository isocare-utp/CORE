<%@ Page Title="" Language="C#" MasterPageFile="~/FrameDialog.Master" AutoEventWireup="true"
    CodeBehind="ws_dlg_fin_member_search.aspx.cs" Inherits="Saving.Applications.app_finance.dlg.ws_dlg_fin_member_search_ctrl.ws_dlg_fin_member_search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function OnDsListClicked(s, r, c) {
            ...
            try {
                window.opener.GetMemNoFromDlg(memberno);
                window.close();
            } catch (err) {
                parent.GetMemNoFromDlg(memberno);
                parent.RemoveIFrame();
            }
        }
    </script>
