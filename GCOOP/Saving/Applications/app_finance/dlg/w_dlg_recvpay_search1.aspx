<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_recvpay_search1.aspx.cs"
    Inherits="Saving.Applications.app_finance.dlg.w_dlg_recvpay_search1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DwMainClick(sender, rowNumber, objectName) {
            ...
            //            window.opener.GetValueFromDlgItemType(slipitemtype_code, item_desc);
            //            window.close();
        ...
        function DwMainSummitClick() {
            ...
            if (rowNumber == "") {
                ...
                var slipitemtype_code = objDwMain.GetItem(rowNumber, "slipitemtype_code");
                //var item_desc = objDwMain.GetItem(rowNumber, "item_desc");
                parent.GetValueFromDlgItemTypeacc(slipitemtype_code);
                parent.RemoveIFrame();
            }
        }
