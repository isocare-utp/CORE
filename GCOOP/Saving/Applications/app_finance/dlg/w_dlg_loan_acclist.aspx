<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_loan_acclist.aspx.cs"
    Inherits="Saving.Applications.app_finance.dlg.w_dlg_loan_acclist" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function DwMainOnClick(sender, row, collumn) {
            ...
            opener.GetLoanAcc(loancontract_no);
            window.close();
        }
...
<body>
    ...
    <div>
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_loan_account_list"
