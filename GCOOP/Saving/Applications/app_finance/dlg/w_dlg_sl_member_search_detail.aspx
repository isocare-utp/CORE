<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_member_search_detail.aspx.cs" Inherits="Saving.Applications.app_finance.dlg.w_dlg_sl_member_search_detail" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function selectRow(sender, rowNumber, objectName) {
                ...
                window.opener.GetMemDetFromDlg(memberno, prename_desc , memb_name, memb_surname);
                window.close();
        }
    </script>
</head>
