...
{
    public partial class w_sheet_finslip_spc_others_noslip : PageWebSheet, WebSheet
    {
        ...
        {
            Int32 result;
            String as_memb_xml = "", slipdet_Xml = "", slipcancel_Xml = "" ;
            ...
            try
            {
                ...
                result = fin.of_init_postotherto_fin(state.SsWsPass,ref as_memb_xml,ref slipdet_Xml,ref slipcancel_Xml, state.SsApplication);
                ...
                {
                    DwList.Reset();
                    DwList.ImportString(slipdet_Xml, FileSaveAsType.Xml);
                }
                if (slipcancel_Xml != "")
                {
                    DwCancelList.Reset();
