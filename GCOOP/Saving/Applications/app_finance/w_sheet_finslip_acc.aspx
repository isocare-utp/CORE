<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_finslip_acc.aspx.cs" Inherits="Saving.Applications.app_finance.w_sheet_finslip_acc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MenubarOpen() {
            Gcoop.OpenDlg('675', '400', 'w_dlg_accconfrim.aspx');
        }
...
/*                if (Gcoop.GetEl("HprintTax").value == "true") {
        ...
        $(function () {
            ...
            $('input[name="entry_tdate_0"]').change(function () {
                $('input[name="operate_tdate_0"]').val($('input[name="entry_tdate_0"]').val());
                objDwMain.SetItem(1, "operate_tdate", $('input[name="entry_tdate_0"]').val());
                objDwMain.SetItem(1, "entry_tdate", $('input[name="entry_tdate_0"]').val());

                postDate();
            });

            $('input[name="operate_tdate_0"]').change(function () {
                objDwMain.SetItem(1, "operate_tdate", $('input[name="operate_tdate_0"]').val());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_fin_slipspc_peapia"
