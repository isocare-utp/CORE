        ...
        private void JsPostMember()
        {
            try
            {
                ...
                try
                {
                    ...
                    DwUtil.ImportData(slipcancle.xml_memdet, dw_main, tdwhead, FileSaveAsType.Xml);
                ...
                try
                {
                    ...
                    DwUtil.ImportData(slipcancle.xml_sliplist, dw_list, tdwhead, FileSaveAsType.Xml);
                }
                catch (Exception ex)
                {
        ...
        private void JsPostPayInList()
        {
            try
            {
                ...
                try
                {
                    ...
                    DwUtil.ImportData(slipcancle.xml_sliphead, dw_head, tdwhead, FileSaveAsType.Xml);
                    if (dw_head.RowCount > 1)
                    {
                        dw_head.DeleteRow(dw_head.RowCount);
                    }
                ...
                try
                {
                    ...
                    DwUtil.ImportData(slipcancle.xml_slipdetail, dw_detail, tdwhead, FileSaveAsType.Xml);
