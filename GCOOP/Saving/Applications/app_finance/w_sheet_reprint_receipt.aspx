<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_reprint_receipt.aspx.cs" Inherits="Saving.Applications.app_finance.w_sheet_reprint_receipt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_loansrv_prn_payinslipcriteria"
        ...
        Width="720px" ClientEventItemChanged="ItemChanged" TabIndex="1"  Visible="false"
