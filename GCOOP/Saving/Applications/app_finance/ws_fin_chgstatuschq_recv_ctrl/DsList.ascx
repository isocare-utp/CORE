<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.app_finance.ws_fin_chgstatuschq_recv_ctrl.DsList" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr >
                ...
                <td colspan = "3">
                        <asp:TextBox ID="REFERDOC_NAME" runat="server" Style="text-align:left; width:98%" ReadOnly="True"></asp:TextBox>
            ...
            <tr>
                ...
                <td rowspan ="2">
                        <asp:TextBox ID="CHEQUE_AMT" runat="server" style="background-color:Black; color:#00FF00; font-size:40px; height:50px; text-align:right" ReadOnly="True" ToolTip="#,##0.00"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
