<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.app_finance.w_sheet_paychq_fromslip_ctrl.DsMain" %>
    ...
    <EditItemTemplate>       
        <table class="DataSourceFormView">
            ...
            <tr>                            
                ...
                <td>
                    <asp:TextBox ID="as_fromaccno" runat="server" Style="text-align: center;" Width="177px"></asp:TextBox>
                    <asp:Button ID="b_accno" runat="server" Text="..." Width="30px" />               
                </td>
            </tr>
        </table>
        <br />
        <table class="DataSourceFormView">
            <tr>
                ...
                <td width="30%">
                    <asp:RadioButtonList ID="ai_prndate"  runat="server" RepeatDirection="Horizontal">
            ...
            <tr>
                ...
                <td>
                     <asp:DropDownList ID="ai_chqstatus" runat="server">
                        <asp:ListItem Value="0">ค้างจ่าย</asp:ListItem>
                        <asp:ListItem Value="8">ระหว่างทาง</asp:ListItem>
                ...
                <td>
                    <asp:RadioButtonList ID="ai_killer"  runat="server" RepeatDirection="Horizontal">
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="ai_payee"  runat="server" RepeatDirection="Horizontal">
