<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_fnucftaxtype.ascx.cs"
    Inherits="Saving.Applications.app_finance.u_funcftaxtype" %>
...
<dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_fnucftaxtype"
