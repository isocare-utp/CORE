<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_fnucfchequetype.ascx.cs" 
Inherits="Saving.Applications.app_finance.u_fnucfchequetype" %>
...
<dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_fnucfchequetype"
