<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_fnucfictaxtype.ascx.cs"
    Inherits="Saving.Applications.app_finance.u_fnucfictaxtype" %>
...
<dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_fnucfictaxtype"
