<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_slip_cancel_day.aspx.cs" Inherits="Saving.Applications.app_finance.w_sheet_sl_slip_cancel_day" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
       ...
       //     alert(Gcoop.GetEl("HfSlipNo").value);
            jsPostPayInList();
        }
