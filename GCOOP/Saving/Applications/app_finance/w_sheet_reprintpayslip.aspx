<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_reprintpayslip.aspx.cs"
    Inherits="Saving.Applications.app_finance.w_sheet_reprintpayslip" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="d_reprintpay_list"
        LibraryList="~/DataWindow/App_finance/reprintpayslip.pbl" AutoRestoreContext="False"
        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
