<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_paytrnbank_cash.aspx.cs"
    Inherits="Saving.Applications.app_finance.w_sheet_paytrnbank_cash" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDwDetailClicked(sender ,rowNumber, colunmName){
            Gcoop.CheckDw(sender,rowNumber,colunmName,"post_flag",1,0);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="500px" ScrollBars="Vertical">
        <dw:WebDataWindowControl ID="DwDetail" runat="server" AutoRestoreContext="False"
            ...
            DataWindowObject="d_fn_paytrnbank_cash_list" LibraryList="~/DataWindow/app_finance/paytrnbank.pbl"
