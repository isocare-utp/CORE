...
{
    public partial class w_sheet_paytrnbank_cash : PageWebSheet, WebSheet
    {
        ...
        private void JsPostDetail()
        {
            ...
            try
            {
                //service
                String xmlMain = "";
                xmlMain = finService.of_getlistappr_moneyorder(state.SsWsPass, date);
                DwDetail.Reset();
        ...
        public void SaveWebSheet()
        {
            ...
            try
            {
                DwDetail.SetFilter("post_flag = 1");
                DwDetail.Filter();

                xmlDetail = DwDetail.Describe("DataWindow.Data.XML");
                finService.of_approve_moneyorder(state.SsWsPass, xmlDetail, state.SsUsername, state.SsWorkDate);
