...
{
    public partial class w_dlg_dp_account_search_click : PageWebDialog, WebDialog
    {
        ...
        public void WebDialogLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                DwMain.InsertRow(0);
                DwUtil.RetrieveDataWindow(dw_detail, "dp_slip.pbl", null, HdCoopid.Value);
            }
            else
            {
