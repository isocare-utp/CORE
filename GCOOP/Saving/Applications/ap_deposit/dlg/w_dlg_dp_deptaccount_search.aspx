<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_dp_deptaccount_search.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.dlg.w_dlg_dp_deptaccount_search" %>
...
<body>
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_dlg_dp_deptaccount_list" LibraryList="~/DataWindow/ap_deposit/dp_reqdeposit.pbl"
