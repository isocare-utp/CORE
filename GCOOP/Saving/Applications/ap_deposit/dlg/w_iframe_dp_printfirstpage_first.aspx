<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_iframe_dp_printfirstpage_first.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.dlg.w_iframe_dp_printfirstpage_first" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>พิมพ์ปกนอก</title>
    <%=initJavaScript %>
    <%=printFirstPage%>
