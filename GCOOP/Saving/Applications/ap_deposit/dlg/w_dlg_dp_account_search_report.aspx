<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_dp_account_search_report.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.dlg.w_dlg_dp_account_search_report" ValidateRequest="false" %>
...
//        function DwDetailButtonClick(sender, row, buttonName) {
//            if (buttonName == "btnsubmitlist") {
//                PostAccountList();
//            }
//        }
...
<body>
    ...
    <div>
        ...
        <table>
            <tr>
                <td valign="top" width="550">
                    ...
                    <dw:WebDataWindowControl ID="DwMain" runat="server" ClientScriptable="True" DataWindowObject="d_dp_depmaster_criteria"
                        LibraryList="~/DataWindow/ap_deposit/dept_search_account.pbl" Width="530px" HorizontalScrollBar="NoneAndClip"
        ...
        <br />
        <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_dept_search_deptaccount"
            LibraryList="~/DataWindow/ap_deposit/dept_search_account.pbl" Width="600px" Style="top: 0px;
