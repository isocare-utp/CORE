<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_dp_taxrateduring.aspx.cs" Inherits="Saving.Applications.ap_deposit.dlg.w_dlg_dp_taxrateduring" %>
...
<body>
    ...
    <div>
        ...
        <dw:WebDataWindowControl ID="DwMain" runat="server" AutoRestoreContext="False" 
            ...
            ClientScriptable="True" DataWindowObject="d_dp_depttype_taxrateduring" 
