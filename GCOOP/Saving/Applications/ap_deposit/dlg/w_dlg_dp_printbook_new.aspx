<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_dp_printbook_new.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.dlg.w_dlg_dp_printbook_new" %>
...
<body>
    ...
    <div>
            ...
            <tr>
                <td>
                 <dw:WebDataWindowControl ID="DwStm" runat="server" AutoRestoreContext="False"
                    ...
                    LibraryList="~/DataWindow/ap_deposit/dp_conteck.pbl" RowsPerPage="10" ClientScriptable="True"
        ...
        <br />
        <dw:WebDataWindowControl ID="DwPrintPrompt" runat="server" DataWindowObject="d_dppbk_prompt_print_new"
            LibraryList="~/DataWindow/ap_deposit/dp_slip.pbl" AutoRestoreContext="False"
