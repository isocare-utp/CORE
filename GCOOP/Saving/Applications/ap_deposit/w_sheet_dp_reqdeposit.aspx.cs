    ...
    //    private DepositClient depService;
      //  private CommonClient cmdService;
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            {
                string recppaytypeCode = DwMain.GetItemString(1, "recppaytype_code");
                if (recppaytypeCode == "OTR")
                {
                    DwMain.SetItemString(1, "tofrom_accid", "21312000");
                }
                else if (recppaytypeCode == "OTS")
                {
                    DwMain.SetItemString(1, "tofrom_accid", "21319000");
                }
                JsPostCoop();
            }
        ...
        private void JsPostMemberNo()
        {
            ...
            if (deptType == "01")
            {
                DwMain.SetItemString(1, "recppaytype_code", "OTR");
                DwMain.SetItemString(1, "tofrom_accid", "21317000");
            }
            else if (deptType == "02")
            {
                DwMain.SetItemString(1, "recppaytype_code", "OTR");
            ...
            {
                DwMain.SetItemString(1, "recppaytype_code", "OTR");
                DwMain.SetItemString(1, "tofrom_accid", "21318000");
            }
            else if (deptType == "05")
            {
                DwMain.SetItemString(1, "recppaytype_code", "OTR");
