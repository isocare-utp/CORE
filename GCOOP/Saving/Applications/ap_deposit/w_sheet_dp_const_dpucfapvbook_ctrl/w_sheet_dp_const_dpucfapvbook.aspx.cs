...
{
    /// <summary>
    /// หน้าจอกำหนด ผู้ลงนามหนังสือรับรองเงินฝาก
    /// </summary>
    public partial class w_sheet_dp_const_dpucfapvbook : PageWebSheet, WebSheet
    {
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostNewRow)
            {
                ...
                dsList.SetItem(0, dsList.DATA.COOP_IDColumn, state.SsCoopControl);//set vaule to primary key
            }
