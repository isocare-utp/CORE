<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_cmdconfig_domain.ascx.cs"
    Inherits="Saving.Applications.u_cm_cmdconfig_domain" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="dw_cmd_domain_mas"
    LibraryList="~/DataWindow/Cmd/cm_constant_config.pbl" ClientScriptable="True"
    Width="750px" ClientEventButtonClicked="OnButtonClick" Height="500px" UseCurrentCulture="True"
    RowsPerPage="15">
