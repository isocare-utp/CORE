<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_hr_constant_department.ascx.cs"
    Inherits="Saving.Applications.u_cm_hr_constant_department" %>
