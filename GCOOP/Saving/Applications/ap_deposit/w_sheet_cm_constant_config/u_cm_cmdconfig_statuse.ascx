<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_cmdconfig_statuse.ascx.cs"
    Inherits="Saving.Applications.u_cm_cmdconfig_statuse" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="ptucfstageuse"
    LibraryList="~/DataWindow/Cmd/cm_constant_config.pbl" Width="560px" ClientEventButtonClicked="OnButtonClick"
    Height="300px">
