...
namespace Saving.Applications.ap_deposit.w_sheet_dp_slip_saving_ctrl
{
    public partial class SlipMaster : ControlDataWeb, IDataWeb
    {
        ...
        public string meta_pk1 = "coop_id";
        public string meta_pk2 = "deptaccount_no";
        public string meta_sql = @"
        select 
            '' as deptslip_no,
	        (select workdate from amappstatus where application = :arg_application and coop_control = :arg_coop_control ) as deptslip_date,
	        0.00 as deptslip_amt,
	        'CSH' as cash_type,
	        ...
	        0.00 as int_return ,
	        1 as item_status,
	        (select closeday_status from amappstatus where application = :arg_application and coop_id = :arg_coop_control )  closeday_status,
	        '' as recppaytype_code,
	        0.00 as other_amt,
	        ...
	        0 as spint_status,
	        0 as send_gov,
	        :arg_coop_id as coop_id,
	        :arg_coop_control as deptcoop_id,
	        '' as group_itemtpe,
	        0.00 as tax_return,
        ...
        from dpdeptmaster d
        where 
	        d.coop_id = :arg_coop_control and 
        ...
        public string arg_coop_control;
        ...
        private decimal fdb_deptslip_amt;
        public decimal Fdb_deptslip_amt
        {
