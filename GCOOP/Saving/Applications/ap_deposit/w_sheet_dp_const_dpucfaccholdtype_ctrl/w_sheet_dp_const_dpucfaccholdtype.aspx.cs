...
{
    /// <summary>
    /// กำหนดประเภทผู้ถือบัญชี
    /// </summary>
    public partial class w_sheet_dp_const_dpucfaccholdtype : PageWebSheet, WebSheet
    {
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostNewRow)
            {
                ...
                dsList.SetItem(0, dsList.DATA.COOP_IDColumn, state.SsCoopControl);//set ค่าให้ primary key
            }
