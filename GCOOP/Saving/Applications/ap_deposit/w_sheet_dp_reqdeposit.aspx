    ...
    <script type="text/javascript">
        ...
        function OnDwMainButtonClicked(sender, rowNumber, buttonName) {
            if (buttonName == "b_member") {
                ...
                Gcoop.OpenIFrame(485, 489, "w_dlg_dp_current_account_no.aspx", "");
            }

            else if (buttonName == "cb_referslip") {
                var recpPayType = objDwMain.GetItem(rowNumber, "recppaytype_code");
                if (recpPayType == "OTR") {
                    Gcoop.OpenDlg(650, 600, "w_dlg_dp_slip_search_reqdeptran.aspx", "?member_no=" + objDwMain.GetItem(1, "member_no"));
                }
            }
            else if (buttonName == "b_search") {
                var memberFlag = objDwMain.GetItem(rowNumber, "member_flag");
                if (memberFlag == 1) {
                    Gcoop.OpenIFrame(550, 590, "w_dlg_dp_deptaccount_search.aspx", "?member_no=" + objDwMain.GetItem(1, "member_no"));
                } else {
                    Gcoop.OpenIFrame(580, 590, "w_dlg_dp_deptaccount_search.aspx", "");
                }
            }
