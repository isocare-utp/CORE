<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SlipMaster.ascx.cs"
    Inherits="Saving.Applications.ap_deposit.w_sheet_dp_upnewbook_ctrl.SlipMaster" %>
<style type="text/css">
    *
    {
        padding: 0;
    ...
    <InsertItemTemplate>
        ...
        <table width="760" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td width="22%">
                    <asp:DropDownList ID="Fdb_deptcoop_id" Width="70px" BackColor="#FFFFBB" runat="server"
                        DataTextField="coop_id" DataValueField="coop_id" SelectedValue='<%#Bind("Fdb_deptcoop_id")%>'
                ...
                <td width="21%">
                    <asp:DropDownList ID="Fdb_recppaytype_code" Width="122" BackColor="#FFFFBB" runat="server"
                        ...
                        <asp:ListItem Value=""></asp:ListItem>
                        <asp:ListItem Value="SAVE">+ บันทึกเลขสมุด</asp:ListItem>
                        <asp:ListItem Value="PRINT">+ พิมพ์สมุด</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td width="12%">
                ...
                <td height="50" colspan="6">
                    <table>
                        <tr>
                            ...
                            <td width="50%">
                                <asp:Label ID="Label5" runat="server" Text="รหัสบาร์โคด:" CssClass="LabelFormView1" Height="30px"
                                    Width="130px" Font-Size="18px"></asp:Label>
                                <asp:TextBox ID="Fdb_deptslip_amt" runat="server" Text='<%#Eval("Fdb_deptslip_amt")%>'
