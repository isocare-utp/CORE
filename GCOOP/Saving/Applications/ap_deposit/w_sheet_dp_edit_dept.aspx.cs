        ...
        public void SaveWebSheet()
        {
            try
            {
                ...
                if (deptAccNo != "" && deptAccNo != null)
                {
                    ...
                    {
                        String deptaccount_name,deptaccount_ename,eaddress;
                        try
                        {
                        ...
                        try
                        {
                            eaddress = DwMain.GetItemString(1, "eaddress");
                        }
                        catch { eaddress = ""; }
                        try
                        {
                            string update_main = @"update DPDEPTMASTER set deptaccount_name = '" + deptaccount_name + @"', deptaccount_ename = '" + deptaccount_ename + @"', 
                            update_byentryid = '" + state.SsUsername + "', update_byentryip = '" + state.SsClientIp + @"', eaddress = '" + eaddress + @"'
