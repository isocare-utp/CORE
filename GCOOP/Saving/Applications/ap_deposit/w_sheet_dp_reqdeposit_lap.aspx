<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_dp_reqdeposit_lap.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.w_sheet_dp_reqdeposit_lap" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MenubarNew() {
            window.location = Gcoop.GetUrl() + "Applications/ap_deposit/w_sheet_dp_reqdeposit_lap.aspx";
        }
        ...
        function OnDwGainButtonClicked(sender, rowNumber, buttonName) {
            if (buttonName == "b_codep") {
                ...
                Gcoop.OpenIFrame(600, 500, "w_dlg_dp_reqdetail_lap.aspx", "?seq_no=" + objDwGain.GetItem(rowNumber, "seq_no"));
            }
        }
        ...
        function SheetLoadComplete() {
            ...
            if (Gcoop.GetEl("HdSaveAccept").value == "true") {
                ...
                Gcoop.OpenIFrame(450, 150, "w_iframe_dp_printfirstpage_lap.aspx", "?deptAccountNo=" + deptAccountNo + "&deptPassBookNo=" + deptPassBookNo);
            }
