<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_dp_reqdeposit_hnd.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.w_sheet_dp_reqdeposit_hnd" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MenubarNew() {
            window.location = Gcoop.GetUrl() + "Applications/ap_deposit/w_sheet_dp_reqdeposit_hnd.aspx";
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Width="680px">
        ...
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_dp_reqdepoist_main_hnd"
