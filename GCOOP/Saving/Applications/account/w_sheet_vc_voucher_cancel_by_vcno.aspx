...
CodeBehind="w_sheet_vc_voucher_cancel_by_vcno.aspx.cs" Inherits="Saving.Applications.account.w_sheet_vc_voucher_cancel_by_vcno" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDWVcNoItemChange(s, r, c, v)//เปลี่ยนวันที่
        {
            if (v == "" || v == null) {
                alert("กรุณากรอกเลขที่ Voucher")
            } else {
                s.SetItem(1, "voucher_no", v);
                s.AcceptText();
                Gcoop.GetEl("Hdvcno").value = v; //Hiden Field เก็บข้อมูลวันที่
                postVcDate();
            }
            return 0;
        }
        ...
        <table style="width: 100%;">
                ...
                <td class="style3" valign="top">
                    <asp:Panel ID="Panel2" runat="server" Width="190px" BorderStyle="Ridge" Height="85px">
                        <dw:WebDataWindowControl ID="Dw_date" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
                            AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True" DataWindowObject="d_vc_vcedit_vcno_cancel"
                            LibraryList="~/DataWindow/account/vc_voucher_edit.pbl" ClientEventItemChanged="OnDWVcNoItemChange"
            ...
            <tr class="style1">
                <td class="style3">
                    ...
                    <asp:HiddenField ID="Hdvcno" runat="server" />
