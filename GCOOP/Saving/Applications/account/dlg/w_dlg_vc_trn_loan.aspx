<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_vc_trn_loan.aspx.cs" Inherits="Saving.Applications.account.dlg.w_dlg_vc_trn_loan" %>
                ...
                <td valign="top" class="style1" colspan="4">
                    <asp:Panel ID="Panel1" runat="server" Height="500px" ScrollBars="Horizontal" BorderStyle="Inset"
                        ...
                        <dw:WebDataWindowControl ID="Dw_main" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
                            AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True" DataWindowObject="d_vc_trnrcvgrp_loan"
                            LibraryList="~/DataWindow/account/vc_genwizard_vcdate.pbl" 
                            ClientEventButtonClicked="OnDwDataButtonClick" ClientEventClicked = "Dw_mainClick" >
