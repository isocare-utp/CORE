<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_acc_cancel_close_depreciation.aspx.cs" Inherits="Saving.Applications.account.w_acc_cancel_close_depreciation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CancelCloseYear() {
            ...
            var isconfirm = confirm("ยืนยันการยกเลิกปิดการยกยอดค่าเสื่อม ปี : " + account_year_t);
            if (isconfirm) {
                postCancelCloseYear();
            }
            return 0;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    <p>
        ...
        <table style="width: 100%; font-size: small;">
            ...
            <tr>
                <td class="style3">
                    <input id="B_cancelclose" type="button" value="ยกเลิกการยกยอดค่าเสื่อม" onclick="CancelCloseYear()" /><br />
                </td>
                <td class="style2">
