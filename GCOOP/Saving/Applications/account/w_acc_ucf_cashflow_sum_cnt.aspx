...
CodeBehind="w_acc_ucf_cashflow_sum_cnt.aspx.cs" Inherits="Saving.Applications.account.w_acc_ucf_cashflow_sum_cnt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetAccidButtonClick(sender, row, bName) {
            ...
            var cont_status = objDwmain.GetItem(row, "cont_status");
            if (accid_list == null) {
                accid_list = "";
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="Dwmain" runat="server" ClientScriptable="True" DataWindowObject="d_acc_ucf_cashflow_cnt"
