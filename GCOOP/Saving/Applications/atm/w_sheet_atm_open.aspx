<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_atm_open.aspx.cs" Inherits="Saving.Applications.atm.w_sheet_atm_open" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_atm_open"
        LibraryList="~/DataWindow/atm/dp_atm_open.pbl" ClientScriptable="True" ClientEvents="true"
    ...
    <dw:WebDataWindowControl ID="DwDetail" runat="server" DataWindowObject="d_atm_open_detail"
        LibraryList="~/DataWindow/atm/dp_atm_open.pbl" ClientScriptable="True" ClientEvents="true"
        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientFormatting="True"
