<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_atm_sequester_loan.aspx.cs" Inherits="Saving.Applications.atm.w_sheet_atm_sequester_loan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_atm_sequester_loan"
        LibraryList="~/DataWindow/atm/dp_atm_sequester_loan.pbl" ClientScriptable="True" ClientEvents="true"
