...
INSERT INTO COOP
VALUES('9999', 'COOP' , '0123456789' , 1, 1 , 0, '' , 0, sysdate , 0 , 0 , 0, 0, 1, 0 , '2111000' , '' , 0, NULL ) ;
...
insert into "SECUSER" values('1','manager', 'manager', 'manager' ,null , 2,0,'manager' ) ;
insert into "SECUSER" values('2','user', 'user', 'user' ,null , 1,0,'user' ) ;
commit;
