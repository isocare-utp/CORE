<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.mbshr.dlg.w_dlg_mbshr_trnmb_search_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 630px;">
            <tr>
                ...
                <td width="10%">
                    <asp:Button ID="b_clear" runat="server" Text="ล้างข้อมูล" />
                </td>
            </tr>
        </table>
    </EditItemTemplate>
