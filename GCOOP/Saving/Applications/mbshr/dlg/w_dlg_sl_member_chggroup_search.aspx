<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_member_chggroup_search.aspx.cs"
    Inherits="Saving.Applications.mbshr.dlg.w_dlg_sl_member_chggroup_search" %>
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" 
                    DataWindowObject="d_sl_member_chggroup_search"
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_sl_member_chggroup_list" LibraryList="~/DataWindow/mbshr/mb_req_chggroup.pbl"
