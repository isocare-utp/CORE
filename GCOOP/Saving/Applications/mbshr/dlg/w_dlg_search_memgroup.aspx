<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_search_memgroup.aspx.cs" Inherits="Saving.Applications.mbshr.dlg.w_dlg_search_memgroup" %>
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_sl_memgroup_search_criteria"
                    LibraryList="~/DataWindow/mbshr/sl_member_new.pbl">
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_sl_memgroup" LibraryList="~/DataWindow/mbshr/sl_member_new.pbl"
