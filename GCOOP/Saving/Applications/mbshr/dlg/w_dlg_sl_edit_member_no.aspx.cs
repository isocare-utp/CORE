...
namespace Saving.Applications.mbshr.dlg
{
    public partial class w_dlg_sl_edit_member_no : System.Web.UI.Page
    {
        ...
        private void of_set_meminfo()
        {
            ...
            TbMainmemno.Text = WebUtil.MemberNoFormat(ls_mainmemno);//WebUtil.StringFormat(ls_mainmemno, "000000");
            TbMainmem.Text = WebUtil.MemberNoFormat(ls_mainmemno);//WebUtil.StringFormat(ls_mainmemno, "000000");
            TbComemno.Text = WebUtil.MemberNoFormat(ls_comemno);// WebUtil.StringFormat(ls_comemno, "000000");
            TbComem.Text = WebUtil.MemberNoFormat(ls_comemno);//WebUtil.StringFormat(ls_comemno, "000000"); 
        }
