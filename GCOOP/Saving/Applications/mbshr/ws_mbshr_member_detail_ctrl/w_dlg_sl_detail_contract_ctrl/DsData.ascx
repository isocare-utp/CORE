<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsData.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_member_detail_ctrl.w_dlg_sl_detail_contract_ctrl.DsData" %>
