<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="ws_mbshr_member_detail.aspx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_member_detail_ctrl.ws_mbshr_member_detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function OnDsMainClicked(s, r, c) {
            if (c == "b_search") {
                Gcoop.OpenIFrameExtend(650, 600, 'w_dlg_sl_member_search.aspx', '')
            }
            else if (c == "b_print") {
                PopupReportshr();
            }
        ...
        function OnDsLoanClicked(s, r, c) {
            if (c == "bloan_detail") {
                ...
                Gcoop.OpenIFrame3Extend("900", "670", "w_dlg_sl_detail_contract.aspx", "?lcontno=" + ls_lcontno);
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tabs-6">เบี้ยประกัน</a></li>
            <li><a href="#tabs-7">กองทุนผู้ค้ำประกัน</a></li>
            <li><a href="#tabs-8">รูปภาพ</a></li>
            <li><a href="#tabs-9">รายการค้างชำระ</a></li>            
            <li><a href="#tabs-10">บัญชีเงินฝาก</a></li>
            <li><a href="#tabs-11">ประวัติโอนย้าย</a></li>
        </ul>
        <div id="tabs-1">
