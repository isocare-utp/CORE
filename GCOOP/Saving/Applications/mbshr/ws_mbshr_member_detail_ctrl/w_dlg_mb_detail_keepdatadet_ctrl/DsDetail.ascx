<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsDetail.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_member_detail_ctrl.w_dlg_mb_detail_keepdatadet_ctrl.DsDetail" %>
