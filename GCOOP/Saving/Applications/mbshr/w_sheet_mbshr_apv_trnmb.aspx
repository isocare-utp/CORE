<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_mbshr_apv_trnmb.aspx.cs" Inherits="Saving.Applications.mbshr.w_sheet_mbshr_apv_trnmb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDwListItemChange(s, r, c, v) {
            if (c == "trnmbreq_status") {

                objDw_list.SetItem(r, "trnmbreq_status", v);
                objDw_list.AcceptText();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    <p>
        ...
        <table style="width: 100%;">
            <tr>
                <td>
                    <dw:WebDataWindowControl ID="Dw_option" runat="server" AutoRestoreContext="False"
                        ...
                        ClientScriptable="True" DataWindowObject="d_mbsrv_list_apvtrnmb_opt" LibraryList="~/DataWindow/mbshr/mb_apv_trnmb.pbl"
            ...
            <tr>
                <td class="style1">
                    <strong>รายละเอียดอนุมัติโอนสถานภาพสมาชิกสมทบเป็นสมาชิกปกติ</strong>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Panel ID="Panel1" runat="server" Height="400px">
                        <dw:WebDataWindowControl ID="Dw_list" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
                            ...
                            DataWindowObject="d_mbsrv_list_apvtrnmb" LibraryList="~/DataWindow/mbshr/mb_apv_trnmb.pbl"
