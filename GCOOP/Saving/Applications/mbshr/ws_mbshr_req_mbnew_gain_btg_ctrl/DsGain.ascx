<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsGain.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_req_mbnew_gain_btg_ctrl.DsGain" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td width="30%">
                        <asp:TextBox ID="gain_addr" runat="server" Style="text-align: center;"></asp:TextBox>
                    </td>
                    <td width="10%">
                    ...
                    <td width="10%">
                        <asp:TextBox ID="gain_percent" runat="server" Style="text-align: center;"></asp:TextBox>
                    </td>
                    <td width="10%">
