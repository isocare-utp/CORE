<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_req_mbnew_gain_btg_ctrl.DsMain" %>
                ...
                <td>
                    ...
                    <table class="DataSourceFormView" style="width: 370px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="mather_name" runat="server" Style="font-size: 12px;"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <td>
                    <table class="DataSourceFormView" style="width: 370px;">
                        ...
                        <tr>
                            ...
                            <td width="27%">
                                <asp:DropDownList ID="position_code" runat="server">
                                </asp:DropDownList>
                            </td>
                            <td width="23%">
                                <div>
                            ...
                            <td width="27%">
                                <asp:DropDownList ID="level_code" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
