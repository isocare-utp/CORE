<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cmucfbankbranch.ascx.cs"
    Inherits="Saving.Applications.mbshr.u_cmucfbankbranch" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" ClientEventButtonClicked="OnButtonClick"
    ClientScriptable="True" DataWindowObject="d_cmucfbankbranch" LibraryList="~/DataWindow/mbshr/admin_cm_constant_config.pbl"
