<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_share_withdraw_partial.aspx.cs"
    Inherits="Saving.Applications.mbshr.w_sheet_sl_share_withdraw_partial" Title="Untitled Page" %>
            ...
            if (objectName == "operate_flag") {
               ...
               // alert(flag);
                if (flag == 1) {
                    ...
                    var bfshrcontbalamt = Gcoop.ParseFloat(objdw_main.GetItem(1, "bfshrcont_balamt"));
                   // alert(amttotal);
                    var payoutclramt =  Gcoop.ParseFloat(objdw_main.GetItem(1, "payoutclr_amt"));
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="dw_list" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
        ...
        LibraryList="~/DataWindow/mbshr/sl_slipall.pbl">
    ...
    <dw:WebDataWindowControl ID="DwOperateEtc" runat="server" DataWindowObject="d_sl_payinslip_etc"
        ...
        ClientEventClicked="operate_flag_Click" ClientEventItemChanged="DwEtc_Changed">
    </dw:WebDataWindowControl>
