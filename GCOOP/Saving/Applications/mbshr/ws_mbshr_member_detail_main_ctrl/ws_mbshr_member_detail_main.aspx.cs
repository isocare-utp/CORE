...
namespace Saving.Applications.mbshr.ws_mbshr_member_detail_main_ctrl
{
    public partial class ws_mbshr_member_detail_main : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            dsTranfer.InitDsTranfer(this);
            dsCremation.InitDsCremation(this);
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostMemberNo)
            {
                ...
                if(state.SsCoopControl == "040001") {
                    dsTranfer.RetrieveTranfer(ls_member_no);
                    dsCremation.RetrieveMemb_no(ls_member_no);
                }
        ...
        public void SumTotal()
        {
            ...
            //คิดผลรวมรายการหักอื่นๆ
            //int ls_row_count4 = dsCremation.RowCount;
            //decimal cp_sum_item = 0;
            //for (int i = 0; i < ls_row_count4; i++)
            //{
            //    decimal ldc_item_payment = dsCremation.DATA[i].ITEM_AMOUNT;
            //    cp_sum_item += ldc_item_payment;


            //}
            //dsCremation.TContract.Text = cp_sum_item.ToString("#,##0.00");
        }
