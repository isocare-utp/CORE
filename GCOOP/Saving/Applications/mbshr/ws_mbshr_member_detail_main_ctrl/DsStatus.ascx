<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsStatus.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_member_detail_main_ctrl.DsStatus" %>
                ...
                <td width="50%">
                    <table width="100%" style="border: 1px solid #C4C4C4">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="TRANSRIGHT_FLAG" runat="server" Text=" หนังสือโอนสิทธิเรียกร้อง"
                                    Enabled="false" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="ALLOWLOAN_FLAG" runat="server" Text=" ใบยินยอมคู่สมรส" Enabled="false" />
                            </td>
                        </tr>
                        <tr>
                            <td>
