...
{
    public partial class w_sheet_mbshr_req_mbnew_pea : PageWebSheet, WebSheet
    {
        String newDocNo = "";
        ...
        protected String jsmanager_group;
        protected String jschkmembertype;
        ...
        public void InitJsPostBack()
        {
            ...
            jsmanager_group = WebUtil.JsPostBack(this, "jsmanager_group");
            ...
            jschkmembertype = WebUtil.JsPostBack(this, "jschkmembertype");
        ...
        public void WebSheetLoadBegin()
        {
            ...
            //ซ่อนไว้ก่อนไม่แน่ใจว่าที่ PEA ได้ใช้ป่าว
            //dw_moneytr.Visible = false;
        }
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == "jsmanager_group")
            {
                manager_group();
            }
            ...
            else if (eventArg == "jschkmembertype")
            {
                if (dw_main.GetItemDecimal(1, "member_type") == 2)
                {
                    dw_main.SetItemString(1, "appltype_code", "06");
                    dw_main.SetItemString(1, "membtype_code", "15");
                }
                else {
                    dw_main.SetItemString(1, "appltype_code", "01");
                    dw_main.SetItemString(1, "membtype_code", "13");
                }
        ...
        private void JsGetdocno()
        {
            ...
            DwUtil.RetrieveDataWindow(dw_main, "sl_member_new.pbl", tdwMain, memcoop_id, doc_no);
            DwUtil.RetrieveDataWindow(dw_moneytr, "sl_member_new.pbl", null, memcoop_id, doc_no);
            DwUtil.RetrieveDataWindow(dw_gain, "sl_member_new.pbl", null, memcoop_id, doc_no);
        ...
        public void SaveWebSheet()
        {
            ...
            try
            {
                ...
                //int result = shrlonService.SaveReqmbnew(state.SsWsPass, ref astr_mbreqnew);
        ...
        private void NewClear()
        {
            ...
            dw_moneytr.SetItemString(2, "trtype_code", "ATM");
        ...
        private void Jsmembgroup_code()
        {
            ...
            String sql = @"   SELECT MBUCFMEMBGROUP.MEMBGROUP_CODE,   
                              MBUCFMEMBGROUP.MEMBGROUP_DESC,   
                              MBUCFMEMBGROUP.MEMBGROUP_CONTROL,
                              MBUCFMEMBGROUP.MANAGER_GROUP
                              FROM MBUCFMEMBGROUP  
                              WHERE 
                                MBUCFMEMBGROUP.COOP_ID='" + state.SsCoopControl + " ' and MBUCFMEMBGROUP.membgroup_code ='" + group + "'  ORDER BY MBUCFMEMBGROUP.MEMBGROUP_CODE ASC   ";
            ...
            if (dt.Next())
            {
                ...
                try { MANAGER_GROUP = dt.GetString("MANAGER_GROUP"); }
                catch { MANAGER_GROUP = ""; }
                dw_main.SetItemString(1, "manager_group", MANAGER_GROUP);
            }
        ...
        private void manager_group()
        {
            String manager_group = Hdhdmanager_group.Value;
            Sta ta = new Sta(sqlca.ConnectionString);
            //   WHERE length ( trim( mbucfmembgroup.membgroup_code ) ) > ( select length( max( trim( b.membgroup_control ) ) ) from mbucfmembgroup b )  AND  MBUCFMEMBGROUP.MEMBGROUP_CODE='" + group + "' AND  MBUCFMEMBGROUP.COOP_ID='" + state.SsCoopControl + "' ORDER BY MBUCFMEMBGROUP.MEMBGROUP_CODE ASC   ";
            String sql = @"   SELECT MBUCFMEMBGROUP.MEMBGROUP_CODE,   
                              MBUCFMEMBGROUP.MEMBGROUP_DESC,   
                              ...
                              FROM MBUCFMEMBGROUP  
                              WHERE  
                                MBUCFMEMBGROUP.COOP_ID='" + state.SsCoopControl + " ' and MBUCFMEMBGROUP.MANAGER_GROUP like'%" + manager_group + "%'  ORDER BY MBUCFMEMBGROUP.MEMBGROUP_CODE ASC   ";
        ...
        void JsPostBankBranch()
        {
            ...
            Sdt dt = ta.Query(sql);
            dw_moneytr.SetItemString(1, "bank_desc", dt.Rows[0]["bank_desc"].ToString());
            dw_moneytr.SetItemString(2, "bank_desc", dt.Rows[0]["bank_desc"].ToString());
            dw_moneytr.SetItemString(1, "bank_code", BankCode);
            dw_moneytr.SetItemString(2, "bank_code", BankCode);
            ...
            dw_moneytr.SetItemString(2, "branch_name", dt.Rows[0]["branch_name"].ToString());
            dw_moneytr.SetItemString(1, "bank_branch", BankBranchId);
            dw_moneytr.SetItemString(2, "bank_branch", BankBranchId);
        ...
        void JsPostBank()
        {
            ...
            try
            {
                dw_moneytr.SetItemString(1, "branch_name", "");
                dw_moneytr.SetItemString(2, "branch_name", "");
                dw_moneytr.SetItemString(1, "bank_branch", "");
                dw_moneytr.SetItemString(2, "bank_branch", "");
            }
            catch
            { }
            ta.Close();
        ...
        private string CheckPerson2(String memcoop_id, String cardperson, String salary_id)
        {
            ...
            if (cardperson != "")
            {
                ...
                sql2 = "select * from mbreqappl where coop_id='" + memcoop_id + "' and appl_status ='8' and card_person ='" + cardperson + "'";
                sql3 = "select member_no from mbmembmaster where coop_id ='" + memcoop_id + "' and CARD_PERSON ='" + cardperson + "' and resign_status = 0";
                sql4 = "select * from mbmembmaster where coop_id = '" + memcoop_id + "' and member_type = 1 and card_person = '" + cardperson + "'";
                txtID = cardperson;
            }
            else
            {
                ...
                sql2 = "select * from mbreqappl where coop_id='" + memcoop_id + "' and appl_status ='8' and trim(salary_id) ='" + salary_id + "'";
                sql3 = "select member_no from mbmembmaster where coop_id ='" + memcoop_id + "' and trim(salary_id) ='" + salary_id + "' and resign_status = 0";
                sql4 = "select * from mbmembmaster where coop_id = '" + memcoop_id + "' and member_type = 1 and trim(salary_id) = '" + salary_id + "'";
                txtID = salary_id;
            }
            ...
            else if (dt.Next())
            {
                ...
                if (dt4.Next())
                {
                    ...
                    string txt = "สมาชิก" + " " + txtID + " เคยเป็นสมาชิกมาแล้ว สมัครใหม่จะต้องมีค่าธรรมเนียม 500 บาท";
