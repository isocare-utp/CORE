<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_mbshr_req_mbnew_pea.aspx.cs" Inherits="Saving.Applications.mbshr.w_sheet_mbshr_req_mbnew_pea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function itemChange(sender, rowNumber, columnName, newValue) {
            ...
            if (columnName == "mateprovince_code") {
            ...
            else if (columnName == "manager_group") {
                objdw_main.SetItem(rowNumber, columnName, newValue);
                objdw_main.AcceptText();
                Gcoop.GetEl("Hdhdmanager_group").value = newValue;
                jsmanager_group();
                ...
                objdw_moneytr.SetItem(1, "bank_accid", $('input[name="expense_accid_0"]').val());
                objdw_moneytr.SetItem(2, "bank_accid", $('input[name="expense_accid_0"]').val());
            ...
            else if (columnName == "member_type") {
                objdw_main.SetItem(rowNumber, columnName, newValue);
                objdw_main.AcceptText();
                jschkmembertype();
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:HiddenField ID="Hdhdmanager_group" runat="server" />
    ...
    <dw:WebDataWindowControl ID="dw_main" runat="server" ClientScriptable="True" DataWindowObject="d_mbsrv_req_appl_pea"
