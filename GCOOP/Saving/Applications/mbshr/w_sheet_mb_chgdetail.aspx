<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_mb_chgdetail.aspx.cs" Inherits="Saving.Applications.mbshr.w_sheet_mb_chgdetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:TextBox ID="TextDetail" runat="server" Visible="False"></asp:TextBox>
    ...
    <div>
        <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_mb_adjust_master"
            LibraryList="~/DataWindow/mbshr/mb_chgdetail.pbl" ClientScriptable="True" ClientEventButtonClicked="MenubarOpen"
            ...
            <td valign="top">
                <div id="tab1" style="visibility: visible; position: absolute;">
                    <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_mb_adjust_mbdetail"
                        LibraryList="~/DataWindow/mbshr/mb_chgdetail.pbl" AutoRestoreContext="False"
