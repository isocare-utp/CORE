<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mthexpense_ctrl.DsMain" %>
...
<asp:FormView ID="FormView1" runat="server" DefaultMode="Edit">
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr>
                <td colspan="2">
                    <strong><u>ข้อมูลการหักชำระเงิน</u></strong>
                </td>
            </tr>
        </table>
    </EditItemTemplate>
