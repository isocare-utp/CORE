<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.mbshr_const.ws_mb_mbucfmemgrp_ctrl.w_dlg_sl_searchmembgroup_ctrl.DsMain" %>
        ...
        <table class="DataSourceFormView" border="0" style="width: 600px;">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td width="30%">
                        <asp:TextBox ID="membgroup_code" runat="server">s</asp:TextBox>
                    </td>
                    <td width="20%">
                        <div>
