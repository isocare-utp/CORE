    ...
    <script type="text/javascript">
        ...
        function OnDsSearchClicked(s, r, c) {
            ...
            if (c == "b_add") {
                ...
                Gcoop.OpenIFrame3("630", "450", "w_dlg_sl_searchmembgroupcontrol.aspx", "?ls_membgroup_code=" + ls_membgroup_code);
        ...
        function OnDsListClicked(s, r, c, v) {
            ...
            if (c == "b_detail") {
                var ls_membgroup_code = dsList.GetItem(r, "membgroup_control");
                Gcoop.OpenIFrame3("630", "450", "w_dlg_sl_searchmembgroupcontrol.aspx", "?ls_membgroup_code=" + ls_membgroup_code);
            } else if (c == "b_delete") {
