<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.mbshr_const.w_sheet_mb_mbucfmembgroup_ctrl.w_dlg_sl_searchmembgroup_ctrl.DsList" %>
