<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMrtger.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_mg_mrtgmast_edit_ctrl.DsMrtger" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 750px;">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="mrtg_name1" runat="server" Style="width: 622px;"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td width="15%">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="mrtg_name2" runat="server" Style="width: 622px;"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
