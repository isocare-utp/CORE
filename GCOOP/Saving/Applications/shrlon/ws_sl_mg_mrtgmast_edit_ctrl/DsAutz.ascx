<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsAutz.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_mg_mrtgmast_edit_ctrl.DsAutz" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 750px;">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="autrz_name1" runat="server" Style="width: 623px;"></asp:TextBox>                    
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="3">
                    <asp:TextBox ID="autrz_pos1" runat="server" Style="width: 623px;"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="4">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="autrz_name2" runat="server" Style="width: 623px;"></asp:TextBox>                    
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="3">
                    <asp:TextBox ID="autrz_pos2" runat="server" Style="width: 623px;"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="4">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="autzd_name" runat="server" Style="width: 593px;"></asp:TextBox>
                    <asp:Button ID="b_autzd" runat="server" Text="..." Style="width: 25px; margin-left: 2px;" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="autzd_village" runat="server" Style="width: 623px;"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
