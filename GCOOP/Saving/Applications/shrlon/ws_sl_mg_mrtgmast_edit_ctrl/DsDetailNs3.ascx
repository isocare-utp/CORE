<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsDetailNs3.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_mg_mrtgmast_edit_ctrl.DsDetailNs3" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 750px; background-color: #CCFF99;border:1px double black;">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="photoair_province" runat="server" Style="width: 620px;"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="size_wa" runat="server" Style="width: 620px;"></asp:TextBox>
                </td>
            </tr>
        </table>
    </EditItemTemplate>
