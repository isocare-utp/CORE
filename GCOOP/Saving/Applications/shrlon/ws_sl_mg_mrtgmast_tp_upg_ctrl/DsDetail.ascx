<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsDetail.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_mg_mrtgmast_tp_upg_ctrl.DsDetail" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 550px; background-color: #CCFF99;
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="mrtgmast_no" runat="server" Style="width: 124px;"></asp:TextBox>
                    <asp:Button ID="b_mrtgsearch" runat="server" Text="..." Style="width: 25px;" />
                </td>
                <td colspan="2">
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    <strong><u>รายละเอียดการขึ้นเงิน</u></strong>
                </td>
            </tr>
            <tr>
                <td width="20%">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="autzd_name" runat="server" Style="width: 390px;"></asp:TextBox>
                    <asp:Button ID="b_autzd" runat="server" Text="..." Style="width: 30px;" />
                </td>
            </tr>
            <tr>
                <td>
