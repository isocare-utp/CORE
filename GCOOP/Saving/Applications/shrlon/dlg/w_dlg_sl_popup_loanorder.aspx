<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_popup_loanorder.aspx.cs"
    Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_popup_loanorder" %>
...
<body onload="SaveStatus();">
    ...
    <dw:WebDataWindowControl ID="DwOperateLoan" runat="server" DataWindowObject="d_sl_payinslip_loan"
        ...
        Width="750px" ClientScriptable="True" ClientEventClicked="OnDwLoanItemClicked" ClientEventItemChanged="OnDwLoanItemChanged"
