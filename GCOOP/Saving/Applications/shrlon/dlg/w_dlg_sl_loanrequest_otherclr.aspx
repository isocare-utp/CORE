<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_loanrequest_otherclr.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_loanrequest_otherclr"   %>
    ...
    <table >
        <tr>
            ...
            <dw:WebDataWindowControl ID="dw_otherclr" runat="server" AutoRestoreContext="False" 
                ...
                ClientScriptable="True" ClientEventButtonClicked="OnDwOtherClrButtonClicked"
                DataWindowObject ="d_sl_loanrequest_otherclr" 
                LibraryList ="~/DataWindow/shrlon/sl_loan_requestment.pbl" 
                    ClientFormatting="True" ClientEventItemChanged="ItemChangeDwOtherClr">
