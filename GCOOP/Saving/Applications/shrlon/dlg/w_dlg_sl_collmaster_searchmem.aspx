<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_collmaster_searchmem.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_collmaster_searchmem" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function selectRow(sender, rowNumber, objectName) {
            ...
            window.opener.GetMemFromDlg(memco_no);
            window.close();
        }
