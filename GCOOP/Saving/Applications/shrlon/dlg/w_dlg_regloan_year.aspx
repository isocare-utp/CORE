<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_regloan_year.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_regloan_year" %>
    ...
    <table >
        <tr>
            <td>
             ...
             <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False" 
                ...
                DataWindowObject ="d_sl_lnreqyearsrch_criteria" 
                LibraryList ="~/DataWindow/shrlon/sl_loan_requestment.pbl" 
                    ClientFormatting="True" ClientEventItemChanged="ItemChangeDWCriteria"
                     ClientEventButtonClicking="OnDwCriteriaClick">
        ...
        <tr>
            ...
            <dw:WebDataWindowControl ID="dw_detail" runat="server" AutoRestoreContext="False" 
                ...
                DataWindowObject ="d_sl_lnreqyearsrch_list" 
