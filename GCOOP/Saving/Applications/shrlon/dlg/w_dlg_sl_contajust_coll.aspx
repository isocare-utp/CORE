<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_contajust_coll.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_contajust_coll" %>
...
<asp:Literal ID="LtServerMessage" runat="server"></asp:Literal>
    ...
    <div>
        <dw:WebDataWindowControl ID="dw_data" runat="server" 
            DataWindowObject="d_sl_contadj_colldet" 
            LibraryList="~/DataWindow/shrlon/sl_contract_adjust.pbl">
        </dw:WebDataWindowControl>
    
    </div>
    <br />
        <dw:WebDataWindowControl ID="dw_item" runat="server" 
        DataWindowObject="d_sl_contadj_collitem" 
        LibraryList="~/DataWindow/shrlon/sl_contract_adjust.pbl">
        </dw:WebDataWindowControl>
