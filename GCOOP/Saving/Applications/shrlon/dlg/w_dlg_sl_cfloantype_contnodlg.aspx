<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_cfloantype_contnodlg.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_cfloantype_contnodlg" %>
...
<body>
    ...
    <div>
        <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_sl_cflntype_contdlg"
            ...
            AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientEventClicked="OnClick" Height="400px" Width="450px">
