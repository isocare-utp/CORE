...
<head runat="server">
    ...
    function DialogLoadComplete(){
         ...
         if (chkStatus == "1" ) 
         {
          ...
          //   window.opener.GetValueDlgClearLoan();
            window.close();
         }
     }
     ...
     function ItemDwClearDetChanged(sender, rowNumber, columnName, newValue)
     {
    ...
    <table >
        <tr>
            ...
            <dw:WebDataWindowControl ID="dw_cleardet" runat="server" 
                    ...
                    LibraryList="~/DataWindow/shrlon/sl_loan_requestment_cen.pbl" 
                    AutoRestoreContext="False" AutoRestoreDataCache="True" 
                    AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True" ClientEventItemChanged="ItemDwClearDetChanged">
