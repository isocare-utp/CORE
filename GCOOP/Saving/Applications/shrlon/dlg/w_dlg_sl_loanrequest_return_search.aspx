<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_loanrequest_return_search.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_loanrequest_return_search" %>
...
<head runat="server">
    <title>ค้นหาใบขอส่งคืนคำขอกู้</title>
    <%=refresh  %>
    <%=setDocNo %>
    <%=searchLoanrequest  %>
    ...
    function ItemChangeDWCriteria(sender, rowNumber, columnName, newValue)
    {
     ...
     function DialogLoadComplete(){
         ...
         if ((docNo != null ) && (docNo != "" ))
         {
            window.opener.GetValueLoanRequestS(docNo);
            window.close();
         }
    }
    </script>
    ...
    <table >
        <tr>
            <td>
             ...
             <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False" 
                ...
                DataWindowObject ="d_sl_requestreturn_search_criteria" 
        ...
        <tr>
            ...
            <dw:WebDataWindowControl ID="dw_detail" runat="server" AutoRestoreContext="False" 
                ...
                DataWindowObject ="d_sl_requestreturn_search_list" 
                LibraryList ="~/DataWindow/shrlon/sl_loan_requestment.pbl" RowsPerPage="17" 
                    ClientFormatting="False" style="top: 0px; left: 0px" >
