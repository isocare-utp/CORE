<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_popup_loanreceive_order.aspx.cs"
    Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_popup_loanreceive_order" %>
...
<head id="Head1" runat="server">
    ...
    <%=jspopupLoanReport%>
    <%=jspopupDeptReport%> <title>จ่ายเงินกู้ให้สมาชิก</title>
...
<body onload="SaveStatus();">
    ...
    <asp:Button ID="Button1" runat="server" Text="เลขสัญญาถัดไป" Height="36px" OnClick="Button1_Click" />&nbsp;<asp:TextBox
        ID="TextBox1" runat="server" Height="31px" Width="159px"></asp:TextBox>
