<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_d_mbucfdistrict.aspx.cs"
    Inherits="Saving.Applications.shrlon.dlg.w_dlg_d_mbucfdistrict" %>
...
//                alert(c);
                ...
                Gcoop.GetEl("Hdistrict_code").value = objdw_district.GetItem(r, "district_code");
                Gcoop.GetEl("Hdistrict_desc").value = v;// objdw_district.GetItem(r, "district_desc");
