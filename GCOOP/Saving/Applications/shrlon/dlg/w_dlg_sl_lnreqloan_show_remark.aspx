<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_lnreqloan_show_remark.aspx.cs"
    Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_lnreqloan_show_remark" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function selectRow(sender, rowNumber, objectName) {
          ...
          //   alert(prncbal);
            window.opener.GetAccIDDept(dept_no, deptaccount_name, prncbal);
            window.close();
