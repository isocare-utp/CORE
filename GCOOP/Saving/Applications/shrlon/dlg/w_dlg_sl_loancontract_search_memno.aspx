<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_loancontract_search_memno.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_loancontract_search_memno" %>
    ...
    <script type="text/javascript">
        function selectRow(sender, rowNumber, objectName) {
            ...
            try {
                ...
                parent.GetContFromDlg(loancontractno);
                parent.RemoveIFrame();
            }
        }
