<%@ Page Title="" Language="C#" MasterPageFile="~/FrameDialog.Master" AutoEventWireup="true"
    CodeBehind="w_dlg_sl_member_search_lite.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_member_search_lite" %>

<%@ Register Src="w_dlg_sl_member_search_lite_ctrl/DsCriteria.ascx" TagName="DsCriteria"
    TagPrefix="uc1" %>
<%@ Register Src="w_dlg_sl_member_search_lite_ctrl/DsList.ascx" TagName="DsList"
    TagPrefix="uc2" %>
