...
{
    public partial class w_dlg_sl_lnreqloan_show_remark : PageWebDialog, WebDialog
    {
        ...
        public void WebDialogLoadBegin()
        {
            ...
            {
                String deptaccount = Request["dept"].ToString();
                LoadAccID(deptaccount);
            }
        }
        ...
        public void LoadAccID(String deptaccount)
        {
            String strSQL = "";
   ...
   WHERE ( DPDEPTMASTER.MEMBER_NO = MBMEMBMASTER.MEMBER_NO ) and  
         ...
         ( DPDEPTMASTER.DEPTACCOUNT_NO = '" + deptaccount + "')  ORDER BY DPDEPTMASTER.DEPTACCOUNT_NO ASC";
            try
            {
                dw_detail.Reset();
