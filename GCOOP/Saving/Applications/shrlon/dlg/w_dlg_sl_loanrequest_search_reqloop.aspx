<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_loanrequest_search_reqloop.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_sl_loanrequest_search_reqloop" %>
...
<head runat="server">
    <title>ค้นหาใบคำขอกู้ฉุกเฉินโอน</title>
    <%=searchLoanrequest%>
    <%=setDocNo %>
    <%=refresh  %>
    ...
    <table >
        <tr>
            <td>
             ...
             <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False" 
                ...
                DataWindowObject ="d_sl_loanrequest_search_criteria_emer" 
        ...
        <tr>
            ...
            <dw:WebDataWindowControl ID="dw_detail" runat="server" AutoRestoreContext="False" 
                ...
                DataWindowObject ="d_sl_loanrequest_search_list_reqloop" 
