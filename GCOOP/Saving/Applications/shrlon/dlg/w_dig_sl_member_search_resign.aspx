<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dig_sl_member_search_resign.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dig_sl_member_search_resign" %>
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_sl_membsrch_criteria_resign"
                    LibraryList="~/DataWindow/shrlon/sl_cancelresign.pbl">
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_sl_membsrch_list_memno2_resign" LibraryList="~/DataWindow/shrlon/sl_cancelresign.pbl"
