<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_yrconfirmbalance.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_yrconfirmbalance" %>
        ...
        <tr>
            <td colspan="3">
                <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_yrcfbal_prc_option"
                    LibraryList="~/DataWindow/shrlon/sl_yrconfirmbalance.pbl" AutoSaveDataCacheAfterRetrieve="True"
