    ...
    public partial class w_sheet_sl_slip_operate_inorder : PageWebSheet, WebSheet
    {
                ...
                for (int j = 1; j <= loanAllRow; j++)
                {
                    ...
                    else if (loancontract_no == "")
                    {
                        ...
                        try
                        {
                            ...
                            DwUtil.ImportData(xml_loan, dw_loan, null);
                        }
                        catch { dw_loan.Reset(); }
                    }
            ...
            try
            {
                ...
                if (result == 1)
                {
                    ...
                    try
                    {
                        ...
                        DwUtil.ImportData(astr_slippayin.xml_sliphead, dw_main, tDwMain);
                    ...
                    try
                    {
                        ...
                        DwUtil.ImportData(astr_slippayin.xml_slipshr, dw_share, null);
                    }
                    ...
                    try
                    {
                        ...
                        DwUtil.ImportData(astr_slippayin.xml_sliplon, dw_loan, null);
                    }
                    catch { dw_loan.Reset(); }
                    try
                    {
                        ...
                        DwUtil.ImportData(astr_slippayin.xml_slipetc, dw_etc, null);
                    }
                    catch { dw_etc.Reset(); }
                }
                else if (result > 1)
                {
                    ...
                    DwUtil.ImportData(as_xmllnrcv, dw_list, null);
                }
            }
        ...
        private void Initlist()
        {
            try
            {
                ...
                try
                {
                    ...
                    DwUtil.ImportData(astr_initpayin.xml_sliphead, dw_main, tDwMain);
                    //   DwUtil.DeleteLastRow(dw_main);
                ...
                try
                {
                    ...
                    DwUtil.ImportData(astr_initpayin.xml_slipshr, dw_share, null);
                }
                catch { dw_share.Reset(); }
                try
                {
                    ...
                    DwUtil.ImportData(astr_initpayin.xml_sliplon, dw_loan, null);
                }
                catch { dw_loan.Reset(); }
                try
                {
                    ...
                    DwUtil.ImportData(astr_initpayin.xml_slipetc, dw_etc, null);
                }
                catch { dw_etc.Reset(); }
                // }
                //else if (result == 2)
        ...
        public void WebSheetLoadEnd()
        {
            ...
            try
            {
                ...
                try
                {
                    arg = dw_main.GetItemString(1, "moneytype_code");
                }
                catch { }
