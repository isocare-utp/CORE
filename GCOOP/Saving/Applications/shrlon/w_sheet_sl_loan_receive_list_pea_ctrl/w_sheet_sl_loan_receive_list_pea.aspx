<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_sl_loan_receive_list_pea.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_receive_list_pea_ctrl.w_sheet_sl_loan_receive_list" %>
    ...
    <script type="text/javascript">
        ...
        function OnDsMainClicked(s, r, c) {
            if (c == "b_show") {
                ...
                Gcoop.OpenIFrame2Extend("830", "650", "w_dlg_loan_receive_order.aspx", "?loans=" + word + "&sdate=" + sdate + "&pay_flag=" + payadv_flag);
