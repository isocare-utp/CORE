<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_reprint_receipt_ry.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_reprint_receipt_ry" %>
...
<%=jsFindDate%>
    <script type="text/javascript">
        ...
        function ItemChanged(sender, rowNumber, columnName, newValue) {
            ...
            if (columnName == "receiptdate_tstart") {
                sender.SetItem(1, "receiptdate_tstart", newValue);
                sender.AcceptText();
                sender.SetItem(1, "receiptdate_start", Gcoop.ToEngDate(newValue));
                sender.AcceptText();
                jsFindDate();
            }
            if (columnName == "receiptdate_tend") {
                sender.SetItem(1, "receiptdate_tend", newValue);
                sender.AcceptText();
                sender.SetItem(1, "receiptdate_end", Gcoop.ToEngDate(newValue));
                sender.AcceptText();
                jsFindDate();
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_loansrv_prn_payinsliplist_ry"
        LibraryList="~/DataWindow/app_finance/reprint_receipt.pbl" AutoRestoreContext="False"
        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
