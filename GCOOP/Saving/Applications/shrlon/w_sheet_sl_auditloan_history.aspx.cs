...
{
    public partial class w_sheet_sl_auditloan_history : PageWebSheet, WebSheet
    {
        ...
        private void JsGetData()
        {
            try
            {
                ...
                String sql = @"  SELECT WEBAUDIT.AUDIT_NO,   
                                 WEBAUDIT.TAB_NAME,   
                                 WEBAUDIT.PK_NAME,   
                                 WEBAUDIT.PK_DESC,   
                                 WEBAUDIT.PK_VALUE,   
                                 WEBAUDIT.MODIFIED_DATE,   
                                 WEBAUDIT.MODIFIED_USER,   
                                 WEBAUDIT.MODIFIED_APP,   
                            ...
                            FROM WEBAUDIT,   
                                 MBMEMBMASTER,   
                                 LNCONTMASTER  
                           WHERE ( WEBAUDIT.PK_VALUE =  LNCONTMASTER.LOANCONTRACT_NO ) and  
                                 ( MBMEMBMASTER.MEMBER_NO = LNCONTMASTER.MEMBER_NO ) and  
                                 ( ( WEBAUDIT.TAB_NAME = 'LNCONTMASTER' ) AND  
                                 ( WEBAUDIT.MODIFIED_APP = 'shrlon' ) )  ";
