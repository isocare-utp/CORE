<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_collateral_master_new_ctrl.ws_dlg_sl_editcollateral_master_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" border="0" style="width: 600px;">
            ...
            <tr>
                ...
                <td width="20%">
                    <asp:TextBox ID="sharestk_value" runat="server" ToolTip="#,##0.00" Style="text-align: right;" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                </td>
                <td width="15%">
                    <div>
                        <span>หน่วย:</span>
