<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsColluse.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_collateral_master_new_ctrl.DsColluse" %>
    ...
    <asp:Repeater ID="Repeater2" runat="server">
        <ItemTemplate>
            <tr>
                ...
                <td width="5%">
                    <asp:Button ID="b_detail" runat="server" Text="ลบ" />
                </td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
