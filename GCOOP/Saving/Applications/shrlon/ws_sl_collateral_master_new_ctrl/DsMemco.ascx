<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMemco.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_collateral_master_new_ctrl.DsMemco" %>
