<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_loan_receive_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table border="0">
            ...
            <tr>
                <table class="DataSourceFormView" style="width: 750px;" border="0">
                    <tr>
                        ...
                        <td width="27%">
                            <asp:TextBox ID="fullname" runat="server" ReadOnly="true" Style="background-color: #FFFFCC;"></asp:TextBox>
                        </td>
                        <td width="13%">
                            <div>
                        ...
                        <td width="17%">
                            <asp:TextBox ID="c_membertype" runat="server" Style="background-color: #FFFFCC;" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="b_sbranch" runat="server" Text="ค้นหาสาขา" />
                </td>
                <td width="17%">
                    <div>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_branch_name" runat="server"></asp:TextBox>
                </td>
                <td>
                    <div>
