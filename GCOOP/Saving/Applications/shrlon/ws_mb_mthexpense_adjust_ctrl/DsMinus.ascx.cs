...
{
    public partial class DsMinus : DataSourceRepeater
    {
        public DataSet1.MBMEMBMTHEXPENSEDataTable DATA { get; set; }

        public void InitDsMinus(PageWeb pw)
        {
            css1.Visible = false;
            css2.Visible = false;
            DataSet1 ds = new DataSet1();
            this.DATA = ds.MBMEMBMTHEXPENSE;
            this.EventItemChanged = "OnDsMinusItemChanged";
            this.EventClicked = "OnDsMinusClicked";
            this.InitDataSource(pw, Repeater1, this.DATA, "dsMinus");
            this.Button.Add("b_delete");
            this.Register();
        }
        public void RetrieveMinus(string member_no)
        {
 ...
 ";
        ...
        {
            get { return this.cpsum_mthexpense_amt2; }
        }
    }
}