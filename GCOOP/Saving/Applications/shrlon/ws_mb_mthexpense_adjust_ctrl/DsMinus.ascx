<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMinus.ascx.cs" Inherits="Saving.Applications.shrlon.ws_mb_mthexpense_adjust_ctrl.DsMinus" %>
...
<div align="left">
    ...
    <table class="DataSourceFormView" style="width: 360px;">
        <tr>
            ...
            <td width="30%">
                <asp:TextBox ID="cpsum_mthexpense_amt2" runat="server" Style="font-size: 11px; text-align: right;
