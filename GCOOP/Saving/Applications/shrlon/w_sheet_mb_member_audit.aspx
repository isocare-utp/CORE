<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_mb_member_audit.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_mb_member_audit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <div>
        <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_sl_audit_membmaster"
