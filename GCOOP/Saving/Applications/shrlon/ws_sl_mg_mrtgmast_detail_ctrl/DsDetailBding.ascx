<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsDetailBding.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_mg_mrtgmast_detail_ctrl.DsDetailBding" %>
