<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsDetailCondo.ascx.cs"
    Inherits="Saving.Applications.shrlon.ws_sl_mg_mrtgmast_detail_ctrl.DsDetailCondo" %>
...
<asp:FormView ID="FormView1" runat="server" DefaultMode="Edit">
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 720px; background-color: #CCFF99;
