...
namespace Saving.Applications.shrlon.ws_sl_const_lnucfbuildingtype_ctrl
{
    ...
    {
        public DataSet1.LNUCFBUILDINGTYPEDataTable DATA { get; private set; }
        ...
        public void InitDs(PageWeb pw)
        {
            ...
            this.DATA = ds.LNUCFBUILDINGTYPE;
        ...
        {
            string sql = @"select * from lnucfbuildingtype order by buildingtype_code";
