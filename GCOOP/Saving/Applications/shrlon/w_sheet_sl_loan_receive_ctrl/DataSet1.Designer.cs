...
namespace Saving.Applications.shrlon.w_sheet_sl_loan_receive_ctrl.DataSet1TableAdapters {
    ...
    public partial class SLSLIPPAYINDETTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("BFINTARRMTH_AMT", "BFINTARRMTH_AMT");
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"SLSLIPPAYINDET\" (\"COOP_ID\", \"PAYINSLIP_NO\", \"SLIPITEMTYPE_CODE\", \"SE" +
                "Q_NO\", \"OPERATE_FLAG\", \"SHRLONTYPE_CODE\", \"CONCOOP_ID\", \"LOANCONTRACT_NO\", \"SLIP" +
                "ITEM_DESC\", \"PERIODCOUNT_FLAG\", \"PERIOD\", \"PRINCIPAL_PAYAMT\", \"INTEREST_PAYAMT\"," +
                " \"INTARREAR_PAYAMT\", \"ITEM_PAYAMT\", \"ITEM_BALANCE\", \"PRNCALINT_AMT\", \"CALINT_FRO" +
                "M\", \"CALINT_TO\", \"INTEREST_PERIOD\", \"INTEREST_RETURN\", \"STM_ITEMTYPE\", \"BFPERIOD" +
                "\", \"BFINTARR_AMT\", \"BFINTARRSET_AMT\", \"BFLASTCALINT_DATE\", \"BFLASTPROC_DATE\", \"B" +
                "FLASTPAY_DATE\", \"BFWITHDRAW_AMT\", \"BFPERIOD_PAYMENT\", \"BFSHRCONT_BALAMT\", \"BFSHR" +
                "CONT_STATUS\", \"BFCONTLAW_STATUS\", \"BFCOUNTPAY_FLAG\", \"BFPAYSPEC_METHOD\", \"RKEEP_" +
                "PRINCIPAL\", \"RKEEP_INTEREST\", \"NKEEP_INTEREST\", \"BFINTRETURN_FLAG\", \"BFINTRETURN" +
                "_AMT\", \"BFPXAFTERMTHKEEP_TYPE\", \"REF_DOCNO\", \"PRNC_RETURN\", \"BFINTARRMTH_AMT\") V" +
                "ALUES (:COOP_ID, :PAYINSLIP_NO, :SLIPITEMTYPE_CODE, :SEQ_NO, :OPERATE_FLAG, :SHR" +
                "LONTYPE_CODE, :CONCOOP_ID, :LOANCONTRACT_NO, :SLIPITEM_DESC, :PERIODCOUNT_FLAG, " +
                ":PERIOD, :PRINCIPAL_PAYAMT, :INTEREST_PAYAMT, :INTARREAR_PAYAMT, :ITEM_PAYAMT, :" +
                "ITEM_BALANCE, :PRNCALINT_AMT, :CALINT_FROM, :CALINT_TO, :INTEREST_PERIOD, :INTER" +
                "EST_RETURN, :STM_ITEMTYPE, :BFPERIOD, :BFINTARR_AMT, :BFINTARRSET_AMT, :BFLASTCA" +
                "LINT_DATE, :BFLASTPROC_DATE, :BFLASTPAY_DATE, :BFWITHDRAW_AMT, :BFPERIOD_PAYMENT" +
                ", :BFSHRCONT_BALAMT, :BFSHRCONT_STATUS, :BFCONTLAW_STATUS, :BFCOUNTPAY_FLAG, :BF" +
                "PAYSPEC_METHOD, :RKEEP_PRINCIPAL, :RKEEP_INTEREST, :NKEEP_INTEREST, :BFINTRETURN" +
                "_FLAG, :BFINTRETURN_AMT, :BFPXAFTERMTHKEEP_TYPE, :REF_DOCNO, :PRNC_RETURN, :BFIN" +
                "TARRMTH_AMT)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("BFINTARRMTH_AMT", global::System.Data.OracleClient.OracleType.Number, 0, global::System.Data.ParameterDirection.Input, "BFINTARRMTH_AMT", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE \"SLSLIPPAYINDET\" SET \"COOP_ID\" = :COOP_ID, \"PAYINSLIP_NO\" = :PAYINSLIP_NO," +
                ...
                "_TYPE\" = :BFPXAFTERMTHKEEP_TYPE, \"REF_DOCNO\" = :REF_DOCNO, \"PRNC_RETURN\" = :PRNC" +
                "_RETURN, \"BFINTARRMTH_AMT\" = :BFINTARRMTH_AMT WHERE ((\"COOP_ID\" = :Original_COOP" +
                "_ID) AND (\"PAYINSLIP_NO\" = :Original_PAYINSLIP_NO) AND (\"SLIPITEMTYPE_CODE\" = :O" +
                "riginal_SLIPITEMTYPE_CODE) AND (\"SEQ_NO\" = :Original_SEQ_NO))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("BFINTARRMTH_AMT", global::System.Data.OracleClient.OracleType.Number, 0, global::System.Data.ParameterDirection.Input, "BFINTARRMTH_AMT", global::System.Data.DataRowVersion.Current, false, null));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT * FROM SLSLIPPAYINDET";
        ...
        public virtual int Insert(
                    ...
                    global::System.Nullable<decimal> BFINTARRMTH_AMT) {
            if ((COOP_ID == null)) {
            ...
            if ((REF_DOCNO == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[41].Value = ((string)(REF_DOCNO));
            }
            if ((PRNC_RETURN.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[42].Value = ((decimal)(PRNC_RETURN.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[42].Value = global::System.DBNull.Value;
            }
            if ((BFINTARRMTH_AMT.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[43].Value = ((decimal)(BFINTARRMTH_AMT.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((REF_DOCNO == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[41].Value = ((string)(REF_DOCNO));
            }
            if ((PRNC_RETURN.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[42].Value = ((decimal)(PRNC_RETURN.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[42].Value = global::System.DBNull.Value;
            }
            if ((BFINTARRMTH_AMT.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[43].Value = ((decimal)(BFINTARRMTH_AMT.Value));
            }
            else {
            ...
            if ((Original_PAYINSLIP_NO == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[45].Value = ((string)(Original_PAYINSLIP_NO));
            }
            if ((Original_SLIPITEMTYPE_CODE == null)) {
                throw new global::System.ArgumentNullException("Original_SLIPITEMTYPE_CODE");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[46].Value = ((string)(Original_SLIPITEMTYPE_CODE));
            }
            this.Adapter.UpdateCommand.Parameters[47].Value = ((decimal)(Original_SEQ_NO));
