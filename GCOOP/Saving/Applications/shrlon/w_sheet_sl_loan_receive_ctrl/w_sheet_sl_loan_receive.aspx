<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_loan_receive.aspx.cs" 
Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_receive_ctrl.w_sheet_sl_loan_receive" %>
    ...
    <script type="text/javascript">
        ...
        function OnDsMainItemChanged(s, r, c, v) {
            if (c == "expense_bank") {
                ...
                dsMain.SetItem(r, "member_no", v);
                PostMember();
            }
            else if (c == "loancontract_no") {
                dsMain.SetItem(r, "loancontract_no", v);
                PostLoancontract();
            }
        }
        ...
        function Validate() {
            return confirm("ต้องการบันทึกการจ่ายเงินกู้ใช่ไหม ?");
        }
