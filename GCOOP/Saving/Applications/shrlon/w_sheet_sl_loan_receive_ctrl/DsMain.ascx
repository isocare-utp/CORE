...
Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_receive_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table border="0">
                ...
                <td>
                    <table class="DataSourceFormView" style="width: 500px;" border="0">
                        ...
                        <tr>
                            ...
                            <td width="25%">
                                <asp:DropDownList ID="loancontract_no" runat="server" Style="text-align: center; background-color:Lime;"></asp:DropDownList>
                            </td>
                            <td width="20%">
                                <div>
            ...
            <tr>
                ...
                <td>
                <asp:Button ID="b_deptacc" runat="server" Text="เลขบัญชี" />
                </td>
            </tr>
        </table>
        </td>
