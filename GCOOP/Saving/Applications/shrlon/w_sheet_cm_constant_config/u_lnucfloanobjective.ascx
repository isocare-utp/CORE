<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_lnucfloanobjective.ascx.cs"
    Inherits="Saving.Applications.shrlon.u_lnucfloanobjective" %>
...
<script type="text/javascript">
    function OnButtonClick(sender, row, name) {
        if (name == "b_delete") {
            var detail = "รหัส : " + objdw_main.GetItem(row, "loanobjective_code");
...
<table style="width: 100%;">
    <tr>
        <td align="center">
            ...
            <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_lnucfloanobjective"
