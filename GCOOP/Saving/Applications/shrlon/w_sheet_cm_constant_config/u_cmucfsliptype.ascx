<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cmucfsliptype.ascx.cs"
    Inherits="Saving.Applications.shrlon.u_cmucfsliptype" %>
    ...
    <tr>
        <td align="center">
            ...
            <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_cmucfsliptype"
                ...
                OnBeginUpdate="dw_main_BeginUpdate" OnEndUpdate="dw_main_EndUpdate" ClientEventButtonClicked="OnButtonClick" Width="520px" Height="500px">
