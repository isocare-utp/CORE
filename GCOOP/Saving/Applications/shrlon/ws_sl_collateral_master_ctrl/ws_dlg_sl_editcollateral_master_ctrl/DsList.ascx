<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_collateral_master_ctrl.ws_dlg_sl_editcollateral_master_ctrl.DsList" %>
