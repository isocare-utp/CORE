...
mbucfprename.prename_desc+ mbmembmaster.memb_name +''+ mbmembmaster.memb_surname as cp_name,  

      rtrim(ltrim(mbmembmaster.membgroup_code)) + mbucfmembgroup.membgroup_desc as cp_memgroup,
