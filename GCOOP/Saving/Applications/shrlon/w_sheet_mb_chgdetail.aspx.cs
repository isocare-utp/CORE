...
namespace Saving.Applications.shrlon
{
    public partial class w_sheet_mb_chgdetail : PageWebSheet, WebSheet
    {
        ...
        private void JsGetShareBase()
        {
            ...
            int result = shrlonService.of_getsharebase(state.SsWsPass,state.SsCoopControl, adc_salary, ref adc_sharebase);
        ...
        public void SaveWebSheet()
        {
            ...
            try
            {
                //try
                //{
                //    DateTime pausekeep_date = dw_status.GetItemDateTime(1, "pausekeep_date");
                //}
                //catch { dw_status.SetItemDateTime(1, "pausekeep_date", state.SsWorkDate); tdwData2.Eng2ThaiAllRow(); }
  ...
  and ( MBUCFDISTRICT.PROVINCE_CODE ='" + provincecode + "' ) and   ( MBUCFDISTRICT.DISTRICT_CODE = '" + district_code + "') ";
        ...
        private void JsCallRetry()
        {
            try
            {
                ...
                dw_detail.SetItemString(1, "retry_tdate", retry_tdate);
