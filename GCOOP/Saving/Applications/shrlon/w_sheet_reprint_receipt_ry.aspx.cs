...
namespace Saving.Applications.shrlon
{
    public partial class w_sheet_reprint_receipt_ry : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            jsFindDate = WebUtil.JsPostBack(this, "jsFindDate");
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == "jsFindDate")
            {
                DateTime receipt_sdate =  dw_main.GetItemDateTime(1, "receiptdate_start");
                DateTime receipt_edate = dw_main.GetItemDateTime(1, "receiptdate_end");
                DwUtil.RetrieveDataWindow(dw_detail, "reprint_receipt.pbl", null, state.SsCoopControl, receipt_sdate, receipt_edate);
