<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsDetail.ascx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_receive_list_atm_ctrl.w_dlg_loan_receive_atm_ctrl.DsDetail" %>
        ...
        <ItemTemplate>
            <tr>
                <td width="5%" align="center">
                    <asp:CheckBox ID="operate_flag" runat="server" Style="font-size: 11px; " BackColor="#EEEEEE"/>
                </td>
                <td width="10%">
                    <asp:TextBox ID="loancontract_no" runat="server" Style="font-size: 11px; text-align: center;
                ...
                <td width="10%">
                    <asp:TextBox ID="bflastcalint_date" runat="server" Style="font-size: 11px; text-align: center;
                        background-color: #EEEEEE"></asp:TextBox>
                </td>
                <td width="10%">
                ...
                <td width="10%">
                    <asp:TextBox ID="principal_payamt" runat="server" Style="font-size: 11px; text-align: right;
                        background-color: #99FFCC;" ToolTip="#,##0.00"></asp:TextBox>
                </td>
                <td width="10%">
