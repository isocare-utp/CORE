<%@ Page Title="" Language="C#" MasterPageFile="~/FrameDialog.Master" AutoEventWireup="true" CodeBehind="w_dlg_loan_receive_atm.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_loan_receive_atm_ctrl.w_dlg_loan_receive_atm" %>
    ...
    <script type="text/javascript">
        ...
        function OnDsDetailItemChanged(s, r, c, v) {
            if (c == "operate_flag") {
                ...
                var loantype = dsMain.GetItem(0, "shrlontype_code");
                var bfloanapprove_amt = dsMain.GetItem(0, "bfloanapprove_amt");
                if (loantype == "88") {
                    if (sum > bfloanapprove_amt) {
        ...
        function OnDsMainItemChanged(s, r, c, v) {
            if (c == "expense_bank") {
                ...
                var bfloanapprove_amt = dsMain.GetItem(0, "bfloanapprove_amt");
                if (loantype == "88") {
                    if (payoutclr_amt > bfloanapprove_amt) {
                        alert("ยอดจ่ายเงินกู้น้อยกว่ายอดหักชำระ กรุณาตรวจสอบ!!");
                    }
                }
                else {
        ...
        function OnDsAddItemChanged(s, r, c, v) {
            if (c == "operate_flag") {
                ...
                var bfloanapprove_amt = dsMain.GetItem(0, "bfloanapprove_amt");
                if (loantype == "88") {
                    if (sum + payout_amt > bfloanapprove_amt) {
                        alert("ยอดจ่ายเงินกู้น้อยกว่ายอดหักชำระ กรุณาตรวจสอบ!!!");
                    }
                }
                else {
