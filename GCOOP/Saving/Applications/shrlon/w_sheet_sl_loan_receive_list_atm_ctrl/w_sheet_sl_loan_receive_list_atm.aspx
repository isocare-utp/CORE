<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_sl_loan_receive_list_atm.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_receive_list_atm_ctrl.w_sheet_sl_loan_receive_list_atm" %>
    ...
    <script type="text/javascript">
        ...
        function OnDsMainClicked(s, r, c) {
            if (c == "b_show") {
                ...
                Gcoop.OpenIFrame3("800", "780", "w_dlg_loan_receive_atm.aspx", "?loans=" + word + "&sdate=" + sdate + "&pay_flag=" + payadv_flag);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <br />
  <%--  <div align="center">
        <input type="button" value="ส่งข้อมูลประกัน" id="b_SendDept" onclick="SendDept()" />
    </div>--%>
