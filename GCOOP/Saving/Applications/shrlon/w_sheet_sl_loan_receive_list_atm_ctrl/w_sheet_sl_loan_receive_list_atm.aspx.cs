...
namespace Saving.Applications.shrlon.w_sheet_sl_loan_receive_list_atm_ctrl
{
    public partial class w_sheet_sl_loan_receive_list_atm : PageWebSheet, WebSheet
    {
        [JsPostBack]
        ...
        [JsPostBack]
        public string of_SendDept { get; set; }
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == PostShowDataGroupEntry)
            {
                ...
                dsList.RetrieveListEntryGroup(entry);
            }
