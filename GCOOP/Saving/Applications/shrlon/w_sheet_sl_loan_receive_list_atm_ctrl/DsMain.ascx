<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_receive_list_atm_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td width="20%">
                    <asp:Button ID="b_show" runat="server" Text="ดึงข้อมูล" Style="font-size: 15px; width: 80px;"
