...
{
    public partial class DsCollOld : DataSourceRepeater
    {
        public DataSet1.LNREQCONTADJUSTCOLLDataTable DATA { get; private set; }

        public void InitDsCollOld(PageWeb pw)
        {
            css1.Visible = false;
            css2.Visible = false;
            DataSet1 ds = new DataSet1();
            this.DATA = ds.LNREQCONTADJUSTCOLL;
            this.InitDataSource(pw, Repeater1, this.DATA, "dsCollOld");
            this.EventItemChanged = "OnDsCollOldItemChanged";
            this.EventClicked = "OnDsCollOldClicked";
