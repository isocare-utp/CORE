<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_loan_receive_list_ctrl.w_dlg_loan_receive_ctrl.DsMain" %>
