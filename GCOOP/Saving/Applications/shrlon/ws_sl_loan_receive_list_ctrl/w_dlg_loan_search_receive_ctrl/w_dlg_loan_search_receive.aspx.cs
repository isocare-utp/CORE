        ...
        protected void Search_Click()
        {
            try
            {
               ...
               // string memb_no = String.Format("{0:00000000}", Convert.ToDecimal(member_no));
                ...
                {
                    sqlext_con += " and ( LNCONTMASTER.LOANAPPROVE_DATE between convert (datetime,('" + approve_date_s + "')) and  convert(datetime,('" + approve_date_e + "','" + date_s + "' )))";
                    sqlext_req += " and ( LNREQLOAN.APPROVE_DATE between convert(datetime,('" + approve_date_s + "')) and  convert(datetime,('" + approve_date_e + "','" + date_s + "' )) )";
                }
