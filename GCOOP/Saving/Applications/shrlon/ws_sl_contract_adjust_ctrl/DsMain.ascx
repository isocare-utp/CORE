<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_contract_adjust_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="cp_name" runat="server" Style="width: 265px; background-color: #CCCCCC;" ReadOnly="true"></asp:TextBox>
                </td>
                <td>
                    <div>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="cp_loantype" runat="server" ReadOnly="true" Style="width: 265px; background-color: #CCCCCC;
                        "></asp:TextBox>
                </td>
                <td>
                    <div>
                ...
                <td>
                    <asp:DropDownList ID="contlaw_status" runat="server" Style="width: 85px;visibility" Enabled="false">
                        </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td width="12%">
                    <asp:CheckBox ID="contadjust_status" Text="อนุมัติ" runat="server" Enabled="false"/>
                </td>
            </tr>
        </table>
    </EditItemTemplate>
