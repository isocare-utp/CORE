...
{
    public partial class w_sheet_yrconfirmbalance : PageWebSheet,WebSheet
    {
        ...
        private void CallWSRunRcvProcess(string xml)
        {
            try
            {
                ...
                //shService.RunSlyrconfirmbalance(state.SsWsPass, ref astr_yrcfbal_proc, state.SsApplication, state.CurrentPage);
