<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="ws_sl_collateral_master_view.aspx.cs" Inherits="Saving.Applications.shrlon.ws_sl_collateral_master_view_ctrl.ws_sl_collateral_master_view" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function OnDsListClicked(s, r, c, v) {
            if (c == "collmast_no" || c == "collmasttype_desc" || c == "dol_prince" || c == "est_price") {
                PostCollNo();
            }
        }
