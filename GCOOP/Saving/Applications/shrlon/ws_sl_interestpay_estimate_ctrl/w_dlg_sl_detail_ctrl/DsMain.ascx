<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_interestpay_estimate_ctrl.w_dlg_sl_detail_ctrl.DsMain" %>
