...
{
    public partial class DsSMain : DataSourceFormView
    {
        public DataSet1.ASSSLIPPAYOUTDataTable DATA { get; set; }
        public void InitDsSMain(PageWeb pw)
        {
            css1.Visible = false;
            DataSet1 ds = new DataSet1();
            this.DATA = ds.ASSSLIPPAYOUT;
            this.EventItemChanged = "OnDsSMainItemChanged";
            this.EventClicked = "OnDsSMainClicked";
            this.InitDataSource(pw, FormView2, this.DATA, "dsSMain");
            this.Register();
        }
