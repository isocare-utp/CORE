...
{
    public partial class DsMedical : DataSourceFormView
    {
        public DataSet1.ASSREQMASTERDataTable DATA { get; set; }
        public void InitDsMedical(PageWeb pw)
        {
            css1.Visible = false;
            DataSet1 ds = new DataSet1();
            this.DATA = ds.ASSREQMASTER;
            this.EventItemChanged = "OnDsMedicalItemChanged";
            this.EventClicked = "OnDsMedicalClicked";
            this.InitDataSource(pw, FormView1, this.DATA, "dsMedical");
            this.Register();
        }
