<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_divsrv_slcls_shr.aspx.cs" Inherits="Saving.Applications.divavg.w_sheet_divsrv_slcls_shr" %>
    ...
    <script type="text/JavaScript">
        ...
        function SheetLoadComplete() {
            if (Gcoop.GetEl("Hd_process").value == "true") {
                Gcoop.OpenProgressBar("ประมวลผลปิดสิ้นปีหุ้น", true, true, ProcClsYearComplete);
            }
        }
            ...
            <tr>
                <td colspan="3">
                    <dw:WebDataWindowControl ID="Dw_option" runat="server" 
                        ...
                        LibraryList="~/DataWindow/divavg/divsrv_proc_slcls_shr.pbl" 
