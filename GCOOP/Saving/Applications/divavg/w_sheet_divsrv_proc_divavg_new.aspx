...
CodeBehind="w_sheet_divsrv_proc_divavg_new.aspx.cs" Inherits="Saving.Applications.divavg.w_sheet_divsrv_proc_divavg_new" %>
                ...
                <td colspan="3">
                    <asp:Panel ID="Panel2" runat="server" Height="300px" ScrollBars="Auto" Width="500px">
                        <dw:WebDataWindowControl ID="Dw_loan" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
                            ...
                            DataWindowObject="d_divsrv_prc_divavg_lntype_option_new" LibraryList="~/DataWindow/divavg/divsrv_proc_divavg.pbl"
