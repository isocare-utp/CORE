<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsCriteria.ascx.cs" Inherits="Saving.Applications.divavg.dlg.w_dlg_divsrv_member_search_ctrl.DsCriteria" %>
