<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_divsrv_proc_divavg_estimate.aspx.cs" Inherits="Saving.Applications.divavg.w_sheet_divsrv_proc_divavg_estimate" %>
                ...
                <td colspan="5">
                    <asp:Panel ID="Panel1" runat="server">
                        <dw:WebDataWindowControl ID="Dw_option" runat="server" AutoRestoreContext="False"
                            ...
                            ClientScriptable="True" DataWindowObject="d_divsrv_prc_estimate_divavg_option" LibraryList="~/DataWindow/divavg/divsrv_proc_estdivavg.pbl"
                ...
                <td colspan="5">
                    <asp:Panel ID="Panel2" runat="server" Height="300px" ScrollBars="Auto" Width="500px">
                        <dw:WebDataWindowControl ID="Dw_loan" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
                            ...
                            DataWindowObject="d_divsrv_prc_divavg_lntype_option_est" LibraryList="~/DataWindow/divavg/divsrv_proc_estdivavg.pbl"
