...
namespace Saving.Applications.divavg.ws_divsrv_detail_ctrl
{
    public partial class DsMethodpayment : DataSourceRepeater
    {
        ...
        public void RetrieveMethodpayment(String ls_member_no, String ls_year)
        {
            ...
            from yrdivmethpay left join cmucfbankbranch on yrdivmethpay.expense_bank = cmucfbankbranch.bank_code and yrdivmethpay.expense_branch = cmucfbankbranch.branch_id,
	            yrucfmethpay
        ...
        public void DdMethpaytype()
        {
            ...
            where coop_id = {0}
                and showlist_flag = 1   
            union select '','',0,0 order by sorter, methpaytype_code asc";
