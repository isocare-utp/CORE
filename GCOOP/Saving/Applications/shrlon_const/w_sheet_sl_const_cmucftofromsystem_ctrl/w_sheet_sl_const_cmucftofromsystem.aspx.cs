...
namespace Saving.Applications.shrlon_const.w_sheet_sl_const_cmucftofromsystem_ctrl
{
    public partial class w_sheet_sl_const_cmucftofromsystem : PageWebSheet, WebSheet
    {
        [JsPostBack]
        public string PostSystem { get; set; }
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostNewRow)
            {
                ...
                dsList.SetItem(0, dsList.DATA.SYSTEM_CODEColumn, "");
            }
