...
namespace Saving.Applications.shrlon_const.w_sheet_sl_const_lnucfloancolltype_ctrl
{
    public partial class w_sheet_sl_const_lnucfloancolltype : PageWebSheet, WebSheet
    {
        [JsPostBack]
        public string PostLoanCollType { get; set; }
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostNewRow)
            {
                ...
                dsList.SetItem(0, dsList.DATA.LOANCOLLTYPE_CODEColumn, "");
            }
