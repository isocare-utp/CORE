...
namespace Saving.Applications.shrlon_const.w_sheet_sl_const_cmucfslipitemtype_ctrl
{
    ...
    {
        public DataSet1.SLUCFSLIPITEMTYPEDataTable DATA { get; private set; }
        ...
        public void InitDs(PageWeb pw)
        {
            ...
            this.DATA = ds.SLUCFSLIPITEMTYPE;
        ...
        {
            string sql = @"SELECT * FROM SLUCFSLIPITEMTYPE order by SLIPITEMTYPE_CODE";
