...
{
    public partial class w_sheet_sl_const_cmucfsliptype : PageWebSheet , WebSheet
    {
        [JsPostBack]
        public string PostSlipType { get; set; }
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostNewRow)
            {
                ...
                dsList.SetItem(0, dsList.DATA.SLIPTYPE_CODEColumn, "");
            }
