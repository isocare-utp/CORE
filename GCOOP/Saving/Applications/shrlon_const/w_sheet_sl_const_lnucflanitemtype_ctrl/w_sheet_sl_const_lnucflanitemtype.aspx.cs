...
{
    public partial class w_sheet_sl_const_lnucflanitemtype : PageWebSheet, WebSheet
    {
        [JsPostBack]
        public string PostLoanItemType { get; set; }
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostNewRow)
            {
                ...
                dsList.SetItem(0, dsList.DATA.LOANITEMTYPE_CODEColumn, "");
            }
