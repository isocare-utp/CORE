...
namespace Saving.CriteriaIReport.u_cri_coopid_period_rmembgroup_rpttype
{
    public partial class u_cri_coopid_period_rmembgroup_rpttype : PageWebReport,WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_rpttype = dsMain.DATA[0].RPT_TYPE;
            ...
            try
            {
                ...
                arg.Add("as_rpttype", iReportArgumentType.String, as_rpttype);
