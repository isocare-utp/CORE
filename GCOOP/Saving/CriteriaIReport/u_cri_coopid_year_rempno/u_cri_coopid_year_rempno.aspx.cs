...
namespace Saving.CriteriaIReport.u_cri_coopid_year_rempno
{
    public partial class u_cri_coopid_year_rempno : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_period = dsMain.DATA[0].as_period;
