...
namespace Saving.CriteriaIReport.u_cri_coopid_rdate_rmembgroup_bycoopid
{
    public partial class u_cri_coopid_rdate_rmembgroup_bycoopid : PageWebReport, WebReport
    {
