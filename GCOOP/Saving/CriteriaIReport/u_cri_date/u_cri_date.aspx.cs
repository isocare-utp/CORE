...
namespace Saving.CriteriaIReport.u_cri_date
{
    public partial class u_cri_date : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            try
            {
                ...
                arg.Add("as_date", iReportArgumentType.String, as_adtm_date);
