<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true"
    CodeBehind="u_cri_coopid_divyear_rmembgroup_rcontrol.aspx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_divyear_rmembgroup_rcontrol.u_cri_coopid_divyear_rmembgroup_rcontrol" %>
...
<script type="text/javascript">
    ...
    function OnDsMainItemChanged(s, r, c, v) {
        ...
        if (c == "smembcontrol_code") {
            dsMain.SetItem(0, "smembcontrol_desc", v);
        }
        else if (c == "smembcontrol_desc") {
            dsMain.SetItem(0, "smembcontrol_code", v);
        }
        else if (c == "emembcontrol_code") {
            dsMain.SetItem(0, "emembcontrol_desc", v);
        }
        else if (c == "emembcontrol_desc") {
            dsMain.SetItem(0, "emembcontrol_code", v);
        }
    }
    </script>
</asp:Content>
