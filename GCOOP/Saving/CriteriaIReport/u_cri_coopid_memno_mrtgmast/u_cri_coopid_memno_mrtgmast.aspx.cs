...
namespace Saving.CriteriaIReport.u_cri_coopid_memno_mrtgmast
{
    public partial class u_cri_coopid_memno_mrtgmast : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_mrtgmast = dsMain.DATA[0].mrtgmast;
            ...
            try
            {
                ...
                arg.Add("coopid", iReportArgumentType.String, state.SsCoopControl);
                arg.Add("member_no", iReportArgumentType.String, as_memno);
                arg.Add("mrtgmast_no", iReportArgumentType.String, as_mrtgmast);
