<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_memno_loancont_bycoopid.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="iReportDataSourceFormView">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:DropDownList ID="loancont" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
