...
namespace Saving.CriteriaIReport.u_cri_coopid_rdepttype_date
{
    public partial class u_cri_coopid_rdepttype_date : PageWebReport, WebReport
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsMain.DATA[0].depttype_scode = "01";
                dsMain.DATA[0].depttype_ecode = "08";
                dsMain.DATA[0].as_date = state.SsWorkDate;
        ...
        public void RunReport()
        {
            ...
            try
            {
                ...
                DateTime as_operatedate = dsMain.DATA[0].as_date;
                ...
                arg.Add("as_operatedate", iReportArgumentType.Date, as_operatedate);
