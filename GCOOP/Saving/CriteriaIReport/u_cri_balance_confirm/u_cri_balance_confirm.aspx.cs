    ...
    public partial class u_cri_balance_confirm : PageWebReport, WebReport
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsMain.DATA[0].balance_date = state.SsWorkDate;
        ...
        {
            DateTime adtm_baldate = dsMain.DATA[0].balance_date;
            DateTime as_docdate = dsMain.DATA[0].document_date;
            ...
            try
            {
                ...
                arg.Add("adtm_operate", iReportArgumentType.Date, adtm_baldate);
                arg.Add("adtm_docdate", iReportArgumentType.Date, as_docdate);
