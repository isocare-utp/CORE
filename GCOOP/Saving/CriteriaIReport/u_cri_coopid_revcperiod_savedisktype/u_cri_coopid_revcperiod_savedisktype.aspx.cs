...
{
    public partial class u_cri_coopid_revcperiod_savedisktype : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string law_start = dsMain.DATA[0].law_start;
            string law_end = dsMain.DATA[0].law_end;
            ...
            try
            {
                ...
                arg.Add("ai_bizz", iReportArgumentType.String, law_start);
                arg.Add("ai_bizzsts", iReportArgumentType.String, law_end);
