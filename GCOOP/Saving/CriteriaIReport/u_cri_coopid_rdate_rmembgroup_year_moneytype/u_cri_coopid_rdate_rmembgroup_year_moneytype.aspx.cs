...
namespace Saving.CriteriaIReport.u_cri_coopid_rdate_rmembgroup_year_moneytype
{
    public partial class u_cri_coopid_rdate_rmembgroup_year_moneytype : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string moneytype = dsMain.DATA[0].moneytype;
            ...
            try
            {
                ...
                arg.Add("as_year", iReportArgumentType.String, year);
                arg.Add("as_moneytype", iReportArgumentType.String, moneytype);
