<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_memno_date_shramt.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="iReportDataSourceFormView">
            ...
            <tr>
                <td>
                    <div>
                        <span>จำนวนหุ้น:</span></div>
                </td>
                <td colspan="3">
                    <asp:TextBox ID="share_amt" runat="server" Style="text-align: center"></asp:TextBox>
                </td>
            </tr>
        </table>
    </EditItemTemplate>
