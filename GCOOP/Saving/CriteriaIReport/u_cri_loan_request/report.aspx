<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true"
    CodeBehind="report.aspx.cs" Inherits="Saving.CriteriaIReport.u_cri_loan_request.report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link id="css1" runat="server" href="../../../JsCss/DataSourceTool.css" rel="stylesheet"
        ...
        <script type="text/javascript">
            $(function () {
                AutoSlash('input[name="ctl00$ContentPlace$str_date1"]');
         ...
         (keyCode >= 96 && keyCode <= 105)) && isShift == false) {
            ...
            function ValidateDate(txt, keyCode) {
                ...
                if (document.getElementById("<%=validdate.ClientID %>").value == "1") {
                    ...
                    document.getElementById("<%=str_date1.ClientID%>").value = curr_date + '/' + curr_month + '/' + (Number(curr_year) + 543).toString();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <tr>
       ...
       <td width="50">
                <div>
                    <span>วันที่จ่ายเงินกู้ :</span>
                </div>
            </td>
            <td width="30">
                <asp:TextBox ID="str_date1" runat="server" MAXLENGTH="10" style="width:100px;" onkeyup="ValidateDate(this, event.keyCode)"
                    onkeydown="return DateFormat(this, event.keyCode)"></asp:TextBox>
                    <asp:TextBox ID="str_date2" runat="server" MAXLENGTH="10" style="width:100px;" onkeyup="ValidateDate(this, event.keyCode)"
                    onkeydown="return DateFormat(this, event.keyCode)"></asp:TextBox>
            </td>
           <%-- <td width="50">
       </td>--%>
       ...
       <td width="20">
            ...
            <td width="50">
                <div>
                    <span>ตั้งแต่เงินกู้ :</span>
                </div>
            </td>
            <td width="120">
                <asp:DropDownList ID="loangrp1" runat="server">
       ...
       <td width="20">
            ...
            <td width="50">
                <div>
                    <span>ถึงเงินกู้ :</span>
                </div>
            </td>
            <td width="120">
                <asp:DropDownList ID="loangrp2" runat="server">
