...
{
    public partial class u_cri_coopid_rcommittee : PageWebReport, WebReport
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            {
                dsMain.DdCoopId();
                dsMain.DATA[0].year = (state.SsWorkDate.Year+543).ToString();
                dsMain.DdScommit();
                dsMain.DdEcommit();
            }
        }
        ...
        public void RunReport()
        {
            ...
            string scommit = dsMain.DATA[0].scommit;
            string ecommit = dsMain.DATA[0].ecommit;
            decimal year = Convert.ToDecimal(dsMain.DATA[0].year);
            year = year - 543;
            int period = Convert.ToInt32(year + dsMain.DATA[0].month.ToString("00"));
            ...
            try
            {
                ...
                arg.Add("as_scommit", iReportArgumentType.String, scommit);
                arg.Add("as_ecommit", iReportArgumentType.String, ecommit);
                arg.Add("as_period", iReportArgumentType.String, period.ToString());
