...
namespace Saving.CriteriaIReport.u_cri_coopid_emp
{
    public partial class u_cri_coopid_emp : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_sempno = dsMain.DATA[0].start_empno;
            ...
            try
            {
                ...
                arg.Add("as_empno", iReportArgumentType.String, as_sempno);
