...
namespace Saving.CriteriaIReport.u_cri_coopid_empno
{
    public partial class u_cri_coopid_empno : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_eempno = dsMain.DATA[0].end_empno;
