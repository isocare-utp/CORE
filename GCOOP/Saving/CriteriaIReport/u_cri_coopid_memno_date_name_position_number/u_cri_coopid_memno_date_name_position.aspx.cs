...
namespace Saving.CriteriaIReport.u_cri_coopid_memno_date_name_position_number
{
    public partial class u_cri_coopid_memno_date_name_position_number : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string name = dsMain.DATA[0].name;
            string position = dsMain.DATA[0].position;
            string n_ber = dsMain.DATA[0].n_ber;
            try
            {
                ...
                arg.Add("as_name", iReportArgumentType.String, name);
                arg.Add("as_position", iReportArgumentType.String, position);
                arg.Add("as_number", iReportArgumentType.String, n_ber);
