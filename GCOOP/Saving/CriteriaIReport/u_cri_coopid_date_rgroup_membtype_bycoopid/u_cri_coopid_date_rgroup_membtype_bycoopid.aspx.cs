...
{
    public partial class u_cri_coopid_date_rgroup_membtype_bycoopid : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_membtype = dsMain.DATA[0].membtype;
            ...
            try
            {
                ...
                arg.Add("as_membtype", iReportArgumentType.String, as_membtype);
