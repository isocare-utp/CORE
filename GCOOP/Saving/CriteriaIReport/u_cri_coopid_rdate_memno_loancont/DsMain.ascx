<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_rdate_memno_loancont.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="iReportDataSourceFormView">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="loancont" runat="server"></asp:TextBox>
                </td>
            </tr>
        </table>
    </EditItemTemplate>
