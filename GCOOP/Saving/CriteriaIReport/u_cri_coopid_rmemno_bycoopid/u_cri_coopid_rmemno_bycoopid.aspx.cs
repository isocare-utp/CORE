...
namespace Saving.CriteriaIReport.u_cri_coopid_rmemno_bycoopid
{
    public partial class u_cri_coopid_rmemno_bycoopid : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_memno2 = dsMain.DATA[0].memno2;
           
            try
            {
                iReportArgument arg = new iReportArgument();
                arg.Add("as_coopid", iReportArgumentType.String, as_coopid);
                arg.Add("as_coop", iReportArgumentType.String, as_coopid2);
                arg.Add("as_membno", iReportArgumentType.String, as_memno);
                arg.Add("as_membno2", iReportArgumentType.String, as_memno2);
