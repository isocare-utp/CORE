<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_rmembgroup_protect.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="iReportDataSourceFormView">
            ...
            <tr>
                <td>
                    <div>
                        <span>ประเภทประกันชีวิต:</span></div>
                </td>
                <td colspan="2">
                    <asp:DropDownList ID="company_id" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
