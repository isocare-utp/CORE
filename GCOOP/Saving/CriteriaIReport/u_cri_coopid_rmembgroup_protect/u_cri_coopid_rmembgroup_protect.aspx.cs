...
{
    public partial class u_cri_coopid_rmembgroup_protect : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string company_id = dsMain.DATA[0].company_id;
            ...
            try
            {
                ...
                arg.Add("company_id", iReportArgumentType.String, company_id);
