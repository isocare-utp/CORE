...
namespace Saving.CriteriaIReport.u_cri_coopid_rempno_mer
{
    public partial class u_cri_coopid_rempno_mer : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            if (Request.QueryString["rid"] != null)
            {
                ...
                string assist_state = dsMain.DATA[0].assist_state;
                ...
                if (assist_state == "ตนเอง")
                {

                    try
                    {

                        string assist_state_s = "01";
                        string assist_state_e = "01";
                        ...
                        arg.Add("as_sdate", iReportArgumentType.Date, date1);
                        arg.Add("as_edate", iReportArgumentType.Date, date2);
                        arg.Add("assist_state_s", iReportArgumentType.String, assist_state_s);
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string assist_state_s = "02";
                        string assist_state_e = "05";
