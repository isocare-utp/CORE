...
namespace Saving.CriteriaIReport.u_cri_coopid_memno_loancont
{
    public partial class DsMain : DataSourceFormView
    {
        ...
        {
            String sql = @"select loancontract_no,1 as sorter from lncontmaster where coop_id = {0} and member_no = {1} and principal_balance > 0 union 
