...
namespace Saving.CriteriaIReport.u_cri_coopid_period_emptype
{
    public partial class u_cri_coopid_period_emptype : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            try
            {
                ...
                arg.Add("as_emptype", iReportArgumentType.String, Convert.ToString(as_emptype));
