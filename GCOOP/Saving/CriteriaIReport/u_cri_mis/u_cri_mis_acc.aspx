<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_mis_acc.aspx.cs" Inherits="Saving.CriteriaIReport.u_cri_mis.u_cri_mis_acc" %>
...
<tr>
            ...
            <td width="100">
                <asp:DropDownList ID="str_month2" runat="server">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem Value="01"> มกราคม</asp:ListItem>
                        <asp:ListItem Value="02"> กุมภาพันธ์</asp:ListItem>
                        <asp:ListItem Value="03"> มีนาคม</asp:ListItem>
            ...
            <td width="30">
                <asp:TextBox ID="str_year2" runat="server" ></asp:TextBox>
            </td>
</tr>
</table>
</asp:Content>
