...
{
    public partial class u_cri_branchid_rdate_deposit_status : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal member_status = dw_criteria.GetItemDecimal(1, "member_status");
            ...
            lnv_helper.AddArgument( member_status.ToString(), ArgumentType.Number);
            //----------------------------------------------------
