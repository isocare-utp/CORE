...
{
    public partial class u_cri_dateclosemonth : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            DateTime select_date = dw_criteria.GetItemDateTime(1, "select_date");
            Decimal month = Convert.ToInt32(select_date.Month);
            Decimal year = Convert.ToInt32(select_date.Year)+543;
