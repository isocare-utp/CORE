...
{
    public partial class u_cri_rdate_emptype : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "emp_type", pbl, null);
        }
        ...
        private void RunProcess()
        {
            ...
            try 
            {
                emp_type = dw_criteria.GetItemString(1, "emp_type").Trim();
            }
            catch { emp_type = "%"; }
            ...
            lnv_helper.AddArgument(emp_type, ArgumentType.String);
