...
{
    public partial class u_cri_rdate_rmembno_status_membtype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "member_type", "criteria.pbl", null);
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "member_type", ""); // nott create
        ...
        private void CheckFlag()
        {
            ...
            if (fixed_flagtest == 0)
            {
                dw_criteria.SetItemString(1, "member_type", "");
        ...
        private void RunProcess()
        {
            ...
            String member_type = dw_criteria.GetItemString(1, "member_type"); // not create

            Decimal fixed_flagtest1 = dw_criteria.GetItemDecimal(1, "fixed_flag");
            ...
            lnv_helper.AddArgument(member_type, ArgumentType.String); // not create
