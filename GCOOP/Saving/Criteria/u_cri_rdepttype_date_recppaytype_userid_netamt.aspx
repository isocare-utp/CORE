<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rdepttype_date_recppaytype_userid_netamt.aspx.cs" Inherits="Saving.Criteria.u_cri_rdepttype_date_recppaytype_userid_netamt" Title="Untitled Page" %>
        ...
        <tr>
            <td align="center" style="width:500px">
             <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_rdepttype_date_recppaytype_userid_netamt"
