...
{
    public partial class u_cri_coopid_chgshapea : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal select_coop = dw_criteria.GetItemDecimal(1, "select_status");
            ...
            lnv_helper.AddArgument(select_coop.ToString(), ArgumentType.Number);
