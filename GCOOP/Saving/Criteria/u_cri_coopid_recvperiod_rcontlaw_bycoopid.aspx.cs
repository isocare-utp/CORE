...
{
    public partial class u_cri_coopid_recvperiod_rcontlaw_bycoopid : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_contlaw", "criteria.pbl", state.SsCoopControl);
            DwUtil.RetrieveDDDW(dw_criteria, "end_contlaw", "criteria.pbl", state.SsCoopControl);
        ...
        private void RunProcess()
        {
            ...
            decimal start_contlaw = dw_criteria.GetItemDecimal(1, "start_contlaw");
            decimal end_contlaw = dw_criteria.GetItemDecimal(1, "end_contlaw");
            ...
            lnv_helper.AddArgument(start_contlaw.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(end_contlaw.ToString(), ArgumentType.Number);
