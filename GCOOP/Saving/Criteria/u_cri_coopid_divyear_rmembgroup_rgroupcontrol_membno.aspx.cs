...
{
    public partial class u_cri_coopid_divyear_rmembgroup_rgroupcontrol_membno : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                string[] minmax3 = ReportUtil.GetMinMaxMembno();
                dw_criteria.SetItemString(1, "start_membno", minmax3[0]);
                dw_criteria.SetItemString(1, "end_membno", minmax3[1]);
