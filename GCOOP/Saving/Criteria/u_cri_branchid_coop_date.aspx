<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_branchid_coop_date.aspx.cs"
    Inherits="Saving.Criteria.u_cri_branchid_coop_date" Title="Report Criteria" %>
...
<%=runProcess%>
		...
		<script type="text/javascript">
		    ...
		    $(function () {
		        Gcoop.GetEl("Hdbranch_desc").value = $('select[name="branch_id_0"]').text()
            })
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_branchid_date_pea"
