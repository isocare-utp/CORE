...
{
    public partial class u_cri_membgroup : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_membgroup", "98800100"); //minmax[0]
        ...
        private void RunProcess()
        {
            ...
            try
            {
                ...
                ta.Exec(" SP_RPT_COLL_DETAIL('" + start_membgroup + "') ");
                //ta.Commit(true);
                LtServerMessage.Text = WebUtil.CompleteMessage("Exec Stored Procedures เรียบร้อย");
            }
            catch
            { LtServerMessage.Text = WebUtil.ErrorMessage("เกิดข้อผิดพลาดในการ Exec Stored Procedures!!!"); }
