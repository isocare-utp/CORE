...
{
    public partial class d_cri_coopid_recvperiod_accid_rgrp : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "account_id", "criteria.pbl", state.SsCoopControl);
        ...
        private void RunProcess()
        {
            ...
            String account_id = dw_criteria.GetItemString(1, "account_id");
