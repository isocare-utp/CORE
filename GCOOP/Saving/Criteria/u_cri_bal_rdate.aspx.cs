...
{
    public partial class u_cri_bal_rdate : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "itemtype_id", "criteria.pbl", null);
            if (IsPostBack)
            {
        ...
        private void RunProcess()
        {
            ...
            //String itemtype_id = dw_criteria.GetItemString(1, "itemtype_id");
            ...
            String suppliesgroup = dw_criteria.GetItemString(1, "suppliesgroup");
            String coop_name = state.SsCoopName;
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            //lnv_helper.AddArgument(itemtype_id, ArgumentType.String);
            //lnv_helper.AddArgument(start_date, ArgumentType.DateTime);
            lnv_helper.AddArgument(suppliesgroup, ArgumentType.String);
            lnv_helper.AddArgument(start_date, ArgumentType.DateTime);
