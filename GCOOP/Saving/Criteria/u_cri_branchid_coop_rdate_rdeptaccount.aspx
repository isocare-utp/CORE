<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_branchid_coop_rdate_rdeptaccount.aspx.cs" Inherits="Saving.Criteria.u_cri_branchid_coop_rdate_rdeptaccount" Title="Untitled Page" %>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_branchid_rdate_rdeptaccount"
