...
{
    public partial class u_cri_rdate_rprincipal : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal start_principal = dw_criteria.GetItemDecimal(1, "start_principal");
            Decimal end_principal = dw_criteria.GetItemDecimal(1, "end_principal");
            ...
            lnv_helper.AddArgument(start_principal.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(end_principal.ToString(), ArgumentType.Number);
