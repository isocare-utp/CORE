...
{
    public partial class u_cri_coopid_date_loan_mnager : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String topic = dw_criteria.GetItemString(1, "topic");
            String position1 = dw_criteria.GetItemString(1, "position1");
            String memno_1 = dw_criteria.GetItemString(1, "memno_1");
            String position2 = dw_criteria.GetItemString(1, "position2");
            String memno_2 = dw_criteria.GetItemString(1, "memno_2");
            String req_status = dw_criteria.GetItemString(1, "req_status");
            ...
            lnv_helper.AddArgument(topic, ArgumentType.String);
            lnv_helper.AddArgument(position1, ArgumentType.String);
            lnv_helper.AddArgument(memno_1, ArgumentType.String);
            lnv_helper.AddArgument(position2, ArgumentType.String);
            lnv_helper.AddArgument(memno_2, ArgumentType.String);
            lnv_helper.AddArgument(req_status, ArgumentType.Number);
