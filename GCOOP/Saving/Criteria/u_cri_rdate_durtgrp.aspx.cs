...
{
    public partial class u_cri_rdate_durtgrp : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "durtgrp_code", "criteria.pbl", null);
            }
        ...
        private void RunProcess()
        {
            ...
            String durtgrp_code = dw_criteria.GetItemString(1, "durtgrp_code");
            ...
            lnv_helper.AddArgument(durtgrp_code, ArgumentType.String);
