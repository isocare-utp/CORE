<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_year_month_rlntype_bycoopid.aspx.cs" Inherits="Saving.Criteria.u_cri_year_month_rlntype_bycoopid" Title="Untitled Page" %>
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_year_month_rloantype_bycoopid"
