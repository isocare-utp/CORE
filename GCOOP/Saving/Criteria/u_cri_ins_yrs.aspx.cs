...
{
    public partial class u_cri_ins_yrs : PageWebSheet, WebSheet
    {
        ...
        {
            //DwUtil.RetrieveDDDW(dw_criteria, "as_yrs", "criteria.pbl", null);
        ...
        private void RunProcess()
        {
            ...
            String asyrs = dw_criteria.GetItemString(1, "as_yrs");
            ...
            lnv_helper.AddArgument(asyrs, ArgumentType.String);
