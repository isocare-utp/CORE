<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rmembgroup.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rmembgroup" Title="Report Criteria" %>
        ...
        <tr>
            <td align="center" >
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_mis_cri_coll"
