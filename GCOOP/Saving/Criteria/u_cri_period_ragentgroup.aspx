<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_period_ragentgroup.aspx.cs" Inherits="Saving.Criteria.u_cri_period_ragentgroup" Title="Untitled Page" %>
...
<%=post%>
		...
		<script type="text/javascript">
		    ...
		    function OnDwItemChanged(sender, row, column, value){
		        if(column == "start_agent" || column == "end_agent"){
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_month_year_ragentgrp"
