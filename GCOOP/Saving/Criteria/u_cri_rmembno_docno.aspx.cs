...
{
    public partial class u_cri_rmembno_docno : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "select_docno", "");
        ...
        private void RunProcess()
        {
            ...
            String select_docno = dw_criteria.GetItemString(1, "select_docno");
            ...
            lnv_helper.AddArgument(select_docno, ArgumentType.String);
