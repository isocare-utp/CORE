...
{
    public partial class d_cri_coopid_divyear_memno_date_human_trndesc : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String member_no = WebUtil.MemberNoFormat(dw_criteria.GetItemString(1, "member_no"));
