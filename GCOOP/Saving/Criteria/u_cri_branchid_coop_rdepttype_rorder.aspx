<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_branchid_coop_rdepttype_rorder.aspx.cs" Inherits="Saving.Criteria.u_cri_branchid_coop_rdepttype_rorder" Title="Untitled Page" %>
...
<asp:Literal ID="LtServerMessage" runat="server"></asp:Literal>
    <table style="text-align:center">
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_branchid_rdepttype_rorder"
        ...
        <tr>
           <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria1" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" 
                    ClientScriptable="True" DataWindowObject="d_cri_rorder"
                    LibraryList="~/DataWindow/ap_deposit/criteria.pbl" 
                    AutoSaveDataCacheAfterRetrieve="True">
                </dw:WebDataWindowControl>
            </td>
        </tr>
