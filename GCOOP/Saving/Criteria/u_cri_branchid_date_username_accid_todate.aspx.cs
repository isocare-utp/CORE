...
{
    public partial class u_cri_branchid_date_username_accid_todate : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "account_id", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "select_username", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "recpay", "criteria.pbl", null);
            if (IsPostBack)
            {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "recpay", "");
                tdw_criteria.Eng2ThaiAllRow();

                DataWindowChild dcAccid = dw_criteria.GetChild("account_id");

                if (dcAccid.RowCount > 0)
                {
                    String accid = dcAccid.GetItemString(1, "account_id").Trim();
                    dw_criteria.SetItemString(1, "account_id", accid);
                }
            }
        ...
        private void RunProcess()
        {
            ...
            String accountid = dw_criteria.GetItemString(1, "account_id");
            String recpay = dw_criteria.GetItemString(1, "recpay");
            ...
            lnv_helper.AddArgument(accountid, ArgumentType.String);
            lnv_helper.AddArgument(recpay, ArgumentType.String);
