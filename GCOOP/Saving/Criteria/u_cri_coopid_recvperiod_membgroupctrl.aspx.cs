...
{
    public partial class u_cri_coopid_recvperiod_membgroupctrl : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                string[] minmax = ReportUtil.GetMinMaxMembgroupCtrl();
                ...
                dw_criteria.SetItemString(1, "start_membtype", minmax2[0]);
                dw_criteria.SetItemString(1, "end_membtype", minmax2[1]);
            }
        ...
        private void RunProcess()
        {
            ...
            String as_recvperiod = as_year + as_month;
            String as_membgrp_ctrls = dw_criteria.GetItemString(1, "start_membgroup");
            String as_membgrp_ctrle = dw_criteria.GetItemString(1, "end_membgroup");
            String as_membtype_codes = dw_criteria.GetItemString(1, "start_membtype");
            String as_membtype_codee = dw_criteria.GetItemString(1, "end_membtype");
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            lnv_helper.AddArgument(as_coopid, ArgumentType.String);
            lnv_helper.AddArgument(as_recvperiod, ArgumentType.String);
            lnv_helper.AddArgument(as_membgrp_ctrls, ArgumentType.String);
            lnv_helper.AddArgument(as_membgrp_ctrle, ArgumentType.String);
            lnv_helper.AddArgument(as_membtype_codes, ArgumentType.String);
            lnv_helper.AddArgument(as_membtype_codee, ArgumentType.String);
