...
{
    public partial class u_cri_rdate_rmembgroup_lawtype : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal start_lawtype = dw_criteria.GetItemDecimal(1, "start_lawtype");
            Decimal end_lawtype = start_lawtype;
            if (start_lawtype == 99)
            {
                start_lawtype = 0;
                end_lawtype = 99;
            ...
            lnv_helper.AddArgument(start_lawtype.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(end_lawtype.ToString(), ArgumentType.Number);
