...
{
    public partial class u_cri_date_bank_bill : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "billitemtype_code", "criteria.pbl", null);
        ...
        private void RunProcess()
        {
            ...
            String bank_code = dw_criteria.GetItemString(1, "bank_code").Trim();
            String billitemtype_code = dw_criteria.GetItemString(1, "billitemtype_code").Trim();
            ...
            lnv_helper.AddArgument(billitemtype_code, ArgumentType.String);
