<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true"
    CodeBehind="u_cri_div_coopid_year_rtyplon_step.aspx.cs" Inherits="Saving.Criteria.u_cri_div_coopid_year_rtyplon_step" %>
    ...
    <script type="text/javascript">
        function OnItemChange(s, r, c, v) {
            if (c == "year") {
                ...
                objdw_criteria.SetItem(1, "step", v);
                objdw_criteria.AcceptText();
                Gcoop.GetEl("Hdstep").value = v;
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_div_coopid_year_rmemgrp_step"
    ...
    <asp:HiddenField ID="Hdstep" runat="server" Value="False" />
    <%=outputProcess%>
</asp:Content>
