...
{
    public partial class u_cri_rdate_mis_4status : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "status", pbl, null);
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                //WebUtil.RetrieveDDDW(dw_criteria,"status","criteria.pbl",null);
        ...
        private void RunProcess()
        {
           //อ่านค่าจากหน้าจอใส่ตัวแปรรอไว้ก่อน.
            ...
            try 
            {
                status = dw_criteria.GetItemString(1, "status");
            }
            catch { status = ""; }
