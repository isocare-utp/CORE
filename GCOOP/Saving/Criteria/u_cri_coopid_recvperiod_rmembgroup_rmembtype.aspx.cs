...
{
    public partial class u_cri_coopid_recvperiod_rmembgroup_rmembtype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_membtype_1", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "end_membtype_1", "criteria.pbl", null);
            ...
            else
            {
                ...
                string[] minmaxc = ReportUtil.GetMinMaxMembType();
                dw_criteria.SetItemString(1, "start_membtype_1", minmaxc[0]);
                dw_criteria.SetItemString(1, "end_membtype_1", minmaxc[1]);
            }
        ...
        private void RunProcess()
        {
            ...
            String start_membgroup = dw_criteria.GetItemString(1, "start_membgroup_1").Trim();
            String end_membgroup = dw_criteria.GetItemString(1, "end_membgroup_1").Trim();
            String start_mbtype = dw_criteria.GetItemString(1, "start_membtype");
            String end_mbtype = dw_criteria.GetItemString(1, "end_membtype");
            ...
            lnv_helper.AddArgument(start_mbtype, ArgumentType.String);
            lnv_helper.AddArgument(end_mbtype, ArgumentType.String);
