<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_date_rmembno_coopid_number_date_returndate.aspx.cs" Inherits="Saving.Criteria.u_cri_date_rmembno_coopid_number_date_returndate" %>
       ...
       <%=postSetStartMemberno%>
		...
		<script type="text/javascript">
		    		    function OnItemChange(s, r, c, v) {
                            ...
                            else if ( c == "start_membgroup" || c == "end_membgroup")
		                    {
        ...
        <tr>
            <td align="center">
                <table style="width: 100%;">
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_date_rmembno_number_name_date_datereturn"
