...
{
    public partial class u_cri_coopid_recvperiod_membertype : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal member_type = dw_criteria.GetItemDecimal(1, "member_type");
            ...
            lnv_helper.AddArgument(member_type.ToString(), ArgumentType.Number);
