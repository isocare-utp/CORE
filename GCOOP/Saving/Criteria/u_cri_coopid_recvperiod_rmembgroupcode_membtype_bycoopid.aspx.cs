...
{
    public partial class u_cri_coopid_recvperiod_rmembgroupcode_membtype_bycoopid : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            lnv_helper.AddArgument(membtypes, ArgumentType.String);
            lnv_helper.AddArgument(membtypee, ArgumentType.String);
