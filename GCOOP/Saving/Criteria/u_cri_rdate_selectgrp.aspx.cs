...
{
    public partial class u_cri_rdate_selectgrp : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String select_grp = dw_criteria.GetItemString(1, "select_grp");
            ...
            lnv_helper.AddArgument(select_grp, ArgumentType.String);
