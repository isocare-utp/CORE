...
{
    public partial class u_cri_coopid_year_rmembgroupcode_bycoopid : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                JsGetYear();
                dw_criteria.SetItemString(1, "ai_month", (DateTime.Now.Month).ToString("00"));
        ...
        {
            int account_year = 0,account_month = 0;
            try
            {
                ...
                if (dt.Next())
                {
                    ...
                    account_month = DateTime.Now.Month;
                    dw_criteria.SetItemString(1, "ai_year", account_year.ToString());
                    dw_criteria.SetItemString(1, "ai_month", account_month.ToString());
                }
                else
                {
                    sqlca.Rollback();
        ...
        private void RunProcess()
        {
            ...
            String year = dw_criteria.GetItemString(1, "ai_year") + dw_criteria.GetItemString(1, "ai_month");
