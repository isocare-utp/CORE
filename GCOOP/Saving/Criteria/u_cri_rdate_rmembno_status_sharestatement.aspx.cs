...
{
    public partial class u_cri_rdate_rmembno_status_sharestatement : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "username", state.SsUsername);
        ...
        private void RunProcess()
        {
            ...
            String set_sort = dw_criteria.GetItemString(1, "select_sort").Trim();
            Decimal select_status = dw_criteria.GetItemDecimal(1,"select_status");
            String username = dw_criteria.GetItemString(1, "username").Trim();
            String month = dw_criteria.GetItemString(1, "month").Trim();
            String year = dw_criteria.GetItemString(1, "year").Trim();
