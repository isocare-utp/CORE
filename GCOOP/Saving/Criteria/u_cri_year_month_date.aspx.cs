...
{
    public partial class u_cri_year_month_date : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal pay_type = dw_criteria.GetItemDecimal(1, "select_pay");
            
            Decimal select_pay_type = dw_criteria.GetItemDecimal(1, "select_pay_type");
            ...
            lnv_helper.AddArgument(pay_type.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(select_pay_type.ToString(), ArgumentType.Number);
