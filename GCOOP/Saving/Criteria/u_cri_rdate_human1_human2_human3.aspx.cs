...
{
    public partial class u_cri_rdate_human1_human2_human3 : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "human1", "criteria.pbl", null);
                DwUtil.RetrieveDDDW(dw_criteria, "human2", "criteria.pbl", null);
                DwUtil.RetrieveDDDW(dw_criteria, "human3", "criteria.pbl", null);
                dw_criteria.SetItemString(1, "human1", "นางสาววันทนา นันทศรี");
                dw_criteria.SetItemString(1, "human2", "นางสาวสุกัญญา วงศ์พรหม");
                dw_criteria.SetItemString(1, "human3", "นางสาวชลธิชา รอดภัย");
        ...
        private void RunProcess()
        {
            ...
            String human1 = dw_criteria.GetItemString(1, "human1");
            String human2 = dw_criteria.GetItemString(1, "human2");
            String human3 = dw_criteria.GetItemString(1, "human3");
            ...
            lnv_helper.AddArgument(human1, ArgumentType.String);
            lnv_helper.AddArgument(human2, ArgumentType.String);
            lnv_helper.AddArgument(human3, ArgumentType.String);
