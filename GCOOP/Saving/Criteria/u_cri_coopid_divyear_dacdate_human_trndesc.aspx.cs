...
{
    public partial class d_cri_coopid_divyear_dacdate_human_trndesc : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            decimal div_year = dw_criteria.GetItemDecimal(1, "div_year");
            ...
            lnv_helper.AddArgument(div_year.ToString(), ArgumentType.String);
        ...
        private void JsGetYear()
        {
            ...
            try
            {
                ...
                if (dt.Next())
                {
                    ...
                    dw_criteria.SetItemDecimal(1, "div_year", account_year);
                }
                else
                {
                    sqlca.Rollback();
