...
{
    public partial class u_cri_kp_rmembgroupcode : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String as_agent = dw_criteria.GetItemString(1, "as_agent");
            ...
            lnv_helper.AddArgument(as_agent, ArgumentType.String);
