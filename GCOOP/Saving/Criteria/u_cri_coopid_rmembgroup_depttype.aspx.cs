...
{
    public partial class u_cri_coopid_rmembgroup_depttype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                string[] minmaxd = ReportUtil.GetMinMaxDepttype();
                dw_criteria.SetItemString(1, "start_depttype", minmaxd[0]);
                dw_criteria.SetItemString(1, "end_depttype", minmaxd[1]);
            }
        ...
        private void RunProcess()
        {
            ...
            String select_coop = dw_criteria.GetItemString(1, "select_coop");
            ...
            lnv_helper.AddArgument(select_coop, ArgumentType.String);
