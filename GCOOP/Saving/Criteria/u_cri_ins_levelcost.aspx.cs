...
{
    public partial class u_cri_ins_levelcost : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "as_starttype","");
                dw_criteria.SetItemString(1, "as_endtype", "");
        ...
        private void RunProcess()
        {
            ...
            String reqstatus = dw_criteria.GetItemString(1, "as_starttype");
            String instype = dw_criteria.GetItemString(1, "as_endtype");
            String account_id = "";
            ...
            lnv_helper.AddArgument(reqstatus, ArgumentType.String);
