...
{
    public partial class u_cri_rmembno : PageWebSheet, WebSheet
    {
        ...
        {
            String S_memberno = dw_criteria.GetItemString(1, "start_membno");
            String E_memberno = dw_criteria.GetItemString(1, "end_membno");
            S_memberno = WebUtil.MemberNoFormat(S_memberno);
            E_memberno = WebUtil.MemberNoFormat(E_memberno);
            dw_criteria.SetItemString(1, "start_membno", S_memberno);
            dw_criteria.SetItemString(1, "end_membno", E_memberno);
        }
        //=======================
