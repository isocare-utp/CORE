...
{
    public partial class u_cri_rdate_rmembgroup_rloanobjective : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_objective", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "end_objective", "criteria.pbl", null);
            if (IsPostBack)
            {
            ...
            else
            {
                ...
                string[] minmax1 = ReportUtil.GetMinMaxMembloanobjective();
                dw_criteria.SetItemString(1, "start_objective", minmax1[0]);
                dw_criteria.SetItemString(1, "end_objective", minmax1[1]);
        ...
        private void RunProcess()
        {
            ...
            String start_objective = dw_criteria.GetItemString(1, "start_objective");
            String end_objective = dw_criteria.GetItemString(1, "end_objective");
