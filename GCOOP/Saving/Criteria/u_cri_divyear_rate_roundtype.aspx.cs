...
{
    public partial class u_cri_divyear_rate_roundtype : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            try 
            {
                ...
                if (dt.Next())
                {
                    satang_type = dt.GetString("satang_type").Trim();
            ...
            ////string start_year = start_tdate.Substring(4, 4);
            ////int li_startyear = int.Parse(start_year) - 543;
            ////start_tdate = start_tdate.Substring(0, 2) + "/" + start_tdate.Substring(2, 2) + "/" + li_startyear.ToString();

            ////string end_tdate = dw_criteria.GetItemString(1, "end_tdate");
            ////string end_year = end_tdate.Substring(4, 4);
            ////int li_endyear = int.Parse(end_year) - 543;
            ////end_tdate = end_tdate.Substring(0, 2) + "/" + end_tdate.Substring(2, 2) + "/" + li_endyear.ToString();
            ...
            //start_tdate = start_date.Date + "/" + start_date.Month + "/" + start_date.Year;
            //end_tdate = end_date.Date + "/" + end_date.Month + "/" + end_date.Year;
