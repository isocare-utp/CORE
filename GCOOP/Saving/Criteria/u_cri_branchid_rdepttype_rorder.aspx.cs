...
{
    public partial class u_cri_branchid_rdepttype_rorder : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "begin_money", 1);
                dw_criteria.SetItemDecimal(1, "step_money", 1);
        ...
        private void RunProcess()
        {
            ...
            decimal begin_money = dw_criteria.GetItemDecimal(1, "begin_money");
            decimal step_money = dw_criteria.GetItemDecimal(1, "step_money");
