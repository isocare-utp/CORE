...
{
    public partial class u_cri_acc_report_shrlon_balance : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            int year2 = Convert.ToInt32(year) + 543;
            String recv_period = Convert.ToString(year2) + month;
            String begin_recv_period = "";
            if (month == "01")
            {
                String last_month = "12";
                int last_year = Convert.ToInt32(year) + 543 - 1;
                begin_recv_period = Convert.ToString(last_year) + last_month;
            }
            else
            {
                int last_month = Convert.ToInt32(month) - 1;
                int last_year = Convert.ToInt32(year) + 543;
                begin_recv_period = Convert.ToString(last_year) + Convert.ToString(last_month);
            }
            ...
            lnv_helper.AddArgument(begin_recv_period, ArgumentType.String);
            //----------------------------------------------------
