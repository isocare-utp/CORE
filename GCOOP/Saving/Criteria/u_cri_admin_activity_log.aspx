<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_admin_activity_log.aspx.cs" Inherits="Saving.Criteria.u_cri_admin_activity_log" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    <asp:Literal ID="LtServerMessage" runat="server"></asp:Literal>
                ...
                <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="ad_report_log"
