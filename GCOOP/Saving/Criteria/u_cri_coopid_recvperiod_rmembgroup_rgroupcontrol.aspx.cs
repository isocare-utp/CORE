...
{
    public partial class u_cri_coopid_recvperiod_rmembgroup_rgroupcontrol : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String year = dw_criteria.GetItemString(1, "ai_year").Trim()+dw_criteria.GetItemString(1,"as_month");
