...
{
    public partial class u_cri_div_coopid_year_rmemno_rdate_rate : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_memno", minmax[0]);
                dw_criteria.SetItemString(1, "end_memno", minmax[1]);
                JsGetYear();
                JspostSetAccDate();                
            }
        ...
        private void RunProcess()
        {
            ...
            string start_memno = dw_criteria.GetItemString(1, "start_memno").Trim();
            string end_memno = dw_criteria.GetItemString(1, "end_memno").Trim();
            ...
            try
            {
                ...
                try
                {
                    printer = dw_criteria.GetItemString(1, "printer");
                }
                catch(Exception lex)
                {
                    printer = "PDF";
