...
{
    public partial class u_cri_coopid_year_rloantype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "slntype", "criteria.pbl", null);
                DwUtil.RetrieveDDDW(dw_criteria, "elntype", "criteria.pbl", null);
                ...
                dw_criteria.SetItemString(1, "slntype", minmax[0]);
                dw_criteria.SetItemString(1, "elntype", minmax[1]);
                JsGetYear();
        ...
        private void RunProcess()
        {
            ...
            String sloantype = dw_criteria.GetItemString(1, "slntype");
            String eloantype = dw_criteria.GetItemString(1, "elntype");
            div_year = (Convert.ToDecimal(div_year) - 543).ToString();
            ...
            lnv_helper.AddArgument(sloantype, ArgumentType.String);
            lnv_helper.AddArgument(eloantype, ArgumentType.String);
