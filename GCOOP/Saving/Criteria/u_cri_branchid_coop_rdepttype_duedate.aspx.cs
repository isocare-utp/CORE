...
{
    public partial class u_cri_branchid_coop_rdepttype_duedate : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            tdw_criteria.Add("select_duedate", "select_duetdate");
        }
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDateTime(1, "select_duedate", DateTime.Today);
                ...
                dw_criteria.SetItemString(1, "select_duetdate"," ");
        ...
        private void RunProcess()
        {
            ...
            DateTime select_duedate = dw_criteria.GetItemDateTime(1, "select_duedate");
            ...
            String select_duetdate = WebUtil.ConvertDateThaiToEng(dw_criteria, "select_duetdate", null);
            String coop_name = state.SsCoopName;
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();

            //lnv_helper.AddArgument(select_duetdate, ArgumentType.DateTime);
            ...
            //lnv_helper.AddArgument(select_duetdate, ArgumentType.String);
