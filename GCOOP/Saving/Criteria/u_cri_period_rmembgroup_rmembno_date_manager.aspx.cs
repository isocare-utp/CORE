...
{
    public partial class u_cri_period_rmembgroup_rmembno_date_manager : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            tdw_criteria.Add("adtm_date", "adtm_tdate");
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "select_year", (state.SsWorkDate.Year + 543));
                dw_criteria.SetItemDecimal(1, "select_month", state.SsWorkDate.Month);
                ...
                string[] minmax2 = ReportUtil.GetMinMaxMembno();
                dw_criteria.SetItemString(1, "start_membno", minmax2[0]);
                dw_criteria.SetItemString(1, "end_membno", minmax2[1]);
                dw_criteria.SetItemDateTime(1, "adtm_date", state.SsWorkDate);
        ...
        private void RunProcess()
        {
            ...
            Decimal select_month = dw_criteria.GetItemDecimal(1, "select_month");
            ...
            String adtm_date = WebUtil.ConvertDateThaiToEng(dw_criteria, "adtm_tdate", null);
            String as_manager = dw_criteria.GetItemString(1, "as_manager");
            String period = select_year.ToString() + select_month.ToString("00");
            ...
            lnv_helper.AddArgument(adtm_date, ArgumentType.DateTime);
            lnv_helper.AddArgument(as_manager, ArgumentType.String);
            //----------------------------------------------------------------
