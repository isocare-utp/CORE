...
{
    public partial class u_cri_date_rmembno_coopid_number_date_returndate : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            tdw_criteria.Add("return_date", "return_tdate");
        }
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDateTime(1, "return_date", state.SsWorkDate);
                ...
                dw_criteria.SetItemString(1, "number", "");
                ...
                dw_criteria.SetItemString(1, "president", manager);
                dw_criteria.SetItemString(1, "namecheck", auditor);
        ...
        private void RunProcess()
        {
            ...
            String number_no = dw_criteria.GetItemString(1, "number").Trim();
            ...
            String return_date = WebUtil.ConvertDateThaiToEng(dw_criteria, "return_tdate", null);
            ...
            lnv_helper.AddArgument(number_no, ArgumentType.String);
            ...
            lnv_helper.AddArgument(return_date, ArgumentType.DateTime);
