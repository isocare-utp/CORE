...
{
    public partial class u_cri_loantype_rage_mis : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
             ...
             //   dw_criteria.SetItemString(1, "end_tdate", "");
               DwUtil.RetrieveDDDW(dw_criteria, "select_loantype", "criteria.pbl", null);
        ...
        private void RunProcess()
        {
            ...
            //String select_loantype = dw_criteria.GetItemString(1, "select_loantype");

            String select_report_type = dw_criteria.GetItemString(1, "ai_age");

            String report_id = rid;
          ...
          //  String end_date = WebUtil.ConvertDateThaiToEng(dw_criteria, "end_tdate", null);
            //decimal ai_age = dw_criteria.GetItemDecimal(1, "ai_age");
           // decimal ai_agemem = dw_criteria.GetItemDecimal(1, "ai_agemem");
           // ai_age = ai_age*12;
           
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            //lnv_helper.AddArgument(select_loantype, ArgumentType.String);
           // lnv_helper.AddArgument(ai_age.ToString(), ArgumentType.Number);
           // lnv_helper.AddArgument(ai_agemem.ToString(), ArgumentType.Number);
