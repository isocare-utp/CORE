<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rmembno_rmembgroup_rmembsubgroup.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rmembno_rmembgroup_rmembsubgroup" Title="Report Criteria" %>
		...
		<script type="text/javascript">
		      ...
		      function OnDwCriteriaItemsChange(sender, rowNumber, columnName, newValue)
		    {
		     if(columnName == "as_startgroup")
		     {
		      ...
		      Gcoop.GetEl("HdStGroup").value = newValue;
                 checkFlag();
                  
		     }
		     if(columnName == "as_endgroup")
		     {
		     
		      Gcoop.GetEl("HdEnGroup").value = newValue;
                 checkFlag1();
		     }
		      if(columnName == "as_startsubgrp")
		     {
		     
		      Gcoop.GetEl("HdStsubGroup").value = newValue;
                 checkFlag2();
                  
		     }
		     if(columnName == "as_endsubgrp")
		     {
		     
		      Gcoop.GetEl("HdEnsubGroup").value = newValue;
                 checkFlag3();
		     }
		    }
		</script>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_rmembno_rmembgroup_rmembsubgroup"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" 
                    AutoSaveDataCacheAfterRetrieve="True" ClientEventItemChanged="OnDwCriteriaItemsChange">
