...
{
    public partial class u_cri_rdate_capital_buget : PageWebSheet, WebSheet
    {
        ...
        {
            //InitJsPostBack();
            DwUtil.RetrieveDDDW(dw_criteria, "buget", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "capital", "criteria.pbl", null);
            if (IsPostBack)
            {
        ...
        private void RunProcess()
        {
            ...
            String buget = dw_criteria.GetItemString(1, "buget");
            String capital = dw_criteria.GetItemString(1, "capital");
            ...
            lnv_helper.AddArgument(capital, ArgumentType.String);
            lnv_helper.AddArgument(buget, ArgumentType.String);
