<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_project.aspx.cs"
    Inherits="Saving.Criteria.u_cri_project" Title="Report Criteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function dw_criteriaItemChange(sender, rowNumber, columnName, newValue) {
            objdw_criteria.SetItem(rowNumber, columnName, newValue);
            objdw_criteria.AcceptText();
            if (columnName == "project_year") {
                postFilterProjectId();
            }
        }
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_project"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True" ClientEventItemChanged="dw_criteriaItemChange">
