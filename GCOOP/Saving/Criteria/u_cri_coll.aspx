<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coll.aspx.cs" Inherits="Saving.Criteria.u_cri_coll" %>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_date"
            ...
            <td align="center">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td>
                            &nbsp;
                            <asp:TextBox ID="txtmemgroup" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;
                        </td>
