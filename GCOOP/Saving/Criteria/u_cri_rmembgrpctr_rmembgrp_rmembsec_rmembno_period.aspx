<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rmembgrpctr_rmembgrp_rmembsec_rmembno_period.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rmembgrpctr_rmembgrp_rmembsec_rmembno_period"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDwCriteriaItemsChange(sender, rowNumber, columnName, newValue) {
            ...
            if (columnName == "start_membctr" || columnName == "end_membctr") {
                objdw_criteria.SetItem(rowNumber, columnName, newValue);
                objdw_criteria.AcceptText();
                jsRetreivemidgroup();
            }
            if (columnName == "start_membgrp" || columnName == "end_membgrp") {
                objdw_criteria.SetItem(rowNumber, columnName, newValue);
                objdw_criteria.AcceptText();
                jsRetreivemidgroup2();
            }
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_rmembgrpctr_rmembgrp_rmembsec_rmembno_period"
