...
{
    public partial class u_cri_branchid_month_accyear : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
               ...
               // dw_criteria.SetItemString(1, "select_accyear", "");
        ...
        private void RunProcess()
        {
            ...
            String select_accyear = dw_criteria.GetItemString(1, "select_accyear");
            String select_month = dw_criteria.GetItemString(1, "select_month");
            String coop_name = state.SsCoopName;
            String yearmonth = select_accyear + select_month;
            ...
            lnv_helper.AddArgument(select_accyear, ArgumentType.String);
            //lnv_helper.AddArgument(yearmonth, ArgumentType.String);
