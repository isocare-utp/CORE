...
{
    public partial class u_cri_month_year_rmembgrp_agent : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "enf_membgroup_1", "criteria.pbl", state.SsCoopControl);
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_membgroup", minmax[1]);
                dw_criteria.SetItemString(1, "month", state.SsWorkDate.Month.ToString("00"));
                dw_criteria.SetItemDecimal(1, "ai_year", 2557);
        ...
        private void RunProcess()
        {
            ...
            string as_period = dw_criteria.GetItemDecimal(1, "ai_year") + dw_criteria.GetItemString(1, "month");
            string agent = dw_criteria.GetItemString(1, "agent");

            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            //lnv_helper.AddArgument(coop_id, ArgumentType.String);
            //lnv_helper.AddArgument(start_date, ArgumentType.DateTime);
            lnv_helper.AddArgument(as_period.ToString(), ArgumentType.String);
            lnv_helper.AddArgument(start_membgroup, ArgumentType.String);
            lnv_helper.AddArgument(end_membgroup, ArgumentType.String);
            lnv_helper.AddArgument(agent, ArgumentType.String);
