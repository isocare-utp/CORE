<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_acc_finance_report.aspx.cs" Inherits="Saving.Criteria.u_cri_acc_finance_report" %>
...
<%=runProcess%>
		...
		<script type="text/javascript">
		    ...
		    function OndwcriteriaItemChanged(s, r, c, v) {
		        if (c == "acc_id_1") {
		            objdw_criteria.SetItem(r, "acc_id", v);
		            objdw_criteria.AcceptText();
		            return 0;
		        }
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_coopid_all_date_payrec_acc"
