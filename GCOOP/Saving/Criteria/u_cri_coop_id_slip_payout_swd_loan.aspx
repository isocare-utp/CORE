<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coop_id_slip_payout_swd_loan.aspx.cs"
    Inherits="Saving.Criteria.u_cri_coop_id_slip_payout_swd_loan" Title="Report Criteria" %>
        ...
        <tr>
            <td align="center" class="style1">
                ...
                <dw:WebDataWindowControl ID="dw_nec" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_coopid_payout_swd"
