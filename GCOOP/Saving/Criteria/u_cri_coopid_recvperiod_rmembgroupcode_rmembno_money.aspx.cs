...
{
    public partial class u_cri_coopid_recvperiod_rmembgroupcode_rmembno_money : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String start_memno = dw_criteria.GetItemString(1, "start_membno");
            String end_memno = dw_criteria.GetItemString(1, "end_membno");
            String as_year = dw_criteria.GetItemString(1, "as_year");
            String as_month = dw_criteria.GetItemString(1, "as_month");
            String money_amt = Convert.ToString( dw_criteria.GetItemDouble(1, "money_amt"));
            //decimal money_amt = Convert.ToDecimal(dw_criteria.GetItemDouble(1, "money_amt"));
            ...
            lnv_helper.AddArgument(money_amt, ArgumentType.String);
