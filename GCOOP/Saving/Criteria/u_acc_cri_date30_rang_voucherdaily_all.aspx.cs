...
{
    public partial class u_acc_cri_date30_rang_voucherdaily_all : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String rep_type = dw_criteria.GetItemString(1, "rep_type");
            String entry_id = "";
            try
            {
                 entry_id = dw_criteria.GetItemString(1, "entry_id");
            }
            catch
            {
                entry_id = "";
            ...
            if (rep_type == "1" && entry_id == "")
            {
                rid = "[VCH0022]";
            }
            else if (rep_type == "1" && entry_id != "")
            {
                rid = "[VCH0020]";
            }
            else if (rep_type == "2" && entry_id == "")
            {
                rid = "[VCH0023]";
            }
            else if (rep_type == "2" && entry_id != "")
