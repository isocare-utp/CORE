...
{
    public partial class u_cri_rdate_bank_shl_branch : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "as_branch", "");
        ...
        private void RunProcess()
        {
            ...
            String as_branch = dw_criteria.GetItemString(1, "as_branch");
            ...
            lnv_helper.AddArgument(as_branch, ArgumentType.String);
