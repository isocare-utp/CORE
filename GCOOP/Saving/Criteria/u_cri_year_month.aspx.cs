...
{
    public partial class u_cri_year_month : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal soci_rate = dw_criteria.GetItemDecimal(1, "soci_rate");
            ...
            lnv_helper.AddArgument(soci_rate.ToString(), ArgumentType.Number);
