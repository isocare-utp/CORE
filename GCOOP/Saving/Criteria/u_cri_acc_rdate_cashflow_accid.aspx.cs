...
{
    public partial class u_cri_acc_rdate_cashflow_accid : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String account_id = dw_criteria.GetItemString(1, "start_accid");
            ...
            Int32 CashBeginForward = wcf.NAccount.of_get_bg_fw(wsPass, date, state.SsCoopId,account_id, ref Begin, ref Forward);
