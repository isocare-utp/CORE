...
{
    public partial class u_cri_year_pay_oper : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "select_paytype", "criteria.pbl", null);
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "select_year", year.ToString());
        ...
        private void RunProcess()
        {
            ...
            String select_paytype = null;
            String select_year = dw_criteria.GetItemString(1, "select_year");
            try 
            {
                select_paytype = dw_criteria.GetItemString(1, "select_paytype");
            }
            catch { select_paytype = "%"; }
            ...
            lnv_helper.AddArgument(select_paytype, ArgumentType.String);
