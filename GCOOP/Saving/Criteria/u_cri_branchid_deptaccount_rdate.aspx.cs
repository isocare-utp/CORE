...
{
    public partial class u_cri_branchid_deptaccount_rdate : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String dept_acc = dw_criteria.GetItemString(1, "dept_acc");
            ...
            lnv_helper.AddArgument(dept_acc, ArgumentType.String);
