...
{
    public partial class u_cri_kp_rmonth_year_membno_user : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "name", "นางกรรณิการ์");
                dw_criteria.SetItemString(1, "surename", "สงเคราะห์ผล");
                dw_criteria.SetItemString(1, "position", "หัวหน้าฝ่ายบัญชีทำการแทนผู้จัดการ");
        ...
        private void RunProcess()
        {
            ...
            String surename = dw_criteria.GetItemString(1, "surename");
            ...
            lnv_helper.AddArgument(surename, ArgumentType.String);
