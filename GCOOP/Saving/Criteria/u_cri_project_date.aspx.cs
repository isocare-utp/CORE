...
{
    public partial class u_cri_project_date : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            tdw_criteria.Add("exp_date", "exp_tdate");
        }
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDateTime(1, "exp_date", state.SsWorkDate);
        ...
        private void RunProcess()
        {
            ...
            String exp_date = WebUtil.ConvertDateThaiToEng(dw_criteria, "exp_tdate", null);
            ...
            lnv_helper.AddArgument(exp_date, ArgumentType.DateTime);
