...
{
    public partial class u_cri_coopid_date_preparetype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "preparetype", "DIV");
        ...
        private void RunProcess()
        {
            ...
            String preparetype = dw_criteria.GetItemString(1, "preparetype").Trim();
            ...
            lnv_helper.AddArgument(preparetype, ArgumentType.String);
