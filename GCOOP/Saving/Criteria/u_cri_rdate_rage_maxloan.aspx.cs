...
{
    public partial class u_cri_rdate_rage_maxloan : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal s_maxloan = dw_criteria.GetItemDecimal(1, "s_maxloan");
            ...
            lnv_helper.AddArgument(s_maxloan.ToString(), ArgumentType.Number);
