...
{
    public partial class u_cri_branchid_coop_rdepttype_rdate_rfeetype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
               ...
               // dw_criteria.SetItemString(1, "start_feetype", "");
                //dw_criteria.SetItemString(1, "end_feetype", "");
        ...
        private void RunProcess()
        {
            ...
            Decimal start_feetype = dw_criteria.GetItemDecimal(1, "start_feetype");
            Decimal end_feetype = dw_criteria.GetItemDecimal(1, "end_feetype");
            ...
            lnv_helper.AddArgument(start_feetype.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(end_feetype.ToString(), ArgumentType.Number);
