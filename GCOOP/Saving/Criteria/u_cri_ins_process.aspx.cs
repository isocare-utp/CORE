...
{
    public partial class u_cri_ins_process : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "select_year","2554");
        ...
        private void RunProcess()
        {
            ...
            String select_year_i = dw_criteria.GetItemString(1, "select_year");
            Int32 int_select_year = Convert.ToInt32(select_year_i);
            int_select_year = int_select_year - 543;

            String select_year = Convert.ToString(int_select_year);
