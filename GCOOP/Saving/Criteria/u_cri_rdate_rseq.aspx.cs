...
{
    public partial class u_cri_rdate_rseq : PageWebSheet, WebSheet
    {
        ...
        {
            //InitJsPostBack();
            DwUtil.RetrieveDDDW(dw_criteria, "start_seq", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "end_seq", "criteria.pbl", null);
            if (IsPostBack)
            {
        ...
        private void RunProcess()
        {
            ...
            String start_seq = dw_criteria.GetItemString(1, "start_seq");
            String end_seq = dw_criteria.GetItemString(1, "end_seq");
            ...
            lnv_helper.AddArgument(start_seq, ArgumentType.String);
            lnv_helper.AddArgument(end_seq, ArgumentType.String);
