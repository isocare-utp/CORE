...
{
    public partial class u_cri_rdate_rperiod : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "recv_year", " ");
                dw_criteria.SetItemString(1, "recv_month", "1");
        ...
        private void RunProcess()
        {
            ...
            String recv_year = dw_criteria.GetItemString(1, "recv_year");
            String recv_month = dw_criteria.GetItemString(1, "recv_month");
            ...
            //.AddArgument(endDate.ToString("yyyy-MM-dd", WebUtil.EN), ArgumentType.DateTime);
            //lnv_helper.AddArgument(start_tdate, ArgumentType.String);
            //lnv_helper.AddArgument(end_tdate, ArgumentType.String);
            //lnv_helper.AddArgument(start_period, ArgumentType.String);
            //lnv_helper.AddArgument(end_period, ArgumentType.String);
            lnv_helper.AddArgument(start_date, ArgumentType.DateTime);
            lnv_helper.AddArgument(end_date, ArgumentType.DateTime);
            lnv_helper.AddArgument(revperiod, ArgumentType.String);
