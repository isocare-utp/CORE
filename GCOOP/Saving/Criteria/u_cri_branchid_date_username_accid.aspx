<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_branchid_date_username_accid.aspx.cs"
    Inherits="Saving.Criteria.u_cri_branchid_date_username_accid" Title="Report Criteria" %>
...
<%=runProcess%>
    ...
    function OnButtonClicked(sender, rowNumber, buttonName)
   {
    ...
    {
        Gcoop.OpenIFrame('570','300','w_dlg_fin_showuser.aspx','');
    }
    }
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_branchid_date_username_accid_rec_pay"
