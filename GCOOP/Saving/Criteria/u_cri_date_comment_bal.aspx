<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_date_comment_bal.aspx.cs"
    Inherits="Saving.Criteria.u_cri_date_comment_bal" Title="Report Criteria" %>
    ...
    <script type="text/javascript">
        ...
        function DwMainButtonClick(sender, rowNumber, buttonName) {
            if (buttonName == "b_search") {
                Gcoop.OpenDlg('650', '650', 'w_dlg_dp_account_search_report.aspx', '');
            }
        }
        function GetValueFromDlg(loancontract_no) {
            objdw_criteria.SetItem(1, "select_contract", loancontract_no);
            objdw_criteria.AcceptText();
        }
    </script>
</asp:Content>
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_dp_comment_bal_con"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True" ClientEventButtonClicked="DwMainButtonClick">
