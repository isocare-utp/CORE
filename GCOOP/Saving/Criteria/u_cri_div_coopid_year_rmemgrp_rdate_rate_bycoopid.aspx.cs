...
{
    public partial class u_cri_div_coopid_year_rmemgrp_rdate_rate_bycoopid : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "coop_id2", "criteria.pbl", state.SsCoopControl);
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "coop_id2", state.SsCoopId);
                JsGetYear();
                JspostSetAccDate();
            }
        ...
        private void RunProcess()
        {
            ...
            string coop_id2 = dw_criteria.GetItemString(1, "coop_id2");
