...
{
    public partial class u_cri_coopid_raccno : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String start_accno = dw_criteria.GetItemString(1, "start_accno");
            String end_accno = dw_criteria.GetItemString(1, "end_accno");
           
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            lnv_helper.AddArgument(start_accno, ArgumentType.String);
            lnv_helper.AddArgument(end_accno, ArgumentType.String);
