...
{
    public partial class u_cri_rdate_rloantype_rcontno_userid_contstatus_tks : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            if (start_loantype == "" && end_loantype == "")
            {
            ...
            if (start_contno == "" || start_contno == null) { start_contno = "0000000000"; } else { start_contno = dw_criteria.GetItemString(1, "start_contno"); }
            if (end_contno == "" || end_contno == null) { end_contno = "ฮฮฮฮฮฮฮฮฮฮ"; } else { end_contno = dw_criteria.GetItemString(1, "end_contno"); }
