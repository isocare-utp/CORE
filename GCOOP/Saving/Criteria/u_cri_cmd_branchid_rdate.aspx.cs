...
{
    public partial class u_cri_cmd_branchid_rdate : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "branch_code", "criteria.pbl", null);
        ...
        private void RunProcess()
        {
            ...
            String branch_code = dw_criteria.GetItemString(1, "branch_code").Trim();
            ...
            lnv_helper.AddArgument(branch_code, ArgumentType.String);
