...
{
    public partial class u_cri_rdate_loantype_contcode : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "loancontract_no","");
        ...
        private void RunProcess() 
        {
            ...
            lnv_helper.AddArgument(loancontract_no, ArgumentType.String);
