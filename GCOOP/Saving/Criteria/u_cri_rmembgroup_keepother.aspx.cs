...
{
    public partial class u_cri_rmembgroup_keepother : PageWebSheet, WebSheet
    {
        ...
        protected String postKeepothertype;
        ...
        public void InitJsPostBack()
        {
            ...
            postKeepothertype = WebUtil.JsPostBack(this, "postKeepothertype");
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "keepothertype", "criteria.pbl", null);
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == "postKeepothertype")
            {
                DwUtil.RetrieveDDDW(dw_criteria, "keepothertype_1", "criteria.pbl", null);
            }
        ...
        private void RunProcess()
        {
            ...
            String keepothertype = null;
            Decimal choose_flag = dw_criteria.GetItemDecimal(1, "choose_flag");
            if (choose_flag == 1)
            {
                keepothertype = dw_criteria.GetItemString(1, "keepothertype");
            }
            else
            {
                keepothertype = "%";
            ...
            lnv_helper.AddArgument(keepothertype, ArgumentType.String);
