...
{
    public partial class u_sl_daily_principal_balance : PageWebSheet, WebSheet
    {
        ...
        {
            InitJsPostBack();
            dw_criteria.Modify("start_tdate.protect = 1");
            ...
            else
            {
                ...
                dw_criteria.SetItemDateTime(1, "start_date", DateTime.Today);
