...
{
    public partial class u_cri_rdate_statem : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "as_contract_no", "");
        ...
        private void RunProcess()
        {
            ...
            String as_contract_no = dw_criteria.GetItemString(1, "as_contract_no");
            ...
            lnv_helper.AddArgument(as_contract_no, ArgumentType.String);
