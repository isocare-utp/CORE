<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_criteria_all.aspx.cs"
    Inherits="Saving.Criteria.u_cri_criteria_all" Title="Report Criteria" %>
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_membno"
                ...
                <dw:WebDataWindowControl ID="dw_preview" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="r_preview"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True">
                </dw:WebDataWindowControl>
            </td>
        </tr>
            ...
            <td align="center">
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                                <span style="cursor: pointer" onclick="OnClickLinkExcel();">สร้าง text file</span>
                            </center>
                            &nbsp;
                        </td>
                        <td align="left" style="width: 100px;">
