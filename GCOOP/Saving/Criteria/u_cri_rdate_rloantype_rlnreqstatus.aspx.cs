...
{
    public partial class u_cri_rdate_rloantype_rlnreqstatus : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "s_lnreqstatus",99);
        ...
        private void RunProcess() 
        {
            ...
            Decimal s_lnreqstatus = dw_criteria.GetItemDecimal(1, "s_lnreqstatus");
            Decimal e_lnreqstatus = s_lnreqstatus;
            if (s_lnreqstatus == 99)
            {
                s_lnreqstatus = -1;
                e_lnreqstatus = 81;
            ...
            lnv_helper.AddArgument(s_lnreqstatus.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(e_lnreqstatus.ToString(), ArgumentType.Number);
