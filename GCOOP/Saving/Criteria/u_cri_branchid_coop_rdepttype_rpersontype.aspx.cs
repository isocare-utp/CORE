...
{
    public partial class u_cri_branchid_coop_rdepttype_rpersontype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_persontype", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "end_persontype", "criteria.pbl", null);
            ...
            else
            {
                ...
                //dw_criteria.SetItemString(1, "start_persontype", "");
                //dw_criteria.SetItemString(1, "end_persontype", "");
        ...
        private void RunProcess()
        {
            ...
            String start_persontype = dw_criteria.GetItemString(1, "start_persontype");
            String end_persontype = dw_criteria.GetItemString(1, "end_persontype");
            ...
            lnv_helper.AddArgument(start_persontype, ArgumentType.String);
            lnv_helper.AddArgument(end_persontype, ArgumentType.String);
