...
{
    public partial class u_cri_coopid_recvperiod_rmembgroupcode_rmembno : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_membtype_1", "criteria.pbl", "");
            DwUtil.RetrieveDDDW(dw_criteria, "end_membtype_1", "criteria.pbl", "");
            ...
            else
            {
                ...
                string[] minmaxmembtype = ReportUtil.GetMinMaxMembType();//.GetMinMaxMembgroupCoopid(state.SsCoopControl);
                dw_criteria.SetItemString(1, "start_membtype", minmaxmembtype[0]);
                dw_criteria.SetItemString(1, "end_membtype", minmaxmembtype[1]);
