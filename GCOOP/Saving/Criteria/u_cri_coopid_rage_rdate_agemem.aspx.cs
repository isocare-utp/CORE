...
{
    public partial class u_cri_coopid_rage_rdate_agemem : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            decimal ai_age1 = dw_criteria.GetItemDecimal(1, "ai_age1");
            decimal ai_age2 = dw_criteria.GetItemDecimal(1, "ai_age2");
            decimal ai_agemem = dw_criteria.GetItemDecimal(1, "ai_agemem");
            ai_agemem = ai_agemem * 12;
            ai_age1 = ai_age1 * 12;
            ai_age2 = ai_age2 * 12;
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            lnv_helper.AddArgument(coop_id, ArgumentType.String);
            lnv_helper.AddArgument(ai_age1.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(ai_age2.ToString(), ArgumentType.Number);
