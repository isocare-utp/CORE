...
{
    public partial class u_cri_branchid_coop_rdepttype_principal_days_date : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "day", 0);
        ...
        private void RunProcess()
        {
            ...
            decimal day = dw_criteria.GetItemDecimal(1, "day");
            ...
            lnv_helper.AddArgument(day.ToString(), ArgumentType.Number);
