...
{
    public partial class u_cri_rdate_moneytype_all_sl : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "as_slipstart", "");
                dw_criteria.SetItemString(1, "as_slipend", "");
     ...
     public void CheckJsPostBack(string eventArg)
        ...
        private void CheckFlag()
        {
            ...
            //    dw_criteria.SetItemString(1, "as_moneytype", null);
            //}
        }
        #endregion
        ...
        private void RunProcess()
        {
            ...
            String as_slipstart = dw_criteria.GetItemString(1, "as_slipstart");
            String as_slipend = dw_criteria.GetItemString(1, "as_slipend");
            ...
            lnv_helper.AddArgument(as_slipstart, ArgumentType.String);
            lnv_helper.AddArgument(as_slipend, ArgumentType.String);
