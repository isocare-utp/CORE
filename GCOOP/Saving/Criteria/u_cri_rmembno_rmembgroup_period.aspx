<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rmembno_rmembgroup_period.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rmembno_rmembgroup_period" Title="Report Criteria" %>
...
<%=runProcess%>
		...
		<script type="text/javascript">
		    ...
		    function OnDwItemChanged( sender, row, column, value){
		        if( column == "as_startgroup" || column == "as_endgroup")
		        {
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_rmembno_rmembgroup_period"
