...
{
    public partial class u_cri_ins_rdate_statustype : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal apptype = dw_criteria.GetItemDecimal(1, "as_strapp");
            String startapp;
            String endapp;
            startapp = (apptype == 0) ? "01" : "03";
            endapp = (apptype == 1) ? "04" : "02";
