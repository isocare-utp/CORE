...
{
    public partial class u_cri_coopid_rdate_rloangroup_rmembgroup_rmembno : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_membno", minmaxmembno[0]);
                dw_criteria.SetItemString(1, "end_membno", minmaxmembno[1]);
        ...
        private void RunProcess()
        {
            ...
            String start_loangroup = dw_criteria.GetItemString(1, "start_loangroup");
            String end_loangroup = dw_criteria.GetItemString(1, "end_loangroup");
            ...
            lnv_helper.AddArgument(start_loangroup, ArgumentType.String);
            lnv_helper.AddArgument(end_loangroup, ArgumentType.String);
