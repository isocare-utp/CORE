<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_year_scgolar_level_date_coop_all.aspx.cs" Inherits="Saving.Criteria.u_cri_year_scgolar_level_date_coop_all" %>
<%@ Register Assembly="WebDataWindow" Namespace="Sybase.DataWindow.Web" TagPrefix="dw" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%=runProcess%>
    <%=popupReport%>
    <%=postFilterScholarshipS%>
     <%= postFilterScholarshipE%>
    ...
    <script type="text/javascript">
        ...
        function DwSchoolItemChange(sender, rowNumber, columnName, newValue) {
            ...
            if (columnName == "sschooldet_level") {
                objdw_criteria.SetItem(rowNumber, columnName, newValue);
                objdw_criteria.AcceptText();
                postFilterScholarshipS();
            }
            else if (columnName == "eschooldet_level") {
                objdw_criteria.SetItem(rowNumber, columnName, newValue);
                objdw_criteria.AcceptText();
                postFilterScholarshipE();
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_as_branchid_date_scholar_schooldet_schoollevel_all"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True"
                    ClientEventItemChanged="DwSchoolItemChange">
