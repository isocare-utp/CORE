...
{
    public partial class u_cri_acc_period_cashflow : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String recv_period = dw_criteria.GetItemString(1, "month");
            ...
            lnv_helper.AddArgument(recv_period, ArgumentType.Number);
