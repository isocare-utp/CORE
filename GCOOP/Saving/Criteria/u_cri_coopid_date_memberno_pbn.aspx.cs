...
{
    public partial class u_cri_coopid_date_memberno_pbn : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "signature", "นายนเรศ  น้อยเอี่ยม");
        ...
        private void RunProcess()
        {
            ...
            String member_no = dw_criteria.GetItemString(1, "member_no");
            ...
            String document_no = dw_criteria.GetItemString(1, "document_no").Trim();
            String signature = dw_criteria.GetItemString(1, "signature").Trim();
            ...
            lnv_helper.AddArgument(signature, ArgumentType.String);
