<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rdate_rloantype_rcontno_userid_contstatus.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rdate_rloantype_rcontno_userid_contstatus" Title="Report Criteria" %>
...
<%=runProcess%>
    ...
    Gcoop.CheckDw(sender, rowNumber, objectName, "fixreqsts_flag", 1, 0);
    if(objectName == "fixentry_flag" || objectName == "fixreqsts_flag")
    {
        objdw_criteria.AcceptText();
        checkFlag();
    }
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_rdate_rloantype_rcontno_userid_contstatus"
