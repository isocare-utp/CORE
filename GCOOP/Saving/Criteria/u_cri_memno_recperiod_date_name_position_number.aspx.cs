...
{
    public partial class u_cri_memno_recperiod_date_name_position_number : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            tdw_criteria.Add("adtm_day", "adtm_tday");
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDateTime(1, "adtm_day", state.SsWorkDate);
        ...
        private void RunProcess()
        {
            ...
            String adtm_day = WebUtil.ConvertDateThaiToEng(dw_criteria, "adtm_tday", null);
            String as_memno = dw_criteria.GetItemString(1, "as_memno");
            ...
            String n_ber = dw_criteria.GetItemString(1, "as_number");
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            lnv_helper.AddArgument(as_memno, ArgumentType.String);
            lnv_helper.AddArgument(recv_period, ArgumentType.String);
            lnv_helper.AddArgument(adtm_day, ArgumentType.DateTime);
            lnv_helper.AddArgument(name, ArgumentType.String);
            lnv_helper.AddArgument(position, ArgumentType.String);
            lnv_helper.AddArgument(n_ber, ArgumentType.String);
