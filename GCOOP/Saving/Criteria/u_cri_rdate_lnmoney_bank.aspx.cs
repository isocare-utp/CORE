...
{
    public partial class u_cri_rdate_lnmoney_bank : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "fixed_flag4", 1);
     ...
     public void CheckJsPostBack(string eventArg)
        ...
        {
            //ให้หน้า page refresh
            Decimal fixed_flagchk4 = dw_criteria.GetItemDecimal(1, "fixed_flag4");
            if (fixed_flagchk4 == 0)
            {
        ...
        private void RunProcess()
        {
            ...
            Decimal fixed_flagtest4 = dw_criteria.GetItemDecimal(1, "fixed_flag4");
