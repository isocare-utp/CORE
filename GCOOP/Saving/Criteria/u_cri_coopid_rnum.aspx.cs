...
{
    public partial class u_cri_coopid_rnum : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String ai_num1 = dw_criteria.GetItemString(1, "ai_num1");
            String ai_num2 = dw_criteria.GetItemString(1, "ai_num2");
          
           
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            lnv_helper.AddArgument(coop_id, ArgumentType.String);
            lnv_helper.AddArgument(ai_num1, ArgumentType.String);
            lnv_helper.AddArgument(ai_num2, ArgumentType.String);
