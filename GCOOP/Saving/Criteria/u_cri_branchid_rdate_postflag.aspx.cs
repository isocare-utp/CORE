...
{
    public partial class u_cri_branchid_rdate_postflag : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                //dw_criteria.SetItemString(1, "coop_id", state.SsBranchId);
        ...
        private void RunProcess()
        {
            ...
            Decimal flag = dw_criteria.GetItemDecimal(1, "post_flag");
            ...
            lnv_helper.AddArgument(flag.ToString(), ArgumentType.Number);
            //----------------------------------------------------
