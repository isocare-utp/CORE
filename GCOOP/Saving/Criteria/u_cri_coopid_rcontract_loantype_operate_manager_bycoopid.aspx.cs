...
{
    public partial class u_cri_coopid_rcontract_loantype_operate_manager_bycoopid : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String operate = dw_criteria.GetItemString(1, "operate");
            ...
            lnv_helper.AddArgument(operate, ArgumentType.String);
