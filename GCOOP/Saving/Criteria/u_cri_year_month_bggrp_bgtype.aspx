<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_year_month_bggrp_bgtype.aspx.cs"
    Inherits="Saving.Criteria.u_cri_year_month_bggrp_bgtype" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
		    ...
		    function OnDwItemChenged(sender, rowNumber, columnName, newValue){
		        if(columnName == "select_year"){
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_year_month_bggrp_bgtype"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True" ClientEventItemChanged="OnDwItemChenged">
