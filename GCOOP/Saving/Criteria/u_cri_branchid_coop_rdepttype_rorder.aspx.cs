...
{
    public partial class u_cri_branchid_coop_rdepttype_rorder : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria1.SetItemDecimal(1, "begin_money", 1);
                dw_criteria1.SetItemDecimal(1, "step_money", 1);
        ...
        private void RunProcess()
        {
            ...
            decimal begin_money = dw_criteria1.GetItemDecimal(1, "begin_money");
            decimal step_money = dw_criteria1.GetItemDecimal(1, "step_money");
            ...
            lnv_helper.AddArgument(begin_money.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(step_money.ToString(), ArgumentType.Number);
