...
{
    public partial class u_cri_coopid_recvpe_datepay_rmbgrp_rmbtype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_date", "criteria.pbl", state.SsCoopControl);
        ...
        private void RunProcess()
        {
            ...
            String as_year = dw_criteria.GetItemString(1, "ai_year");
            String adtm_datepay = WebUtil.ConvertDateThaiToEng(dw_criteria, "start_tdate", null);
