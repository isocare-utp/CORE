...
{
    public partial class u_cri_coopid_date_rmembno_longrp : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String as_longrp = dw_criteria.GetItemString(1, "as_longrp");
            ...
            lnv_helper.AddArgument(as_longrp, ArgumentType.String);
