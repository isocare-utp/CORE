...
{
    public partial class u_cri_ins_instype_membgroup : PageWebSheet, WebSheet
    {
        ...
        {
            DwUtil.RetrieveDDDW(dw_criteria, "as_starttype", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "as_endtype", "criteria.pbl", null);
        ...
        private void RunProcess()
        {
            ...
            String startgroup = dw_criteria.GetItemString(1, "as_startgroup");
            String endgroup = dw_criteria.GetItemString(1, "as_endgroup");
            ...
            lnv_helper.AddArgument(startgroup, ArgumentType.String);
            lnv_helper.AddArgument(endgroup, ArgumentType.String);
