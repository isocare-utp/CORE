<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_date_rmembno_excel.aspx.cs"
    Inherits="Saving.Criteria.u_cri_date_rmembno_excel" Title="Report Criteria" %>
        ...
        <tr>
            <td align="center">
                <table style="width: 100%;">
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_date_rmembno_excel"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" 
                    AutoSaveDataCacheAfterRetrieve="True" ClientEventItemChanged="OnItemChange"></dw:WebDataWindowControl>
                        </td>
                        <td>
                            &nbsp;
                        </td>
