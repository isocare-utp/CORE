<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rdate_rdate_loantype_lnreqstatus_entryid.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rdate_rdate_loantype_lnreqstatus_entryid" Title="Report Criteria" %>
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_rdate_rdate_loantype_lnreqstatus_entryid"
