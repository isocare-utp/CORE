...
{
    public partial class u_cri_branchid_rdate_rloantype_rmembgroup_beginyear : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_loantype", minmax1[0]);
                dw_criteria.SetItemString(1, "end_loantype", minmax1[1]);
        ...
        private void RunProcess()
        {
            ...
            //string[] str = start_tdate.Split('/');
            //DateTime d = Convert.ToDateTime(new DateTime(Convert.ToInt32(str[2]), Convert.ToInt32(str[0]), Convert.ToInt32(str[1])), den);
            //DateTime[] atmbeginyear = ReportUtil.GetAdtmBeginYear(d.ToString("mm/dd/yyyy"));
            //DateTime beginyear = atmbeginyear[0];

            DateTime[] atmbeginyear = ReportUtil.GetAdtmBeginYear(start_tdate);
            DateTime beginyear = atmbeginyear[0];
            ...
            lnv_helper.AddArgument(start_tdate, ArgumentType.DateTime);
            lnv_helper.AddArgument(end_tdate, ArgumentType.DateTime);
            ...
            lnv_helper.AddArgument(beginyear.ToString("yyyy-MM-dd", WebUtil.EN), ArgumentType.DateTime);
            //----------------------------------------------------------------
