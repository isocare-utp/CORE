...
{
    public partial class u_cri_membno : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String name_manager = "นายสงวน  ศรีสวัสดิ์";
            String position_manager = "ผู้จัดการสหกรณ์ออมทรัพย์ครูแม่ฮ่องสอน";
            ...
            lnv_helper.AddArgument(name_manager, ArgumentType.String);
            lnv_helper.AddArgument(position_manager, ArgumentType.String);
