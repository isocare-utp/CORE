...
{
    public partial class u_cri_coopid_rmembgroup_protect : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "scompany", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "ecompany", "criteria.pbl", null);
            if (IsPostBack)
            {
        ...
        private void RunProcess()
        {
            ...
            String as_sprotectgrp = dw_criteria.GetItemString(1, "scompany");
            String as_eprotectgrp = dw_criteria.GetItemString(1, "ecompany");
            ...
            lnv_helper.AddArgument(as_sprotectgrp, ArgumentType.String);
            lnv_helper.AddArgument(as_eprotectgrp, ArgumentType.String);
