...
{
    public partial class u_cri_acc_yearperiod_budget : PageWebSheet, WebSheet
    {
        ...
        private void JspostNewClear()
        {
            ...
            //    kp_month = "0" + kp_month;
            //}
            dw_criteria.SetItemDecimal(1, "year",DateTime.Now.Year + 543);
            dw_criteria.SetItemDecimal(1, "period", DateTime.Now.Month);
        }
        //========================
        ...
        private void RunProcess()
        {
            ...
            String select_rpt = dw_criteria.GetItemString(1, "select_rpt");
            ...
            lnv_helper.AddArgument(select_rpt, ArgumentType.String);
            //----------------------------------------------------------------
