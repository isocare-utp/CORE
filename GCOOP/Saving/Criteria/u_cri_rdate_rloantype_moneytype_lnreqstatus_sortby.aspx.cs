...
{
    public partial class u_cri_rdate_rloantype_moneytype_lnreqstatus_sortby : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String as_sortby = dw_criteria.GetItemString(1, "as_sortby");
            ...
            lnv_helper.AddArgument(as_sortby, ArgumentType.String);
