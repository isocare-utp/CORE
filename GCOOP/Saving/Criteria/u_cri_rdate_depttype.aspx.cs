...
{
    public partial class u_cri_rdate_depttype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "depttype_code", "criteria.pbl", null);
            }
        ...
        private void RunProcess()
        {
            ...
            String depttype_code = dw_criteria.GetItemString(1, "depttype_code");
            ...
            lnv_helper.AddArgument(depttype_code, ArgumentType.String);
