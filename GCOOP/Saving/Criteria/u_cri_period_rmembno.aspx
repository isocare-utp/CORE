<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_period_rmembno.aspx.cs"
    Inherits="Saving.Criteria.u_cri_period_rmembno" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDwItemChanged(sender, row, column, value) {
            if (column == "start_membno" || column == "end_membno") {
                var start_membno = objdw_criteria.GetItem(row, "start_membno");
                var end_membno = objdw_criteria.GetItem(row, "end_membno");
                if (start_membno == null || start_membno == "") {
                    objdw_criteria.SetItem(row, "start_membno", value);
                }
                if (end_membno == null || end_membno == "") {
                    objdw_criteria.SetItem(row, "end_membno", value);
                }
                objdw_criteria.AcceptText();
                //post();
            }
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_month_year_rmembno"
