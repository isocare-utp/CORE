...
{
    public partial class u_cri_rdate_moneytype_loangroup_all : PageWebSheet, WebSheet
    {
     ...
     public void CheckJsPostBack(string eventArg)
        ...
        private void RunProcess()
        {
            ...
            if (fixed_flagtest1 == 0 && fixed_flagtest2 == 0)
            {
                as_moneytype = "%";
                as_loangroup = "%";
            }
            else if (fixed_flagtest1 == 1 && fixed_flagtest2 == 0)
            {
                as_moneytype = dw_criteria.GetItemString(1, "as_moneytype");
                as_loangroup = "%";
            }
            else if (fixed_flagtest1 == 0 && fixed_flagtest2 == 1)
            {
