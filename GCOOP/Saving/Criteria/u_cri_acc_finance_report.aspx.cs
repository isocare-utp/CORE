...
{
    public partial class u_cri_acc_finance_report : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "acc_id", "criteria.pbl", null);
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "payrec", "%");
        ...
        private void RunProcess()
        {
            ...
            String payrec = dw_criteria.GetItemString(1, "payrec");
            String coop_ctl = state.SsCoopControl;
            String acc_id = dw_criteria.GetItemString(1, "acc_id");
            Int16 coopall_flag = 0;

            try
            {
                coopall_flag = Convert.ToInt16(dw_criteria.GetItemDecimal(1, "allcoop_flag"));
            }
            catch { coopall_flag = 0; }

            // ถ้าเลือกเป็นทูกสาขา
            if (coopall_flag == 1) { coop_id = "%"; }
            ...
            lnv_helper.AddArgument(coop_ctl, ArgumentType.String);
            lnv_helper.AddArgument(payrec, ArgumentType.String);
            lnv_helper.AddArgument(acc_id, ArgumentType.String);
