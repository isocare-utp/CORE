...
{
    public partial class u_cri_rdate_rstatus : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String appstatus = dw_criteria.GetItemString(1, "app_status");
            ...
            lnv_helper.AddArgument(appstatus, ArgumentType.Number);
