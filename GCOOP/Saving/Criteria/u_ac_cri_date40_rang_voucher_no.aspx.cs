...
{
    public partial class u_ac_cri_date40_rang_voucher_no : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String voucher_sno = dw_criteria.GetItemString(1, "voucher_sno");
            String voucher_eno = dw_criteria.GetItemString(1, "voucher_eno");
            String entry_id = dw_criteria.GetItemString(1, "entry_id");
            ...
            lnv_helper.AddArgument(voucher_sno, ArgumentType.String);
            lnv_helper.AddArgument(voucher_eno, ArgumentType.String);
