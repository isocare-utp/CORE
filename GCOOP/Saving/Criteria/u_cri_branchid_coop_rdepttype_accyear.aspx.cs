...
{
    public partial class u_cri_branchid_coop_rdepttype_accyear : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "select_accyear",state.SsWorkDate.Year+543);
        ...
        private void RunProcess()
        {
            ...
            Decimal select_accyear = dw_criteria.GetItemDecimal(1, "select_accyear");
            ...
            lnv_helper.AddArgument(select_accyear.ToString(), ArgumentType.Number);
