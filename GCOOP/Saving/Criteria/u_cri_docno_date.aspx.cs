...
{
    public partial class u_cri_docno_date : PageWebSheet, WebSheet
    {
        ...
        private void Runprocess()
        {
            ...
            String as_docno = dw_criteria.GetItemString(1, "as_docno");
           ...
           lnv_helper.AddArgument(as_docno, ArgumentType.String);
