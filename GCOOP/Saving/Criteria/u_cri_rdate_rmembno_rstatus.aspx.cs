...
{
    public partial class u_cri_rdate_rmembno_rstatus : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_status", "");
                dw_criteria.SetItemString(1, "end_status", "");
        ...
        private void RunProcess()
        {
            ...
            String start_status = dw_criteria.GetItemString(1, "start_status");
            String end_status = dw_criteria.GetItemString(1, "end_status");
            ...
            lnv_helper.AddArgument(start_status, ArgumentType.String);
            lnv_helper.AddArgument(end_status, ArgumentType.String);
