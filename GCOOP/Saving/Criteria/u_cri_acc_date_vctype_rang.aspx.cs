...
{
    public partial class u_cri_acc_date_vctype_rang : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String type_g = dw_criteria.GetItemDecimal(1, "type_group").ToString();
       ...
       //     lnv_helper.AddArgument("11010000", ArgumentType.Number);
            lnv_helper.AddArgument(type_g, ArgumentType.Number);
    //        lnv_helper.AddArgument(type_g, ArgumentType.Number);
