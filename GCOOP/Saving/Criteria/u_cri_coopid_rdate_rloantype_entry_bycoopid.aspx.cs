...
{
    public partial class u_cri_coopid_rdate_rloantype_entry_bycoopid : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                //ดึงค่าน้อยสุด และค่ามากสุด ของเจ้าหน้าที่ มาเก็บไว้ในตัวแปร Array ชื่อ minmax2
                string[] minmax2 = ReportUtil.GetMinMaxMembentryid();
                dw_criteria.SetItemString(1, "start_entry", minmax2[0]);
                dw_criteria.SetItemString(1, "end_entry", minmax2[1]);
