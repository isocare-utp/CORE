...
{
    public partial class u_cri_branchid_rdepttype_rdate_recppaytype_userid : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDateTime(1, "end_tdate", state.SsWorkDate);
        ...
        private void RunProcess()
        {
            ...
            String branchid = dw_criteria.GetItemString(1, "branchid");
            String ebranchid = dw_criteria.GetItemString(1, "ebranchid");
            if (user_id == "0")
            {
            ...
            //lnv_helper.AddArgument(ebranchid, ArgumentType.String);
