...
{
    public partial class u_cri_rcoopid_rdate_rloantype_rmembgroup : PageWebSheet, WebSheet
    {
        ...
        {
            InitJsPostBack();
            //ดึงข้อมูล DropDownDataWindow ของช่วงสังกัด
            ...
            else
            {
                ...
                //ดึงค่าน้อยสุดและค่ามากสุดของประเภทเงินกู้มาเก็บไว้ในตัวแปร Array ชื่อ minmax
                ...
                //ดึงค่าน้อยสุดกับค่ามากสุดของช่วงสังกัดมาเก็บไว้ในตัวแปร Array ชื่อ minmax2
                string[] minmax2 = ReportUtil.GetMinMaxMembgroup();
                dw_criteria.SetItemString(1, "start_membgroup", minmax2[0]);
                dw_criteria.SetItemString(1, "end_membgroup", minmax2[1]);
        ...
        private void RunProcess()
        {
            ...
            //String start_entry = dw_criteria.GetItemString(1, "start_entry");
            //String end_entry = dw_criteria.GetItemString(1, "end_entry");
