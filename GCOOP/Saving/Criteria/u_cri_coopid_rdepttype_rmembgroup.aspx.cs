...
{
    public partial class u_cri_coopid_rdepttype_rmembgroup : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "as_sdepttype", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "as_edepttype", "criteria.pbl", null);
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "as_sdepttype", minmax[0]);
                dw_criteria.SetItemString(1, "as_edepttype", minmax[1]);
                string[] minmaxGrp = ReportUtil.GetMinMaxMembgroup();
                dw_criteria.SetItemString(1, "as_startgroup", "00100100");
                dw_criteria.SetItemString(1, "as_endgroup", minmaxGrp[1]);
        ...
        private void RunProcess()
        {
            ...
            String start_dp_type = dw_criteria.GetItemString(1, "as_sdepttype");
            String end_dp_type = dw_criteria.GetItemString(1, "as_edepttype");
