<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coopid_date_membno.aspx.cs"
    Inherits="Saving.Criteria.u_cri_coopid_date_membno" Title="Report Criteria" %>
		...
		<script type="text/javascript">
		    ...
		    function OnDwCriteriaItemsChange(sender, rowNumber, columnName, newValue) {
		        if (columnName == "start_membno") {
		            ...
		            objdw_criteria.AcceptText();
		            var member_no = objdw_criteria.GetItem(1, "start_membno");
		            if (member_no != null){
		            postmembno();
		            }
		        }
		    }
		    function dw_criteriaButtonOnClick(sender, rowNumber, buttonName) {
		        if (buttonName == "search") {
		            Gcoop.OpenDlg(700, 550, "w_dlg_fin_member_search.aspx", "");
		        }
            }

            function GetValueFromDlg(startmembno) {
                objdw_criteria.SetItem(1, "start_membno", startmembno);
                objdw_criteria.AcceptText();
            }
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_coopid_date_membno"
                    ClientEventButtonClicked="dw_criteriaButtonOnClick" 
