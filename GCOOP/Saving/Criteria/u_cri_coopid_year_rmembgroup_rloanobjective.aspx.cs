...
{
    public partial class u_cri_coopid_year_rmembgroup_rloanobjective : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_loanobjective_1", "criteria.pbl", null);
            DwUtil.RetrieveDDDW(dw_criteria, "end_loanobjective_1", "criteria.pbl", null);
            if (IsPostBack)
            {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_loanobjective", minmax1[0]);
                dw_criteria.SetItemString(1, "end_loanobjective", minmax1[1]);
            }
        ...
        private void JsGetYear()
        {
            ...
            try
            {
                ...
                if (dt.Next())
                {
                    ...
                    dw_criteria.SetItemDecimal(1, "an_year", account_year);
                }
                else
                {
                    sqlca.Rollback();
