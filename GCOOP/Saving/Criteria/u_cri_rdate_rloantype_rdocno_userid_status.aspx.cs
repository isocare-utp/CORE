...
{
    public partial class u_cri_rdate_rloantype_rdocno_userid_status : PageWebSheet, WebSheet
    {
        ...
        {
            //InitJsPostBack();
            DwUtil.RetrieveDDDW(dw_criteria, "start_loantype", "criteria.pbl", state.SsCoopId);
            DwUtil.RetrieveDDDW(dw_criteria, "end_loantype", "criteria.pbl", state.SsCoopId);
            if (IsPostBack)
            {
