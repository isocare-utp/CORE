...
{
    public partial class u_cri_coopid_year_rmembno_status : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "methpay", minmax[2]);
            }
        ...
        private void RunProcess()
        {
            ...
            string methpay = dw_criteria.GetItemString(1, "methpay");
            ...
            lnv_helper.AddArgument(methpay, ArgumentType.String);
