...
{
    public partial class u_cri_coopid_rdepartment : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_department", minmax[0]);
                dw_criteria.SetItemString(1, "end_department", minmax[1]);
