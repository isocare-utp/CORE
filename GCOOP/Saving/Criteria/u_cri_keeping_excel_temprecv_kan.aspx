<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_keeping_excel_temprecv_kan.aspx.cs" Inherits="Saving.Criteria.u_cri_keeping_excel_temprecv_kan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnItemChange(s, r, c, v) {
            if (c == "start_membgroup") {
                objdw_criteria.SetItem(r, "start_membgroup", v);
                objdw_criteria.AcceptText();
                postRefresh();
            }
            else if (c == "end_membgroup") {
                objdw_criteria.SetItem(r, "end_membgroup", v);
                objdw_criteria.AcceptText();
                postRefresh();
            }
            else if (c == "choice") {
                objdw_criteria.SetItem(r, "choice", v);
                objdw_criteria.AcceptText();
                postRefresh();
            }
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_keeping_cri_excel_temprecv_kan"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True" ClientEventItemChanged="OnItemChange">
