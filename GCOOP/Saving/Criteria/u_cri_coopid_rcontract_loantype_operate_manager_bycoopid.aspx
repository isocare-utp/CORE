<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coopid_rcontract_loantype_operate_manager_bycoopid.aspx.cs"
    Inherits="Saving.Criteria.u_cri_coopid_rcontract_loantype_operate_manager_bycoopid"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ItemDwCriteriaChanged(sender, rowNumber, columnName, newValue) {
            if (columnName == "loantype") {
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_coopid_rcontract_loantype_operate_manager_bycoopid"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" ClientEventItemChanged="ItemDwCriteriaChanged"
