...
{
    public partial class u_cri_coopid_date_betweenry : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_membgroup", "001");
                dw_criteria.SetItemString(1, "end_membgroup", "F09");
        ...
        private void RunProcess()
        {
            ...
            String smembgroup = dw_criteria.GetItemString(1, "start_membgroup");
            String emembgroup = dw_criteria.GetItemString(1, "end_membgroup");
            String ordno = dw_criteria.GetItemString(1, "ordno");
            String resultmt = dw_criteria.GetItemString(1, "resultmt");
            ...
            lnv_helper.AddArgument(smembgroup, ArgumentType.String);
            lnv_helper.AddArgument(emembgroup, ArgumentType.String);
            lnv_helper.AddArgument(ordno, ArgumentType.String);
            lnv_helper.AddArgument(resultmt, ArgumentType.String);
