...
{
    public partial class u_cri_coopid_rdate_rmembno_mhs : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "end_membno", "ZZZZZZZZ");
        ...
        private void RunProcess()
        {
            ...
            String fill_header = dw_criteria.GetItemString(1, "fill_header");
            ...
            lnv_helper.AddArgument(fill_header, ArgumentType.String);
