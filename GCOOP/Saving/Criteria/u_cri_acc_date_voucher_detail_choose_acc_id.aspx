<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_acc_date_voucher_detail_choose_acc_id.aspx.cs" Inherits="Saving.Criteria.u_cri_acc_date_voucher_detail_choose_acc_id" %>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_acc_date_vc_drcr_rang_choose_acc_id"
