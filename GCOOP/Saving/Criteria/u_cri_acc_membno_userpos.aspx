<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_acc_membno_userpos.aspx.cs"
    Inherits="Saving.Criteria.u_cri_acc_membno_userpos" Title="Report Criteria" %>
...
<%=postMemberno %>
		<script type="text/javascript">
		    function OnItemChange(s, r, c, v) {
		        if (c == "as_memberno") {
		            objdw_criteria.SetItem(1, "as_memberno", v);
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_acc_membno_userpos"
