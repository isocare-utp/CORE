...
{
    public partial class u_cri_coopid_recvperiod_rmembgroupcode_sort : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String select_sort = dw_criteria.GetItemString(1, "select_sort");
            ...
            lnv_helper.AddArgument(select_sort, ArgumentType.String);
