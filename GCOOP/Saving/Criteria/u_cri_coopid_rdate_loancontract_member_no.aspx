<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coopid_rdate_loancontract_member_no.aspx.cs" Inherits="Saving.Criteria.u_cri_coopid_rdate_loancontract_member_no" %>
    ...
    <script type="text/javascript">
        ...
        function DwMainButtonClick(sender, rowNumber, buttonName) {
            if (buttonName == "b_search") {
                Gcoop.OpenDlg('650', '650', 'w_dlg_sl_loancontract_search.aspx', '');
        ...
        //		        alert("getvalue");
        //		        objdw_criteria.SetItemString(1, "select_contract", loancontractno);
        //		        objdw_criteria.AcceptText();
        //		    }
        function GetValueFromDlg(loancontract_no,member_no) {

            objdw_criteria.SetItem(1, "select_contract", member_no);
            objdw_criteria.AcceptText();
            //		        
        }
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_coopid_rdate_loancontract"
