<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_raccmaster.aspx.cs"
    Inherits="Saving.Criteria.u_cri_raccmaster" Title="Report Criteria" %>
...
<%=runProcess%>
		...
		<script type="text/javascript">
		    ...
		    function OnDwItemChanged( sender, row, column, value){
		        if (column == "as_startaccid" || column == "as_endaccid")
		        {
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_raccount_id"
