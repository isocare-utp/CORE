...
{
    public partial class u_cri_coopid_recvperiod_rmembgroup_rgroupcontrol_loantype : PageWebSheet, WebSheet
    {
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == "post")
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "start_membctrl_1", "criteria.pbl", null);
                DwUtil.RetrieveDDDW(dw_criteria, "end_membctrl_1", "criteria.pbl", null);
                DwUtil.RetrieveDDDW(dw_criteria, "loantype_code_1", "criteria.pbl", null);
            }
        }
        ...
        private void RunProcess()
        {
            ...
            String year = dw_criteria.GetItemString(1, "ai_year").Trim() + dw_criteria.GetItemString(1, "as_month").Trim();
            String loantype_code = dw_criteria.GetItemString(1, "loantype_code").Trim();
