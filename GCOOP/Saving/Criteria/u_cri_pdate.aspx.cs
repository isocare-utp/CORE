...
{
    public partial class u_cri_pdate : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            //lnv_helper.AddArgument(startDate.ToString("dd/MM/yyyy", WebUtil.EN), ArgumentType.DateTime);
            //lnv_helper.AddArgument(endDate.ToString("dd/MM/yyyy", WebUtil.EN), ArgumentType.DateTime);
