...
{
    public partial class u_cri_coopid_rdate_rloantype_com123 : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "start_membgroup_1", "criteria.pbl", state.SsCoopControl);
                DwUtil.RetrieveDDDW(dw_criteria, "end_membgroup_1", "criteria.pbl", state.SsCoopControl);
        ...
        private void RunProcess()
        {
            ...
            String start_group      = dw_criteria.GetItemString(1, "start_membgroup");
            String end_group        = dw_criteria.GetItemString(1, "end_membgroup");
            String com1             = dw_criteria.GetItemString(1, "com1");
            String com2             = dw_criteria.GetItemString(1, "com2");
            String com3             = dw_criteria.GetItemString(1, "com3");
            String user_id          = dw_criteria.GetItemString(1, "user_id").Trim();
            string commetino = dw_criteria.GetItemString(1, "commetino");
            ...
            lnv_helper.AddArgument(start_group, ArgumentType.String);
            lnv_helper.AddArgument(end_group, ArgumentType.String);
            lnv_helper.AddArgument(com1, ArgumentType.String);
            lnv_helper.AddArgument(com2, ArgumentType.String);
            lnv_helper.AddArgument(com3, ArgumentType.String);
            lnv_helper.AddArgument(user_id, ArgumentType.String);
            lnv_helper.AddArgument(commetino, ArgumentType.String);
