<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_ins_membno.aspx.cs" Inherits="Saving.Criteria.u_cri_ins_membno" Title="Report Criteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
	    ...
	    function DWITemCHANGE(sender, row, colum, value) {
	        if (colum == "as_membno") {
	            objdw_criteria.SetItem(row, colum, value);
	            objdw_criteria.AcceptText();
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_ins_membno"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" 
                    AutoSaveDataCacheAfterRetrieve="True" ClientEventItemChanged="DWITemCHANGE">
