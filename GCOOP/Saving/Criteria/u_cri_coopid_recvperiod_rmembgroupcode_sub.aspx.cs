...
{
    public partial class u_cri_coopid_recvperiod_rmembgroupcode_sub : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_subgroup", "criteria.pbl");
            DwUtil.RetrieveDDDW(dw_criteria, "end_subgroup", "criteria.pbl");
        ...
        private void RunProcess()
        {
            ...
            String start_subgroup = dw_criteria.GetItemString(1, "start_subgroup").Trim();
            String end_subgroup = dw_criteria.GetItemString(1, "end_subgroup").Trim();
            ...
            lnv_helper.AddArgument(start_subgroup, ArgumentType.String);
            lnv_helper.AddArgument(end_subgroup, ArgumentType.String);
