...
{
    public partial class u_cri_month_year_rmembgroup : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "select_month", 1);
                string[] minmax = ReportUtil.GetMinMaxMembgroup();
                dw_criteria.SetItemString(1, "start_membgroup_1", minmax[0]);
                dw_criteria.SetItemString(1, "end_membgroup_1", minmax[1]);
        ...
        private void RunProcess()
        {
            ...
            String start_membgroup = dw_criteria.GetItemString(1, "start_membgroup_1");
            String end_membgroup = dw_criteria.GetItemString(1, "end_membgroup_1");
            ...
            lnv_helper.AddArgument(select_month.ToString(), ArgumentType.Number);
