...
{
    public partial class u_cri_rdate_moneytype_loangroup : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "as_loangroup", 1);
        ...
        private void RunProcess()
        {
            ...
            Decimal as_loangroup = dw_criteria.GetItemDecimal(1, "as_loangroup");
            ...
            lnv_helper.AddArgument(as_loangroup.ToString(), ArgumentType.Number);
