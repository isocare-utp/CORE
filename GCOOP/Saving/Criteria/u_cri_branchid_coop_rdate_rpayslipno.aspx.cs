...
{
    public partial class u_cri_branchid_coop_rdate_rpayslipno : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "s_payslipno", "");
                dw_criteria.SetItemString(1, "e_payslipno", "");
        ...
        private void RunProcess()
        {
            ...
            String s_payslipno = dw_criteria.GetItemString(1, "s_payslipno");
            String e_payslipno = dw_criteria.GetItemString(1, "e_payslipno");
            if (s_payslipno == "")
            {
                s_payslipno = "0";
            }
            ...
            lnv_helper.AddArgument(s_payslipno, ArgumentType.String);
            lnv_helper.AddArgument(e_payslipno, ArgumentType.String);
            //----------------------------------------------------
