...
{
    public partial class u_cri_rmembgroup_date_uname : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "tdate","");
                dw_criteria.SetItemString(1, "snamet", "");
                dw_criteria.SetItemString(1, "enamet", "");
                dw_criteria.SetItemString(1, "snamemana", "");
                dw_criteria.SetItemString(1, "enamemana", "");
        ...
        private void RunProcess()
        {
            ...
            String tdate = WebUtil.ConvertDateThaiToEng(dw_criteria, "tdate", null);
            String snamet = dw_criteria.GetItemString(1, "snamet");
            String enamet = dw_criteria.GetItemString(1, "enamet");
            String snamemana = dw_criteria.GetItemString(1, "snamemana");
            String enamemana = dw_criteria.GetItemString(1, "enamemana");
            ...
            lnv_helper.AddArgument(snamet, ArgumentType.String);
            lnv_helper.AddArgument(enamet, ArgumentType.String);
            lnv_helper.AddArgument(snamemana, ArgumentType.String);
            lnv_helper.AddArgument(enamemana, ArgumentType.String);
