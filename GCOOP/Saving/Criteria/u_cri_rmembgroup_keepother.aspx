<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rmembgroup_keepother.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rmembgroup_keepother" Title="Report Criteria" %>
...
<%=runProcess%>
		...
		<script type="text/javascript">
		    ...
		    function OnDwcriteriaClick(s, r, c) {
		        if (c == "choose_flag") {
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_rmembgroup_keepothertype"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" 
                    AutoSaveDataCacheAfterRetrieve="True" 
                    ClientEventItemChanged="OnDwItemChanged" ClientEventClicked="OnDwcriteriaClick">
