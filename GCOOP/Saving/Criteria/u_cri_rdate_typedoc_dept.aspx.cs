...
{
    public partial class u_cri_rdate_typedoc_dept : PageWebSheet, WebSheet
    {
        ...
        {
            //InitJsPostBack();
            DwUtil.RetrieveDDDW(dw_criteria, "dept", "criteria.pbl", null);
            if (IsPostBack)
            {
        ...
        private void RunProcess()
        {
            ...
            String type_doc = dw_criteria.GetItemString(1, "typedoc");
            String dept = dw_criteria.GetItemString(1, "dept");
            dept = dept.Trim() + "%";
            ...
            lnv_helper.AddArgument(type_doc, ArgumentType.String);
            lnv_helper.AddArgument(dept, ArgumentType.String);
            ...
            try
            {
                //Saving.WsReport.Report lws_report = new Saving.WsReport.Report();
