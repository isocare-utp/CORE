...
{
    public partial class u_cri_rmembgroup_rprnbal : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            Decimal start_prnbal = dw_criteria.GetItemDecimal(1,"start_prnbal");
            Decimal end_prnbal = dw_criteria.GetItemDecimal(1, "end_prnbal");
            ...
            lnv_helper.AddArgument(start_prnbal.ToString(), ArgumentType.Number);
            lnv_helper.AddArgument(end_prnbal.ToString(), ArgumentType.Number);
            //****************************************************************
