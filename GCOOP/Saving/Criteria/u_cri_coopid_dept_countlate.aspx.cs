...
{
    public partial class u_cri_coopid_dept_countlate : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "ai_countlate", 1);
        ...
        private void RunProcess()
        {
            ...
            Decimal ai_countlate = dw_criteria.GetItemDecimal(1, "ai_countlate");
            ...
            lnv_helper.AddArgument(ai_countlate.ToString(), ArgumentType.Number);
