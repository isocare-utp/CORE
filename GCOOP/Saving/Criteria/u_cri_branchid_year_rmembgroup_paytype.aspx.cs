...
{
    public partial class u_cri_branchid_year_rmembgroup_paytype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "paytype_code", "criteria.pbl", state.SsCoopId);
            if (IsPostBack)
            {
        ...
        private void RunProcess()
        {
            ...
            try
            {
               paytype_code = dw_criteria.GetItemString(1, "paytype_code").Trim();
            }
            catch { paytype_code = "%"; }
