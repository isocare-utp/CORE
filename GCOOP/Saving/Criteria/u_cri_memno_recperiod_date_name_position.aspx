<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_memno_recperiod_date_name_position.aspx.cs" Inherits="Saving.Criteria.u_cri_memno_recperiod_date_name_position" %>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_memno_recvperiod_date_name_position"
