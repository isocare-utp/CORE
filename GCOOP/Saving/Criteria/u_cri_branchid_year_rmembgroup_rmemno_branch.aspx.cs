...
{
    public partial class u_cri_branchid_year_rmembgroup_rmemno_branch : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_memno", "criteria.pbl", state.SsCoopId);
            DwUtil.RetrieveDDDW(dw_criteria, "end_memno", "criteria.pbl", state.SsCoopId);
            DwUtil.RetrieveDDDW(dw_criteria, "branch", "criteria.pbl", state.SsCoopId);
            if (IsPostBack)
            {
            ...
            else
            {
               ...
               // DwUtil.RetrieveDDDW(dw_criteria, "branch_id", "criteria.pbl", state.SsCoopControl);
                ...
                JsGetYear();
                //dw_criteria.SetItemString(1, "div_year", Convert.ToString(DateTime.Now.AddYears(-1).Year + 543));
        ...
        private void RunProcess()
        {
            ...
            String branch = dw_criteria.GetItemString(1, "branch").Trim();
            ...
            lnv_helper.AddArgument(branch, ArgumentType.String);
