...
{
    public partial class u_cri_rmembgroup : PageWebSheet, WebSheet
    {
        ...
        {
            //InitJsPostBack();
            DwUtil.RetrieveDDDW(dw_criteria, "membgroup_code", "criteria.pbl", null);
            ...
            else
            {
                ...
                //dw_criteria.SetItemString(1, "membgroup_code", minmax[0]);
        ...
        private void RunProcess()
        {
            ...
            String start_membgroup = dw_criteria.GetItemString(1, "membgroup_code");
