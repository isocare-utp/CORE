...
{
    public partial class u_cri_kp_rmonth_year_kpitemtype : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "keepitemtype", "criteria.pbl");
        }
        ...
        private void RunProcess()
        {
            ...
            String kpitemtype = dw_criteria.GetItemString(1, "keepitemtype");

            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.
            ReportHelper lnv_helper = new ReportHelper();
            lnv_helper.AddArgument(period, ArgumentType.String);
            lnv_helper.AddArgument(kpitemtype, ArgumentType.String);
            //****************************************************************
