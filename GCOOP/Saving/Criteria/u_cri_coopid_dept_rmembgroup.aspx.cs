...
{
    public partial class u_cri_coopid_dept_rmembgroup : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "ai_monthstatus", 1);
        ...
        private void RunProcess()
        {
            ...
            Decimal ai_monthstatus = dw_criteria.GetItemDecimal(1, "ai_monthstatus");
            ...
            lnv_helper.AddArgument(ai_monthstatus.ToString(), ArgumentType.Number);
