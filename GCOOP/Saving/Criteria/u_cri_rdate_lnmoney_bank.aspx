<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rdate_lnmoney_bank.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rdate_lnmoney_bank" Title="Report Criteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
            ...
            {
                Gcoop.CheckDw(sender, rowNumber, objectName, "fixed_flag1", 1, 0);
                Gcoop.CheckDw(sender, rowNumber, objectName, "fixed_flag2", 1, 0);
                Gcoop.CheckDw(sender, rowNumber, objectName, "fixed_flag3", 1, 0);
                Gcoop.CheckDw(sender, rowNumber, objectName, "fixed_flag4", 1, 0);
                if(objectName == "fixed_flag1")
                {
                    //objdw_criteria.AcceptText();
                    checkFlag();
                } 
                else if(objectName == "fixed_flag2")
                {
                    //objdw_criteria.AcceptText();
                    checkFlag1();
                }
                else if (objectName == "fixed_flag3") {
                    //objdw_criteria.AcceptText();
                    checkFlag2();
                }
                else if (objectName == "fixed_flag4") {
                    //objdw_criteria.AcceptText();
                    checkFlag3();
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_rdate_lnmoney_bank"
    ...
    <asp:HiddenField ID="HdFlag3" runat="server" />
    <%=outputProcess%>
</asp:Content>
