<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_branchid_coop_rdepttype_workdate.aspx.cs"
    Inherits="Saving.Criteria.u_cri_branchid_coop_rdepttype_workdate" Title="Report Criteria" %>
		...
		<script type="text/javascript">
		    ...
		    function SheetLoadComplete(){
		        if( Gcoop.GetEl("HdOpenIFrame").value == "True" ){
		            ...
		            //Gcoop.OpenIFrame("220","200", 'http://localhost/GCOOP/Saving/Criteria/dlg/w_dlg_report_progress.aspx?aa=aa&app=<%=app%>&gid=<%=gid%>&rid=<%=rid%>&pdf=<%=pdf%>',"");
		        }
		    }
		</script>
</asp:Content>
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_branchid_rdepttype"
