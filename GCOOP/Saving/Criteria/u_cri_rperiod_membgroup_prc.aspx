<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rperiod_membgroup_prc.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rperiod_membgroup_prc" Title="Report Criteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
		...
		<script type="text/javascript">
		    ...
		    function SheetLoadComplete(){
		        ...
		        else if (Gcoop.GetEl("HdRunProcess").value == "True") {
		            Gcoop.OpenProgressBar("ประมวลผลเรียกเก็บ", true, true, ShowReport);
                }
		    }
