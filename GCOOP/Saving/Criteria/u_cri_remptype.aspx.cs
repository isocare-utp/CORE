...
{
    public partial class u_cri_remptype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "as_emptype", "criteria.pbl", null);
        ...
        private void CheckFlag()
        {
            ...
            if (fixed_flagtest == 0)
            {
                dw_criteria.SetItemString(1, "as_emptype", "");
        ...
        private void RunProcess()
        {
            ...
            String as_emptype = dw_criteria.GetItemString(1, "as_emptype");
            ...
            lnv_helper.AddArgument(as_emptype, ArgumentType.String);
